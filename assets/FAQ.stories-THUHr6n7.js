import{f as S}from"./snippets-m8t1HIl1.js";const x={title:"Vuexy/Templates/Misc/FAQ",tags:["autodocs"],parameters:{docs:{description:{component:`
# FAQ Page Template
...
- Contact/support footer
        `}},layout:"fullscreen"},argTypes:{withSearch:{control:"boolean",description:"Incluir barra de busca",table:{defaultValue:{summary:!0}}}}},h=({withSearch:c=!0})=>`<div class="faq-wrapper">
  <!-- FAQ Header -->
...
.bg-label-info {
  ...
  color: #00cfe8 !important;
    ...
    <details>
      ...
      <div class="mt-3">
        <h6>HTML</h6>
        <pre><code>${S(s).replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
      </div>
    </details>
  `},o=()=>h({withSearch:!0}),a=f.bind({});a.args={withSearch:!0};const e=f.bind({});e.args={withSearch:!1};const t={render:()=>`
      <div class="container py-5">
    ...
    `,parameters:{docs:{description:{story:"Demo interativo com accordion funcional usando state controlado (classes/display). Clique para expandir/recolher."}}}};var i,n,r;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`() => createFAQPage({
  withSearch: true
})`,...(r=(n=o.parameters)==null?void 0:n.docs)==null?void 0:r.source}}};var l,d,p;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(p=(d=a.parameters)==null?void 0:d.docs)==null?void 0:p.source}}};var u,m,b;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:`args => {
  const markup = createFAQPage(args);
  return \`
    \${markup}
  ...
  \`;
}`,...(b=(m=e.parameters)==null?void 0:m.docs)==null?void 0:b.source}}};var v,g,y;t.parameters={...t.parameters,docs:{...(v=t.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => {
    return \`
      <div class="container py-5">
        <h3 class="mb-4">Interactive FAQ Accordion</h3>
...
}`,...(y=(g=t.parameters)==null?void 0:g.docs)==null?void 0:y.source}}};const q=["Overview","WithSearch","NoSearch","Interactive"];export{t as Interactive,e as NoSearch,o as Overview,a as WithSearch,q as __namedExportsOrder,x as default};
