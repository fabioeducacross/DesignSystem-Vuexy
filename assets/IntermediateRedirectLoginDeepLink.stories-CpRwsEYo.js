const j={title:"Educacross Components V2/Navigation/IntermediateRedirectLoginDeepLink",tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:`
...
`,n=`<svg width="250" height="275" viewBox="0 0 250 275" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,a=`<svg width="256" height="42" viewBox="0 0 256 42" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `},d={parameters:{viewport:{defaultViewport:"mobile1"}},render:()=>`
    ${e}
    <div class="BackgroundSpace">
      <div class="redirectLogin-container" style="width: 85%; padding: 1.5rem;">
        <div class="redirectLogin-content" style="gap: 24px;">
          <div style="width: 100%;">
            ${n.replace('width="250"','width="100%"').replace('height="275"','height="auto"')}
          </div>
          <div style="width: 100%;">
            ${a.replace('width="256"','width="100%"').replace('height="42"','height="auto"')}
          </div>
          <div>
  ...
  `},c={parameters:{viewport:{defaultViewport:"tablet"}},render:()=>`
    ${e}
    <div class="BackgroundSpace">
  ...
  `},p={render:()=>(setTimeout(()=>{const l=document.querySelector(".redirectLogin-container");l&&l.addEventListener("click",()=>{alert("Redirecionamento simulado: Você seria levado para o painel principal após autenticação.")})},100),`
      ${e}
      <style>
        .redirectLogin-container {
          cursor: pointer;
    ...
    `)};var g,v,m;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="BackgroundSpace">
      <div class="redirectLogin-container">
  ...
  \`
}`,...(m=(v=i.parameters)==null?void 0:v.docs)==null?void 0:m.source}}};var u,h,x;o.parameters={...o.parameters,docs:{...(u=o.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="BackgroundSpace">
      <div class="redirectLogin-container">
  ...
  \`
}`,...(x=(h=o.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};var f,w,L;t.parameters={...t.parameters,docs:{...(f=t.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="BackgroundSpace">
      <div class="redirectLogin-container">
  ...
  \`
}`,...(L=(w=t.parameters)==null?void 0:w.docs)==null?void 0:L.source}}};var S,y,$;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="BackgroundSpace">
      <div class="redirectLogin-container">
  ...
  \`
}`,...($=(y=s.parameters)==null?void 0:y.docs)==null?void 0:$.source}}};var b,k,E;r.parameters={...r.parameters,docs:{...(b=r.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="BackgroundSpace">
      <div class="redirectLogin-container">
  ...
  \`
}`,...(E=(k=r.parameters)==null?void 0:k.docs)==null?void 0:E.source}}};var V,C,B;d.parameters={...d.parameters,docs:{...(V=d.parameters)==null?void 0:V.docs,source:{originalSource:`{
  parameters: {
    viewport: {
  ...
  \`
}`,...(B=(C=d.parameters)==null?void 0:C.docs)==null?void 0:B.source}}};var A,D,G;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  parameters: {
    viewport: {
  ...
  \`
}`,...(G=(D=c.parameters)==null?void 0:D.docs)==null?void 0:G.source}}};var F,z,M;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => {
    setTimeout(() => {
...
}`,...(M=(z=p.parameters)==null?void 0:z.docs)==null?void 0:M.source}}};const R=["Default","WithMessage","StudentContext","TeacherContext","LongWaitAnimation","MobileView375","TabletView768","Interactive"];export{i as Default,p as Interactive,r as LongWaitAnimation,d as MobileView375,t as StudentContext,c as TabletView768,s as TeacherContext,o as WithMessage,R as __namedExportsOrder,j as default};
