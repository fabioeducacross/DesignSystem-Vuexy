const i={title:"Educacross Components V2/Navigation/SidebarProficiencyInfo",tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
...
`,a={render:()=>`
    <style>${d}</style>
    ${o}
  `};var e,t,s;a.parameters={...a.parameters,docs:{...(e=a.parameters)==null?void 0:e.docs,source:{originalSource:`{
  render: () => \`
