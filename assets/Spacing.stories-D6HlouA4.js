const I={title:"Vuexy/Foundations/Spacing",parameters:{previewTabs:{canvas:{hidden:!1}}}},B=[{name:"0",value:"0",rem:"0rem",px:"0px"},{name:"1",value:"0.25rem",rem:"0.25rem",px:"4px"},{name:"2",value:"0.5rem",rem:"0.5rem",px:"8px"},{name:"3",value:"1rem",rem:"1rem",px:"16px"},{name:"4",value:"1.5rem",rem:"1.5rem",px:"24px"},{name:"5",value:"3rem",rem:"3rem",px:"48px"}],d={render:()=>`
        ...
        ${B.map(e=>`
          ...
          ">
            ...
            <div style="flex: 1; display: flex; align-items: center; gap: 2rem;">
              <div style="background: #5f61e6; height: 40px; width: ${e.value}; border-radius: 4px;"></div>
              <div>
                <div><code>${e.rem}</code></div>
                <div style="font-size: 0.875rem; color: #6c757d;">${e.px}</div>
              </div>
            </div>
          </div>
        `).join("")}
    ...
    <div style="padding: 2rem; max-width: 900px;">
      ...
      <div style="display: grid; gap: 2rem;">
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 1rem;">
            ${[0,1,2,3,4,5].map(e=>{var o;return`
              <div style="background: #f8f9fa; padding: 1rem; border-radius: 8px;">
                <div class="d-flex gap-${e}">
                ...
                <div style="margin-top: 0.5rem; font-size: 0.75rem; color: #6c757d;">
                  .gap-${e} (${((o=B.find(E=>E.name===e.toString()))==null?void 0:o.rem)||"auto"})
                </div>
              </div>
            `}).join("")}
          </div>
  ...
  `};var s,l,m;d.parameters={...d.parameters,docs:{...(s=d.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; max-width: 900px;">
      <h1 style="margin-bottom: 0.5rem;">Spacing</h1>
      <p style="color: #6c757d; margin-bottom: 3rem;">
  ...
  \`
}`,...(m=(l=d.parameters)==null?void 0:l.docs)==null?void 0:m.source}}};var p,c,g;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; max-width: 900px;">
      <h2 style="margin-bottom: 2rem;">Margin Utilities</h2>
  ...
  \`
}`,...(g=(c=n.parameters)==null?void 0:c.docs)==null?void 0:g.source}}};var v,f,b;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; max-width: 900px;">
      <h2 style="margin-bottom: 2rem;">Padding Utilities</h2>
  ...
  \`
}`,...(b=(f=i.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var u,y,x;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; max-width: 900px;">
      <h2 style="margin-bottom: 2rem;">Gap Utilities (Flexbox & Grid)</h2>
  ...
  \`
}`,...(x=(y=r.parameters)==null?void 0:y.docs)==null?void 0:x.source}}};var h,k,w;t.parameters={...t.parameters,docs:{...(h=t.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; max-width: 900px;">
      <h2 style="margin-bottom: 2rem;">Common Usage Examples</h2>
  ...
  \`
}`,...(w=(k=t.parameters)==null?void 0:k.docs)==null?void 0:w.source}}};var S,z,C;a.parameters={...a.parameters,docs:{...(S=a.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; max-width: 900px;">
      <h2 style="margin-bottom: 2rem;">📏 Interactive Spacing Demo</h2>
  ...
  \`
}`,...(C=(z=a.parameters)==null?void 0:z.docs)==null?void 0:C.source}}};const A=["SpacingScale","MarginUtilities","PaddingUtilities","GapUtilities","UsageExamples","Interactive"];export{r as GapUtilities,a as Interactive,n as MarginUtilities,i as PaddingUtilities,d as SpacingScale,t as UsageExamples,A as __namedExportsOrder,I as default};
