import{c as q,a as T,b as I,d as O}from"./docTemplate-RKjNfURf.js";const R={title:"Educacross Components V2/Modals/DeleteGuide",parameters:{layout:"fullscreen",docs:{page:null,description:{component:`DeleteGuide - Mission Deletion Confirmation Component
=========================================
...
@since 2.0.0`}},options:{showPanel:!1}}},n={render:()=>q({title:"DeleteGuide",subtitle:"Modal de confirmação para exclusão de missões com orientação da mascote Belinha",badge:"Front-office / Modals",badgeIcon:"delete_forever",showStats:!0,stats:{Tipo:"Confirmation",Ação:"Destructive",Loading:"✓"},colors:{primary:"#EA5455",secondary:"#f39c12"},content:`
      ${T({title:"Fluxo de Exclusão",icon:"rule",steps:['Professor clica "Excluir missão"',"Modal DeleteGuide aparece com Belinha","Exibe nome da missão a ser excluída",'Professor pode "Não quero excluir" (cancela)','Ou clica "Quero excluir" (confirma)',"Botão exibe loading durante processamento","Modal fecha e missão é excluída"]})}

      ${I({title:"Modal Padrão",description:"Confirmação básica de exclusão com mascote Belinha",showTitle:!0,wrapPreview:!1,preview:`
          <style>
            .delete-guide-modal {
              background: white;
              border-radius: 12px;
...
</div>`,react:`import { useState } from 'react'
...
<\/script>`}})}
      ...
      ${O([{prop:"visible",type:"Boolean",default:"false",description:"Controla a visibilidade do modal"},{prop:"missionName",type:"String",default:'""',description:"Nome da missão a ser excluída (exibido no título)"},{prop:"studentsCount",type:"Number",default:"0",description:"Número de alunos impactados (exibe aviso se > 0)"},{prop:"isLoading",type:"Boolean",default:"false",description:"Estado de carregamento (desabilita botões e exibe spinner)"}])}
...
`,s={render:()=>`
  ...
  `};var c,p,m,u,b;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => createDocPage({
    ...
    content: \`
      ...
      icon: 'rule',
      steps: ['Professor clica "Excluir missão"', 'Modal DeleteGuide aparece com Belinha', 'Exibe nome da missão a ser excluída', 'Professor pode "Não quero excluir" (cancela)', 'Ou clica "Quero excluir" (confirma)', 'Botão exibe loading durante processamento', 'Modal fecha e missão é excluída']
    })}
...
}`,...(m=(p=n.parameters)==null?void 0:p.docs)==null?void 0:m.source},description:{story:`Design Specs
...
- Buttons: d-flex justify-content-center gap-4`,...(b=(u=n.parameters)==null?void 0:u.docs)==null?void 0:b.description}}};var x,g,h;s.parameters={...s.parameters,docs:{...(x=s.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => \`
    \${deleteGuideStyles}
    <div class="delete-guide-container">
      <img src="/educacross-assets/belinha/belinha-school-enable-script.png" class="mascot-image" alt="Belinha - excluir missão" />
  ...
  \`
}`,...(h=(g=s.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};var v,f,E;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => \`
    \${deleteGuideStyles}
    <div class="delete-guide-container">
      <img src="/educacross-assets/belinha/belinha-school-enable-script.png" class="mascot-image" alt="Belinha - excluir missão" />
  ...
  \`
}`,...(E=(f=i.parameters)==null?void 0:f.docs)==null?void 0:E.source}}};var y,w,D;t.parameters={...t.parameters,docs:{...(y=t.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => \`
    \${deleteGuideStyles}
    <div class="delete-guide-container">
      <img src="/educacross-assets/belinha/belinha-school-enable-script.png" class="mascot-image" alt="Belinha - excluir missão" />
  ...
  \`
}`,...(D=(w=t.parameters)==null?void 0:w.docs)==null?void 0:D.source}}};var C,F,B;a.parameters={...a.parameters,docs:{...(C=a.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => \`
    \${deleteGuideStyles}
    <style>
      .missions-list {
  ...
  \`
}`,...(B=(F=a.parameters)==null?void 0:F.docs)==null?void 0:B.source}}};var k,z,N;o.parameters={...o.parameters,docs:{...(k=o.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => \`
    \${deleteGuideStyles}
    <style>
      .impact-box {
  ...
  \`
}`,...(N=(z=o.parameters)==null?void 0:z.docs)==null?void 0:N.source}}};var A,S,M;r.parameters={...r.parameters,docs:{...(A=r.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => \`
    \${deleteGuideStyles}
    <div class="delete-guide-container">
      <svg width="80" height="80" viewBox="0 0 80 80" style="margin-bottom: 16px;">
  ...
  \`
}`,...(M=(S=r.parameters)==null?void 0:S.docs)==null?void 0:M.source}}};var L,j,G;l.parameters={...l.parameters,docs:{...(L=l.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => \`
    \${deleteGuideStyles}
    <style>
      .modal-overlay {
  ...
  \`
}`,...(G=(j=l.parameters)==null?void 0:j.docs)==null?void 0:G.source}}};var $,P,Q;d.parameters={...d.parameters,docs:{...($=d.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => \`
    \${deleteGuideStyles}
    <div style="background: #E3F2FD; border-left: 4px solid #2196F3; padding: 16px; border-radius: 6px; margin-bottom: 24px; max-width: 700px;">
      <h4 style="font-size: 14px; font-weight: 600; color: #1565C0; margin: 0 0 8px 0;">
  ...
  \`
}`,...(Q=(P=d.parameters)==null?void 0:P.docs)==null?void 0:Q.source}}};const _=["Documentation","Default","WithLoading","WithWarning","MultipleMissions","WithStudentsImpact","SimpleConfirmation","InModal","Responsive"];export{s as Default,n as Documentation,l as InModal,a as MultipleMissions,d as Responsive,r as SimpleConfirmation,i as WithLoading,o as WithStudentsImpact,t as WithWarning,_ as __namedExportsOrder,R as default};
