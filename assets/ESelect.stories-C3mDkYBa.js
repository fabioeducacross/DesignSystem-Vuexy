const ee={title:"Vuexy/Molecules/Forms/ESelect",tags:["autodocs"],parameters:{docs:{description:{component:`
...
`,l=`<svg width="32" height="32" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,j=`<svg width="32" height="32" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,Q=`<svg width="32" height="32" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,N=`<svg width="32" height="32" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M27.5607 22.7057C27.9913 22.7057 28.3404 22.3535 28.3404 21.9191C28.3404 21.4846 27.9913 21.1324 27.5607 21.1324C27.1301 21.1324 26.781 21.4846 26.781 21.9191C26.781 22.3535 27.1301 22.7057 27.5607 22.7057Z" fill="#FEFEFE"/>
  ...
  `},m={name:"Seleção Múltipla",render:()=>`
    ${a}
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" rel="stylesheet" />
  ...
  `},u={name:"Variantes de Cor",render:()=>`
    ${a}
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" rel="stylesheet" />
  ...
  `},g={name:"Layout de Filtros",render:()=>`
    ${a}
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" rel="stylesheet" />
  ...
  `,play:async({canvasElement:n})=>{const r=n.querySelector("#select-trigger"),i=n.querySelector("#options-list"),o=n.querySelector("#drop-icon"),b=n.querySelector("#selected-display"),J=n.querySelector("#selected-value"),h=n.querySelectorAll("#options-list .option");if(!r||!i)return;let s=!1;r.addEventListener("click",e=>{e.stopPropagation(),s=!s,s?(i.classList.add("opened"),o.classList.add("revert-drop-icon")):(i.classList.remove("opened"),o.classList.remove("revert-drop-icon"))}),h.forEach(e=>{e.addEventListener("click",W=>{W.stopPropagation(),h.forEach(U=>U.classList.remove("selected","bg-light-primary")),e.classList.add("selected","bg-light-primary");const K=e.querySelector(".opt-content").querySelector("svg").outerHTML,C=e.dataset.label;b.className="opt-content",b.innerHTML=K+"<span>"+C+"</span>",J.textContent=JSON.stringify({value:e.dataset.value,label:C},null,2),s=!1,i.classList.remove("opened"),o.classList.remove("revert-drop-icon")})}),document.addEventListener("click",e=>{s&&!e.target.closest("#select-area")&&(s=!1,i.classList.remove("opened"),o.classList.remove("revert-drop-icon"))}),r.addEventListener("keydown",e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),r.click()),e.key==="Escape"&&s&&(s=!1,i.classList.remove("opened"),o.classList.remove("revert-drop-icon"))})}};var f,x,y;d.parameters={...d.parameters,docs:{...(f=d.parameters)==null?void 0:f.docs,source:{originalSource:`{
  name: 'Default',
  render: () => \`
    \${eSelectCSS}
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" rel="stylesheet" />
  ...
  \`
}`,...(y=(x=d.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};var w,L,S;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: 'Placeholder',
  render: () => \`
    \${eSelectCSS}
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" rel="stylesheet" />
  ...
  \`
}`,...(S=(L=c.parameters)==null?void 0:L.docs)==null?void 0:S.source}}};var E,M,F;p.parameters={...p.parameters,docs:{...(E=p.parameters)==null?void 0:E.docs,source:{originalSource:`{
  ...
  \`
}`,...(F=(M=p.parameters)==null?void 0:M.docs)==null?void 0:F.source}}};var k,D,Z;v.parameters={...v.parameters,docs:{...(k=v.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: 'Desabilitado',
  render: () => \`
    \${eSelectCSS}
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" rel="stylesheet" />
  ...
  \`
}`,...(Z=(D=v.parameters)==null?void 0:D.docs)==null?void 0:Z.source}}};var A,V,z;m.parameters={...m.parameters,docs:{...(A=m.parameters)==null?void 0:A.docs,source:{originalSource:`{
  ...
  \`
}`,...(z=(V=m.parameters)==null?void 0:V.docs)==null?void 0:z.source}}};var $,H,_;u.parameters={...u.parameters,docs:{...($=u.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...
  \`
}`,...(_=(H=u.parameters)==null?void 0:H.docs)==null?void 0:_.source}}};var O,I,P;g.parameters={...g.parameters,docs:{...(O=g.parameters)==null?void 0:O.docs,source:{originalSource:`{
  ...
  \`
}`,...(P=(I=g.parameters)==null?void 0:I.docs)==null?void 0:P.source}}};var B,G,q,R,T;t.parameters={...t.parameters,docs:{...(B=t.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: '🎮 Interativo',
  render: () => \`
    \${eSelectCSS}
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" rel="stylesheet" />
  ...
  play: async ({
    ...
    options.forEach(option => {
      option.addEventListener('click', e => {
        ...
        // Atualizar valor
        selectedValue.textContent = JSON.stringify({
...
}`,...(q=(G=t.parameters)==null?void 0:G.docs)==null?void 0:q.source},description:{story:`Story Interativa - ESelect com JavaScript
Demonstra o comportamento real do componente`,...(T=(R=t.parameters)==null?void 0:R.docs)==null?void 0:T.description}}};const se=["Default","Placeholder","Opened","Disabled","MultipleBadge","Variants","FilterLayout","Interactive"];export{d as Default,v as Disabled,g as FilterLayout,t as Interactive,m as MultipleBadge,p as Opened,c as Placeholder,u as Variants,se as __namedExportsOrder,ee as default};
