const L={title:"Educacross Components V2/Legends/LegendEnumPDF",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
# LegendEnumPDF
...
`,s={render:()=>`
  ...
  `};var l,r,c;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: () => \`
    \${legendPDFStyles}
    <div class="legend-pdf-container">
      <span class="legend-pdf-label">Status:</span>
  ...
  \`
}`,...(c=(r=s.parameters)==null?void 0:r.docs)==null?void 0:c.source}}};var g,x,f;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => \`
    \${legendPDFStyles}
    <div style="background: white; padding: 16px; max-width: 600px;">
      <div class="legend-pdf-container" style="margin-bottom: 12px;">
  ...
  \`
}`,...(f=(x=a.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};var u,b,m;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
    \${legendPDFStyles}
    <div class="pdf-page-demo">
      <div class="pdf-header">
  ...
  \`
}`,...(m=(b=e.parameters)==null?void 0:b.docs)==null?void 0:m.source}}};var v,y,h;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => \`
    \${legendPDFStyles}
    <div style="background: white; padding: 16px; max-width: 700px;">
      <div class="legend-pdf-container" style="justify-content: flex-start; margin-bottom: 8px;">
  ...
  \`
}`,...(h=(y=n.parameters)==null?void 0:y.docs)==null?void 0:h.source}}};var E,F,w;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => \`
    \${legendPDFStyles}
    <div class="pdf-page-demo" style="max-width: 700px;">
      <div class="pdf-header" style="border-bottom: 3px double #6E63E8;">
  ...
  \`
}`,...(w=(F=d.parameters)==null?void 0:F.docs)==null?void 0:w.source}}};var B,A,P;p.parameters={...p.parameters,docs:{...(B=p.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => \`
    \${legendPDFStyles}
    <div style="background: white; padding: 16px; max-width: 600px;">
      <div class="legend-pdf-container" style="justify-content: space-between; border-bottom: 1px solid #E0E0E0; padding-bottom: 8px; margin-bottom: 12px;">
  ...
  \`
}`,...(P=(A=p.parameters)==null?void 0:A.docs)==null?void 0:P.source}}};var D,z,C;i.parameters={...i.parameters,docs:{...(D=i.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => \`
    \${legendPDFStyles}
    <div style="background: #E8F5E9; border-left: 4px solid #28C76F; padding: 16px; border-radius: 6px; margin-bottom: 24px; max-width: 700px;">
      <h4 style="font-size: 14px; font-weight: 600; color: #2E7D32; margin: 0 0 8px 0;">
  ...
  \`
}`,...(C=(z=i.parameters)==null?void 0:z.docs)==null?void 0:C.source}}};var S,k,I;o.parameters={...o.parameters,docs:{...(S=o.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => \`
    \${legendPDFStyles}
    <div style="background: #FFF8E1; border-left: 4px solid #FF9F43; padding: 16px; border-radius: 6px; margin-bottom: 24px; max-width: 700px;">
      <h4 style="font-size: 14px; font-weight: 600; color: #F57F17; margin: 0 0 8px 0;">
  ...
  \`
}`,...(I=(k=o.parameters)==null?void 0:k.docs)==null?void 0:I.source}}};const j=["Default","AllStatuses","InPDFReport","CompactMultiple","InCertificate","WithPercentages","PrintOptimized","Responsive"];export{a as AllStatuses,n as CompactMultiple,s as Default,d as InCertificate,e as InPDFReport,i as PrintOptimized,o as Responsive,p as WithPercentages,j as __namedExportsOrder,L as default};
