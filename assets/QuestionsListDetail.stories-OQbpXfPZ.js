const A={title:"Educacross Components V2/Lists/QuestionsListDetail",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`QuestionsListDetail - Lista Detalhada de Questões
=================================================
  ...
  ${[1,2,3].map(s=>`
    <div class="question-item">
      <div class="question-header">
        <div class="question-number">${s}</div>
      ...
      <div class="alternatives">
        ${["A","B","C","D"].map((i,t)=>`
          <div class="alternative-item ${t===0?"correct":""}">
            <div class="alternative-letter">${i}</div>
            <span>${t===0?"5/4":t===1?"4/6":t===2?"3/6":"1/2"}</span>
          </div>
        `).join("")}
      </div>
...
<div class="questions-list">
  ...
  <div class="question-item">
    ...
    <div class="alternatives">
      ${["Equilátero","Isósceles","Escaleno","Retângulo"].map((s,i)=>`
        <div class="alternative-item ${i===0?"correct":""}">
          <div class="alternative-letter">${String.fromCharCode(65+i)}</div>
          <span>${s}</span>
        </div>
      `).join("")}
    </div>
...
<div class="questions-list">
  ...
  ${[1,2].map(s=>`
    <div class="question-item">
      ...
      <div class="question-content">
        ${s===1?"A fotossíntese é o processo pelo qual as plantas produzem seu próprio alimento.":"O Sol é o planeta mais próximo da Terra."}
      </div>
      <div class="alternatives">
        ${["Verdadeiro","Falso"].map((i,t)=>`
          <div class="alternative-item ${s===1&&t===0||s===2&&t===1?"correct":""}">
            <div class="alternative-letter">${t===0?"V":"F"}</div>
            <span>${i}</span>
          </div>
        `).join("")}
      </div>
...
<div class="questions-list">
  ...
  ${[{q:"Resolva a equação: 2x + 5 = 15",topic:"Equações",diff:2,color:"#FF9F43"},{q:"Calcule a área de um triângulo com base 8cm e altura 5cm",topic:"Geometria",diff:1,color:"#28C76F"},{q:"Qual é o valor de π (pi) com 2 casas decimais?",topic:"Constantes",diff:1,color:"#28C76F"}].map((s,i)=>`
    <div class="question-item">
      <div class="question-header">
        <div class="question-number">${i+1}</div>
        <span class="question-type">📐 ${s.topic}</span>
      </div>
      <div class="question-content">${s.q}</div>
      <div class="question-footer">
        <div class="difficulty">
          ${[1,2,3].map(t=>`
            <div class="diff-dot" style="background:${t<=s.diff?s.color:"#F3F2F7"}"></div>
          `).join("")}
        </div>
        <div class="question-actions">
...
<div class="questions-list">
  ...
  ${[{q:"Qual é a capital do Brasil?",uses:42,correct:95,subject:"Geografia"},{q:'Conjugue o verbo "fazer" no pretérito perfeito',uses:38,correct:78,subject:"Português"}].map((s,i)=>`
    <div class="question-item">
      <div class="question-header">
        <div class="question-number">${i+1}</div>
        <span class="question-type">${s.subject}</span>
      </div>
      <div class="question-content">${s.q}</div>
      <div class="question-footer">
        <div class="footer-meta">
    ...
    <div class="question-item" style="border-color:#6E63E8;background:#6E63E810">
      <div style="display:flex;gap:16px">
        ...
        <div style="flex:1">
          ...
          <div class="question-content">
            Questão ${s}: Lorem ipsum dolor sit amet, consectetur adipiscing elit?
          </div>
        </div>
      </div>
    </div>
  ...
  ${[1,2,3,4].map(s=>`
    <div class="question-item" style="padding:12px;margin-bottom:8px">
      <div style="display:flex;gap:12px;align-items:center">
        <div class="question-number" style="width:28px;height:28px;font-size:13px">${s}</div>
        <div style="flex:1">
          <div style="font-size:14px;color:#3F3F46;margin-bottom:4px">
            Questão curta exemplo ${s}
          </div>
...
<style>${n}</style>
`};var u,p,b;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
<div class="questions-list">
  <div class="list-header">
    <div>
...
<style>\${css}</style>
\`
}`,...(b=(p=e.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};var m,x,f;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => \`
<div class="questions-list">
  <div class="list-header">
    <span class="list-title">Questões com Imagem</span>
...
<style>\${css}</style>
\`
}`,...(f=(x=a.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};var g,y,q;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => \`
<div class="questions-list">
  <div class="list-header">
    <span class="list-title">Questões V ou F</span>
...
<style>\${css}</style>
\`
}`,...(q=(y=o.parameters)==null?void 0:y.docs)==null?void 0:q.source}}};var F,h,E;d.parameters={...d.parameters,docs:{...(F=d.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => \`
<div class="questions-list">
  <div class="list-header">
    <div>
  ...
  \${[{
    q: 'Resolva a equação: 2x + 5 = 15',
    topic: 'Equações',
    diff: 2,
    color: '#FF9F43'
  }, {
    q: 'Calcule a área de um triângulo com base 8cm e altura 5cm',
    topic: 'Geometria',
    diff: 1,
    color: '#28C76F'
  }, {
    q: 'Qual é o valor de π (pi) com 2 casas decimais?',
    topic: 'Constantes',
    diff: 1,
    color: '#28C76F'
  }].map((item, i) => \`
...
<style>\${css}</style>
\`
}`,...(E=(h=d.parameters)==null?void 0:h.docs)==null?void 0:E.source}}};var $,C,D;l.parameters={...l.parameters,docs:{...($=l.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => \`
<div class="questions-list">
  <div class="list-header">
    <span class="list-title">Questões Mais Utilizadas</span>
  ...
  \${[{
    ...
    q: 'Conjugue o verbo "fazer" no pretérito perfeito',
    uses: 38,
    correct: 78,
    subject: 'Português'
  }].map((item, i) => \`
...
<style>\${css}</style>
\`
}`,...(D=(C=l.parameters)==null?void 0:C.docs)==null?void 0:D.source}}};var k,j,z;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => \`
<div class="questions-list">
  <div class="list-header">
    <div>
...
<style>\${css}</style>
\`
}`,...(z=(j=c.parameters)==null?void 0:j.docs)==null?void 0:z.source}}};var Q,w,B;r.parameters={...r.parameters,docs:{...(Q=r.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  render: () => \`
<div class="questions-list" style="max-width:600px;padding:16px">
  \${[1, 2, 3, 4].map(i => \`
    <div class="question-item" style="padding:12px;margin-bottom:8px">
...
<style>\${css}</style>
\`
}`,...(B=(w=r.parameters)==null?void 0:w.docs)==null?void 0:B.source}}};var M,V,S;v.parameters={...v.parameters,docs:{...(M=v.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => \`
<div class="questions-list">
  <div class="list-header">
    <span class="list-title">Banco de Questões</span>
...
<style>\${css}</style>
\`
}`,...(S=(V=v.parameters)==null?void 0:V.docs)==null?void 0:S.source}}};const L=["Default","ComImagem","VerdadeiroFalso","PorDisciplina","ComEstatisticas","ModoEdicao","Compacta","Vazio"];export{l as ComEstatisticas,a as ComImagem,r as Compacta,e as Default,c as ModoEdicao,d as PorDisciplina,v as Vazio,o as VerdadeiroFalso,L as __namedExportsOrder,A as default};
