import{f as B,a as J}from"./snippets-m8t1HIl1.js";const V={title:"Atoms/Forms/Select",tags:["autodocs"],parameters:{docs:{description:{component:`
# Select Dropdown
...
`,l=p.bind({});l.args={size:"default",disabled:!1,multiple:!1,state:"default"};const n=p.bind({});n.args={...l.args,size:"lg"};const r=p.bind({});r.args={...l.args,multiple:!0};const c=p.bind({});c.args={...l.args,disabled:!0};const i={parameters:{docs:{description:{story:`
...
\``,...(f=(h=d.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var S,y,E;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(E=(y=l.parameters)==null?void 0:y.docs)==null?void 0:E.source}}};var w,C,k;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`args => {
  const markup = createSelect(args);
  const feedbackMsg = args.state === 'valid' ? 'Looks good!' : args.state === 'invalid' ? 'Please select a valid option.' : '';
  return \`
    <div style="max-width: 400px;">
  ...
  \`;
}`,...(k=(C=n.parameters)==null?void 0:C.docs)==null?void 0:k.source}}};var $,F,j;r.parameters={...r.parameters,docs:{...($=r.parameters)==null?void 0:$.docs,source:{originalSource:`args => {
  const markup = createSelect(args);
  const feedbackMsg = args.state === 'valid' ? 'Looks good!' : args.state === 'invalid' ? 'Please select a valid option.' : '';
  return \`
    <div style="max-width: 400px;">
  ...
  \`;
}`,...(A=(T=c.parameters)==null?void 0:T.docs)==null?void 0:A.source}}};var D,P,O,R,z;i.parameters={...i.parameters,docs:{...(D=i.parameters)==null?void 0:D.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
}`,...(O=(P=i.parameters)==null?void 0:P.docs)==null?void 0:O.source},description:{story:`====================================
INTERACTIVE STORY - Select2 Real
====================================`,...(z=(R=i.parameters)==null?void 0:R.docs)==null?void 0:z.description}}};const Q=["Overview","Default","Sizes","Multiple","Disabled","InteractiveSelect2"];export{l as Default,c as Disabled,i as InteractiveSelect2,r as Multiple,d as Overview,n as Sizes,Q as __namedExportsOrder,V as default};
