import{f as D,a as M}from"./snippets-m8t1HIl1.js";const z={title:"Vuexy/Molecules/Actions/ButtonGroup",tags:["autodocs"],parameters:{docs:{description:{component:`
# Button Group
...
`,t=i.bind({});t.args={size:"default",variant:"outline-primary",vertical:!1};const a=i.bind({});a.args={...t.args,variant:"primary"};const e=i.bind({});e.args={...t.args,size:"sm"};const s=i.bind({});s.args={...t.args,size:"lg"};const r=i.bind({});r.args={...t.args,vertical:!0};const c={render:()=>`
    ...
    `,parameters:{docs:{description:{story:"Demo interativo com button groups funcionais usando state controlado (classes). Clique para alternar estados."},source:{code:`<!-- Toggle Selection -->
<div class="btn-group" role="group">
...
</div>`}}}};var u,p,d;b.parameters={...b.parameters,docs:{...(u=b.parameters)==null?void 0:u.docs,source:{originalSource:`() => \`
  <div class="row g-4">
    <div class="col-12">
      <h5>Variantes de Estilo</h5>
      <div class="demo-vertical-spacing">
...
\``,...(d=(p=b.parameters)==null?void 0:p.docs)==null?void 0:d.source}}};var m,y,g;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(L=(f=e.parameters)==null?void 0:f.docs)==null?void 0:L.source}}};var S,B,C;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`args => {
  const markup = createButtonGroup(args);
  return \`
    <div style="padding: 20px;">
      \${markup}
  ...
  \`;
}`,...(C=(B=s.parameters)==null?void 0:B.docs)==null?void 0:C.source}}};var $,G,T;r.parameters={...r.parameters,docs:{...($=r.parameters)==null?void 0:$.docs,source:{originalSource:`args => {
  const markup = createButtonGroup(args);
  return \`
    <div style="padding: 20px;">
      \${markup}
  ...
  \`;
}`,...(T=(G=r.parameters)==null?void 0:G.docs)==null?void 0:T.source}}};var I,R,E;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: () => {
    return \`
      <div class="p-4">
        <h6 class="mb-3">Interactive Button Groups</h6>
...
}`,...(E=(R=c.parameters)==null?void 0:R.docs)==null?void 0:E.source}}};const H=["Overview","Default","Primary","Small","Large","Vertical","Interactive"];export{t as Default,c as Interactive,s as Large,b as Overview,a as Primary,e as Small,r as Vertical,H as __namedExportsOrder,z as default};
