const L={title:"Educacross Components V2/Missions/MissionDetails",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`MissionDetails - Detalhes Completos de Missão
============================================
...
`,e={render:()=>s(`
      ...
      <div class="mission-body">
        <div class="mission-section">
          ...
          <div class="objective-list">
            ${[{title:"Identificar frações equivalentes no cotidiano",tags:["BNCC - EF08MA09","Competência 3"]},{title:"Resolver problemas com frações em receitas",tags:["Habilidade 8B","Pensamento crítico"]},{title:"Colaborar em equipes para dividir tarefas",tags:["Competência socioemocional"]}].map((i,a)=>`
              <div class="objective-item">
                <div class="objective-index">${a+1}</div>
                <div class="objective-info">
                  <div style="font-weight:600;color:#2F2B3D">${i.title}</div>
                  <div class="objective-tags">
                    ${i.tags.map(v=>`<span class="objective-tag">${v}</span>`).join("")}
                  </div>
                </div>
              </div>
            `).join("")}
        ...
        <div class="mission-section">
          ...
          <div class="timeline">
            ${[{label:"Preparação e leitura da missão",date:"01 a 05 de fevereiro"},{label:"Execução em equipes (laboratório de ciências)",date:"06 a 15 de fevereiro"},{label:"Apresentação dos resultados",date:"18 a 20 de fevereiro"}].map(i=>`
        ...
        <div class="mission-section">
          ...
          <div class="student-grid">
            ${[{name:"Equipe 1 • Ana, João, Laura",status:"Missão em revisão",progress:88},{name:"Equipe 2 • Bruno, Camila, Igor",status:"Enviaram evidências",progress:76},{name:"Equipe 3 • Diana, Enzo, Maria",status:"Precisam reenviar foto",progress:58},{name:"Equipe 4 • Felipe, Helena, Otávio",status:"Começando atividades",progress:32}].map(i=>`
              <div class="student-card">
                <div class="student-header">
                  <div class="student-avatar">${i.name.charAt(7)}</div>
                  <div>
                    <div class="student-name">${i.name}</div>
                    <div class="student-status">${i.status}</div>
                  </div>
                </div>
                <div class="student-progress"><span style="width:${i.progress}%"></span></div>
              </div>
            `).join("")}
          </div>
        </div>
      ...
      <div class="mission-body">
        <div class="mission-section">
          ...
          <div class="resource-list">
            ${[{type:"Relatório PDF",by:"Ana e Sofia",date:"Enviado em 07/02 às 18h40",status:"Aguardando feedback"},{type:"Galeria de fotos",by:"Bruno e Tiago",date:"Enviado em 07/02 às 19h05",status:"Aprovado"},{type:"Vídeo curto",by:"Lia e Pedro",date:"Enviado em 08/02 às 08h10",status:"Solicitar ajustes"}].map(i=>`
              <div class="resource-item" style="border-radius:10px">
                <div class="resource-left">
                  <i class="bi bi-file-earmark-richtext" style="color:#6E63E8"></i>
                  <div>
                    <div style="font-weight:600">${i.type}</div>
                    <div style="font-size:12px;color:#6E6B7B">${i.by} • ${i.date}</div>
                  </div>
                </div>
                <span class="resource-chip">${i.status}</span>
              </div>
            `).join("")}
          </div>
        </div>
    ...
    <div class="mission-card">
      ...
      <div class="mission-body">
        <div class="mission-section">
          ...
          <div class="objective-list">
            ${[{title:"Guardião Dourado",tags:["Entrega pontual","+150 XP","Badge lendária"]},{title:"Narrador Criativo",tags:["Texto com 3 recursos narrativos","+80 XP"]},{title:"Mentor da Turma",tags:["Ajudou 3 colegas","+60 XP","Mentoria"]}].map((i,a)=>`
              <div class="objective-item" style="background:#FFF7E9;border-color:#FDD9A5">
                <div class="objective-index" style="background:#FF9F43">${a+1}</div>
                <div class="objective-info">
                  <div style="font-weight:600;color:#C05621">${i.title}</div>
                  <div class="objective-tags">
                    ${i.tags.map(v=>`<span class="objective-tag" style="background:#FFE8CC;color:#BF4B17">${v}</span>`).join("")}
                  </div>
                </div>
              </div>
            `).join("")}
        ...
        <div class="mission-section">
          ...
          <div class="student-grid" style="grid-template-columns:repeat(auto-fill,minmax(200px,1fr))">
            ${[{name:"Ana Clara",xp:1890,badge:"Lendária"},{name:"Gabriel Souza",xp:1720,badge:"Épica"},{name:"Isabela Nunes",xp:1615,badge:"Rara"},{name:"Miguel Teixeira",xp:1580,badge:"Rara"}].map(i=>`
              <div class="student-card" style="background:#FFF4E8;border-color:#FBD0A3">
                <div class="student-header">
                  <div class="student-avatar" style="background:#FFB26B;color:#fff">${i.name.charAt(0)}</div>
                  <div>
                    <div class="student-name" style="color:#C05621">${i.name}</div>
                    <div class="student-status">${i.xp} XP • Badge ${i.badge}</div>
                  </div>
                </div>
              </div>
            `).join("")}
    ...
    <div class="mission-card">
      ...
      <div class="mission-body">
        ...
        <div class="mission-section">
          ...
          <div class="resource-list">
            ${[{item:"Disponibilizar diário de bordo digital",status:"Concluído",icon:"bi-check-circle",color:"#28C76F"},{item:"Enviar lembrete às famílias",status:"Agendado para 12/02",icon:"bi-clock-history",color:"#FF9F43"},{item:"Separar materiais para mini planetário",status:"Em andamento",icon:"bi-gear",color:"#6E63E8"}].map(i=>`
              <div class="resource-item">
                <div class="resource-left">
                  <i class="bi ${i.icon}" style="color:${i.color}"></i>
                  <div>
                    <div style="font-weight:600">${i.item}</div>
                    <div style="font-size:12px;color:#6E6B7B">${i.status}</div>
                  </div>
                </div>
                <span class="resource-chip">${i.color==="#28C76F"?"OK":"Planejado"}</span>
              </div>
            `).join("")}
          </div>
        </div>
    ...
    <div class="mission-card">
      ...
      <div class="mission-body">
        <div class="mission-section">
          ...
          <div class="resource-list">
            ${[{mission:"Projeto Cidadania Digital",owner:"Profª Helena",status:"Solicitar atualização de evidências"},{mission:"Laboratório de Química Verde",owner:"Prof. Victor",status:"Sem nota atribuída há 5 dias"},{mission:"Crônicas do Cotidiano",owner:"Profª Carla",status:"Feedback da coordenação enviado"}].map(i=>`
              <div class="resource-item">
                <div class="resource-left">
                  <i class="bi bi-flag"></i>
                  <div>
                    <div style="font-weight:600">${i.mission}</div>
                    <div style="font-size:12px;color:#6E6B7B">${i.owner}</div>
                  </div>
                </div>
                <span class="resource-chip">${i.status}</span>
              </div>
        ...
        <div class="mission-section">
          ...
          <div class="student-grid" style="grid-template-columns:repeat(auto-fill,minmax(210px,1fr))">
            ${[{name:"Missão Matemática Financeira",prof:"Prof. Diego",result:"98% dos alunos entregaram com excelência"},{name:"Circuito de Ciências",prof:"Profª Larissa",result:"Projeto apresentado na feira municipal"}].map(i=>`
              <div class="student-card" style="background:#F3F2FF;border-color:#D7D4FF">
                <div class="student-name" style="color:#3F3F8F">${i.name}</div>
                <div class="student-status">${i.prof}</div>
                <div style="font-size:12px;color:#3F3F46">${i.result}</div>
              </div>
            `).join("")}
          </div>
        </div>
    ...
    <div class="mission-card">
      ...
      <div class="mission-body">
        <div class="mission-section">
          ...
          <div class="objective-list">
            ${[{title:"Ler o resumo sobre biomas brasileiros",status:"Concluído",icon:"bi-check-circle",color:"#28C76F"},{title:"Registrar observações em diário ilustrado",status:"Em andamento",icon:"bi-pencil-square",color:"#6E63E8"},{title:"Enviar áudio explicando descobertas",status:"Pendente",icon:"bi-mic",color:"#FF9F43"}].map((i,a)=>`
              <div class="objective-item" style="background:#F8F7FD;border-color:#E2E1F7">
                <div class="objective-index" style="background:${i.color}">${a+1}</div>
                <div class="objective-info">
                  <div style="display:flex;align-items:center;gap:8px;font-weight:600;color:#2F2B3D">
                    <i class="bi ${i.icon}" style="color:${i.color}"></i>
                    ${i.title}
                  </div>
                  <div style="font-size:12px;color:#6E6B7B">Status: ${i.status}</div>
                </div>
              </div>
            `).join("")}
          </div>
  ...
  `)};var p,m,b;e.parameters={...e.parameters,docs:{...(p=e.parameters)==null?void 0:p.docs,source:{originalSource:`{
    ...
    <div class="mission-card">
      ...
      <div class="mission-body">
        <div class="mission-section">
          ...
          <div class="objective-list">
            \${[{
    title: 'Identificar frações equivalentes no cotidiano',
    tags: ['BNCC - EF08MA09', 'Competência 3']
  }, {
    title: 'Resolver problemas com frações em receitas',
    tags: ['Habilidade 8B', 'Pensamento crítico']
  }, {
    title: 'Colaborar em equipes para dividir tarefas',
    tags: ['Competência socioemocional']
  }].map((obj, index) => \`
              <div class="objective-item">
        ...
        <div class="mission-section">
          ...
          <div class="timeline">
            \${[{
    label: 'Preparação e leitura da missão',
    date: '01 a 05 de fevereiro'
  }, {
    label: 'Execução em equipes (laboratório de ciências)',
    date: '06 a 15 de fevereiro'
  }, {
    label: 'Apresentação dos resultados',
    date: '18 a 20 de fevereiro'
  }].map(item => \`
              <div class="timeline-item">
                <span class="timeline-badge"></span>
                <div>
        ...
        <div class="mission-section">
          ...
          <div class="student-grid">
            \${[{
    name: 'Equipe 1 • Ana, João, Laura',
    status: 'Missão em revisão',
    progress: 88
  }, {
    name: 'Equipe 2 • Bruno, Camila, Igor',
    status: 'Enviaram evidências',
    progress: 76
  }, {
    name: 'Equipe 3 • Diana, Enzo, Maria',
    status: 'Precisam reenviar foto',
    progress: 58
  }, {
    name: 'Equipe 4 • Felipe, Helena, Otávio',
    status: 'Começando atividades',
    progress: 32
  }].map(team => \`
              <div class="student-card">
                <div class="student-header">
  ...
  \`)
}`,...(b=(m=e.parameters)==null?void 0:m.docs)==null?void 0:b.source}}};var u,g,x;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => withContainer(\`
    <div class="mission-card">
      <div class="mission-header">
        <div>
    ...
    type: 'Relatório PDF',
    by: 'Ana e Sofia',
    date: 'Enviado em 07/02 às 18h40',
    status: 'Aguardando feedback'
  }, {
    type: 'Galeria de fotos',
    by: 'Bruno e Tiago',
    date: 'Enviado em 07/02 às 19h05',
    status: 'Aprovado'
  }, {
    type: 'Vídeo curto',
    by: 'Lia e Pedro',
    date: 'Enviado em 08/02 às 08h10',
  ...
  \`)
}`,...(x=(g=n.parameters)==null?void 0:g.docs)==null?void 0:x.source}}};var E,f,F;o.parameters={...o.parameters,docs:{...(E=o.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => withContainer(\`
    <div class="mission-card">
      <div class="mission-header">
        <div>
    ...
    tags: ['Entrega pontual', '+150 XP', 'Badge lendária']
  }, {
    title: 'Narrador Criativo',
    tags: ['Texto com 3 recursos narrativos', '+80 XP']
  }, {
    title: 'Mentor da Turma',
    tags: ['Ajudou 3 colegas', '+60 XP', 'Mentoria']
  }].map((badge, index) => \`
              <div class="objective-item" style="background:#FFF7E9;border-color:#FDD9A5">
  ...
  \`)
}`,...(F=(f=o.parameters)==null?void 0:f.docs)==null?void 0:F.source}}};var h,y,k;d.parameters={...d.parameters,docs:{...(h=d.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => withContainer(\`
    <div class="mission-card">
      <div class="mission-header">
        <div>
      ...
      <div class="mission-body">
        ...
        <div class="mission-section">
          ...
          <div class="resource-list">
            \${[{
    item: 'Disponibilizar diário de bordo digital',
    status: 'Concluído',
    icon: 'bi-check-circle',
    color: '#28C76F'
  }, {
    item: 'Enviar lembrete às famílias',
    status: 'Agendado para 12/02',
    icon: 'bi-clock-history',
    color: '#FF9F43'
  }, {
    item: 'Separar materiais para mini planetário',
    status: 'Em andamento',
    icon: 'bi-gear',
    color: '#6E63E8'
  }].map(check => \`
  ...
  \`)
}`,...(k=(y=d.parameters)==null?void 0:y.docs)==null?void 0:k.source}}};var C,j,A;t.parameters={...t.parameters,docs:{...(C=t.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => withContainer(\`
    <div class="mission-card">
      <div class="mission-header">
        <div>
      ...
      <div class="mission-body">
        <div class="mission-section">
          ...
          <div class="resource-list">
            \${[{
    mission: 'Projeto Cidadania Digital',
    owner: 'Profª Helena',
    status: 'Solicitar atualização de evidências'
  }, {
    mission: 'Laboratório de Química Verde',
    owner: 'Prof. Victor',
    status: 'Sem nota atribuída há 5 dias'
  }, {
    mission: 'Crônicas do Cotidiano',
    owner: 'Profª Carla',
    status: 'Feedback da coordenação enviado'
  }].map(priority => \`
              <div class="resource-item">
                <div class="resource-left">
                  <i class="bi bi-flag"></i>
        ...
        <div class="mission-section">
          ...
          <div class="student-grid" style="grid-template-columns:repeat(auto-fill,minmax(210px,1fr))">
            \${[{
    name: 'Missão Matemática Financeira',
    prof: 'Prof. Diego',
    result: '98% dos alunos entregaram com excelência'
  }, {
    name: 'Circuito de Ciências',
    prof: 'Profª Larissa',
    result: 'Projeto apresentado na feira municipal'
  }].map(highlight => \`
              <div class="student-card" style="background:#F3F2FF;border-color:#D7D4FF">
  ...
  \`)
}`,...(A=(j=t.parameters)==null?void 0:j.docs)==null?void 0:A.source}}};var $,D,z;r.parameters={...r.parameters,docs:{...($=r.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => withContainer(\`
    <div class="mission-card">
      <div class="mission-header">
        <div>
      ...
      <div class="mission-body">
        <div class="mission-section">
          ...
          <div class="objective-list">
            \${[{
    title: 'Ler o resumo sobre biomas brasileiros',
    status: 'Concluído',
    icon: 'bi-check-circle',
    color: '#28C76F'
  }, {
    title: 'Registrar observações em diário ilustrado',
    status: 'Em andamento',
    icon: 'bi-pencil-square',
    color: '#6E63E8'
  }, {
    title: 'Enviar áudio explicando descobertas',
    status: 'Pendente',
    icon: 'bi-mic',
    color: '#FF9F43'
  }].map((task, index) => \`
  ...
  \`)
}`,...(z=(D=r.parameters)==null?void 0:D.docs)==null?void 0:z.source}}};var P,w,B;l.parameters={...l.parameters,docs:{...(P=l.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => withContainer(\`
    <div class="mission-card" style="max-width:520px;margin:0 auto">
      <div class="mission-header" style="gap:12px">
        <div>
  ...
  \`)
}`,...(B=(w=l.parameters)==null?void 0:w.docs)==null?void 0:B.source}}};var M,R,q;c.parameters={...c.parameters,docs:{...(M=c.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => withContainer(\`
    <div class="mission-empty">
      <svg viewBox="0 0 24 24" fill="currentColor">
        <path d="M5 4h14a2 2 0 0 1 2 2v11.5a1.5 1.5 0 0 1-2.45 1.11L14 15.5l-4.55 3.11A1.5 1.5 0 0 1 7 17.5V6a2 2 0 0 1 2-2z"/>
  ...
  \`)
}`,...(q=(R=c.parameters)==null?void 0:R.docs)==null?void 0:q.source}}};const I=["Default","ComEvidencias","Gamificacao","PlanejamentoProfessor","PainelGestor","VisaoAluno","Compacto","Vazio"];export{n as ComEvidencias,l as Compacto,e as Default,o as Gamificacao,t as PainelGestor,d as PlanejamentoProfessor,c as Vazio,r as VisaoAluno,I as __namedExportsOrder,L as default};
