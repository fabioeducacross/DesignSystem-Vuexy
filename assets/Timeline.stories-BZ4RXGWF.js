import{f as O,a as j}from"./snippets-m8t1HIl1.js";const $={title:"Vuexy/Organisms/Content/Timeline",tags:["autodocs"],parameters:{docs:{description:{component:`
# Timeline
...
- Timestamps legíveis
- Conteúdo semântico
        `}}},argTypes:{variant:{control:{type:"select"},options:["primary","secondary","success","info","warning","danger"],description:"Cor da linha e markers",table:{defaultValue:{summary:"primary"}}}}},I=({variant:c="primary"})=>`<ul class="list-group list-group-timeline list-group-timeline-${c}">
  ...
  <li class="list-group-item">
    ...
    <details>
      ...
      <div class="mt-3">
        <h6>HTML</h6>
        <pre><code>${O(r).replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
        <h6>React</h6>
        <pre><code>${j(r,"Timeline").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
      </div>
    </details>
  `},n=()=>`
  <div class="row g-4">
...
`,s=i.bind({});s.args={variant:"primary"};const e=i.bind({});e.args={variant:"success"};const t=i.bind({});t.args={variant:"warning"};const l=i.bind({});l.args={variant:"danger"};const a=i.bind({});a.args={variant:"info"};const m=()=>`
  ...
  `;var d,o,p;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`() => \`
  <div class="row g-4">
    <div class="col-md-6">
      <h5>Default Timeline</h5>
      <ul class="list-group list-group-timeline">
...
\``,...(p=(o=n.parameters)==null?void 0:o.docs)==null?void 0:p.source}}};var u,g,v;s.parameters={...s.parameters,docs:{...(u=s.parameters)==null?void 0:u.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(v=(g=s.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};var b,x,h;e.parameters={...e.parameters,docs:{...(b=e.parameters)==null?void 0:b.docs,source:{originalSource:`args => {
  const markup = createTimeline(args);
  return \`
    <div style="max-width: 600px;">
      \${markup}
  ...
  \`;
}`,...(h=(x=e.parameters)==null?void 0:x.docs)==null?void 0:h.source}}};var f,y,w;t.parameters={...t.parameters,docs:{...(f=t.parameters)==null?void 0:f.docs,source:{originalSource:`args => {
  const markup = createTimeline(args);
  return \`
    <div style="max-width: 600px;">
      \${markup}
  ...
  \`;
}`,...(w=(y=t.parameters)==null?void 0:y.docs)==null?void 0:w.source}}};var k,C,S;l.parameters={...l.parameters,docs:{...(k=l.parameters)==null?void 0:k.docs,source:{originalSource:`args => {
  const markup = createTimeline(args);
  return \`
    <div style="max-width: 600px;">
      \${markup}
  ...
  \`;
}`,...(S=(C=l.parameters)==null?void 0:C.docs)==null?void 0:S.source}}};var A,E,D;a.parameters={...a.parameters,docs:{...(A=a.parameters)==null?void 0:A.docs,source:{originalSource:`args => {
  const markup = createTimeline(args);
  return \`
    <div style="max-width: 600px;">
      \${markup}
  ...
  \`;
}`,...(D=(E=a.parameters)==null?void 0:E.docs)==null?void 0:D.source}}};var T,P,L;m.parameters={...m.parameters,docs:{...(T=m.parameters)==null?void 0:T.docs,source:{originalSource:`() => {
  return \`
    <div class="card" style="max-width: 700px; margin: 0 auto;">
      <div class="card-body">
        <h5 class="card-title mb-3">📋 Activity Timeline</h5>
  ...
  \`;
}`,...(L=(P=m.parameters)==null?void 0:P.docs)==null?void 0:L.source}}};const q=["Overview","Default","Success","Warning","Danger","Info","Interactive"];export{l as Danger,s as Default,a as Info,m as Interactive,n as Overview,e as Success,t as Warning,q as __namedExportsOrder,$ as default};
