...
- Navegável por teclado (Enter/Space)
        `}}},argTypes:{flush:{control:"boolean",description:"Remove bordas e arredondamento",table:{defaultValue:{summary:!1}}},alwaysOpen:{control:"boolean",description:"Permite múltiplos painéis abertos",table:{defaultValue:{summary:!1}}}}},O=({flush:o=!1,alwaysOpen:a=!1})=>{const s=o?"accordion-flush":"",d=a?"":'data-bs-parent="#accordionExample"';return`<div class="accordion ${s}" id="accordionExample">
...
`,c=l.bind({});c.args={flush:!1,alwaysOpen:!1};const i=l.bind({});i.args={flush:!0,alwaysOpen:!1};const t=l.bind({});t.args={flush:!1,alwaysOpen:!0};const e={parameters:{docs:{description:{story:`
...
4. Use teclado (Tab + Enter)
        `}}},loaders:[async()=>typeof window<"u"&&!window.bootstrap?new Promise((o,a)=>{const s=document.createElement("script");s.src="/vuexy/js/bootstrap.js",s.onload=()=>{console.log("✅ Bootstrap JS carregado para Accordion"),o({bootstrapLoaded:!0})},s.onerror=()=>a(new Error("Failed to load Bootstrap JS")),document.head.appendChild(s)}):{bootstrapLoaded:!0}],render:()=>`
...
\``,...(b=(p=n.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};var u,v,m;c.parameters={...c.parameters,docs:{...(u=c.parameters)==null?void 0:u.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(m=(v=c.parameters)==null?void 0:v.docs)==null?void 0:m.source}}};var h,g,f;i.parameters={...i.parameters,docs:{...(h=i.parameters)==null?void 0:h.docs,source:{originalSource:`args => {
  const markup = createAccordion(args);
  return \`
    <div style="max-width: 800px;">
      \${markup}
  ...
  \`;
}`,...(f=(g=i.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var y,x,w;t.parameters={...t.parameters,docs:{...(y=t.parameters)==null?void 0:y.docs,source:{originalSource:`args => {
  const markup = createAccordion(args);
  return \`
    <div style="max-width: 800px;">
      \${markup}
  ...
  \`;
}`,...(w=(x=t.parameters)==null?void 0:x.docs)==null?void 0:w.source}}};var A,E,k,F,S;e.parameters={...e.parameters,docs:{...(A=e.parameters)==null?void 0:A.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
====================================`,...(S=(F=e.parameters)==null?void 0:F.docs)==null?void 0:S.description}}};const D=["Overview","Default","Flush","AlwaysOpen","Interactive"];export{t as AlwaysOpen,c as Default,i as Flush,e as Interactive,n as Overview,D as __namedExportsOrder,q as default};
