const L={title:"Educacross Components V2/Tables/ListTableRanking",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
`,R=[{n:"Ana Silva",c:"8º A",s:9.8,x:2850,col:"#6E63E8"},{n:"Bruno Costa",c:"8º B",s:9.5,x:2720,col:"#00CFE8"},{n:"Diana Santos",c:"8º A",s:9.3,x:2650,col:"#28C76F"},{n:"Eduardo Lima",c:"9º A",s:9,x:2480,col:"#FF9F43"},{n:"Fernanda Alves",c:"8º B",s:8.8,x:2350,col:"#EA5455"}],a={render:()=>`
    ${o}
    <div class="ranking-table">
      ...
      ${R.map((i,n)=>`
        <div class="ranking-row">
          <div class="position position-${n<3?n+1:"default"}">${n+1}º</div>
          <div class="student-info">
            <div class="student-avatar" style="background: ${i.col};">
              ${i.n.split(" ").map(s=>s[0]).join("")}
            </div>
            <div>
              <div class="student-name">${i.n}</div>
              <div class="student-class">Turma ${i.c}</div>
            </div>
          </div>
          <div class="score" style="color: #28C76F;">${i.s}</div>
          <div style="color: #6E63E8; font-weight: 600;">${i.x} XP</div>
        </div>
      `).join("")}
    </div>
  `},d={render:()=>`
  ...
  `},t={render:()=>`
    ...
    <div class="ranking-table">
      ...
      ${[{n:"João Silva",c:"Matemático",s:"Destaque",p:3200,col:"#6E63E8",b:"#28C76F"},{n:"Maria Costa",c:"Leitora Expert",s:"Ativo",p:2950,col:"#00CFE8",b:"#6E63E8"},{n:"Pedro Santos",c:"Cientista",s:"Ativo",p:2800,col:"#28C76F",b:"#6E63E8"},{n:"Ana Oliveira",c:"Artista",s:"Em Alta",p:2650,col:"#FF9F43",b:"#FF9F43"}].map((i,n)=>`
        <div class="ranking-row">
          <div class="position position-${n<3?n+1:"default"}">${n+1}º</div>
          <div class="student-info">
            <div class="student-avatar" style="background: ${i.col};">
            ...
            <div>
              <div class="student-name">${i.n}</div>
              <div class="student-class">${i.c}</div>
            </div>
          </div>
          <div>
            <span class="badge" style="background: ${i.b}20; color: ${i.b};">${i.s}</span>
          </div>
          <div style="font-weight: 700; color: #6E63E8;">${i.p}</div>
        </div>
      `).join("")}
    </div>
    <p style="margin-top: 16px; font-size: 13px; color: #6E6B7B;">
  ...
  `},e={render:()=>`
    ...
    <div class="ranking-table">
      ...
      ${[{n:"Ana Silva",m:10,p:9.5},{n:"Bruno Costa",m:9.8,p:9.2},{n:"Diana Santos",m:9.5,p:9.8},{n:"Eduardo Lima",m:9.2,p:9},{n:"Fernanda Alves",m:9,p:9.3}].map((i,n)=>`
        <div class="ranking-row">
          <div class="position position-${n<3?n+1:"default"}">${n+1}º</div>
          <div class="student-info">
            <div class="student-avatar" style="background: ${["#6E63E8","#00CFE8","#28C76F","#FF9F43","#EA5455"][n]};">
              ${i.n.split(" ").map(s=>s[0]).join("")}
            </div>
            <div class="student-name">${i.n}</div>
          </div>
          <div class="score" style="color: #28C76F;">${i.m}</div>
          <div class="score" style="color: #6E63E8;">${i.p}</div>
        </div>
      `).join("")}
    </div>
    <p style="margin-top: 16px; font-size: 13px; color: #6E6B7B;">
  ...
  `},r={render:()=>`
    ...
    <div class="ranking-table">
      ...
      ${[{n:"Ana Silva",p:9.8,t:"+3",c:"#28C76F",i:"arrow-up"},{n:"Bruno Costa",p:9.5,t:"=",c:"#6E6B7B",i:"dash"},{n:"Diana Santos",p:9.3,t:"+1",c:"#28C76F",i:"arrow-up"},{n:"Eduardo Lima",p:9,t:"-2",c:"#EA5455",i:"arrow-down"},{n:"Fernanda Alves",p:8.8,t:"+5",c:"#28C76F",i:"arrow-up"}].map((i,n)=>`
        <div class="ranking-row">
          <div class="position position-${n<3?n+1:"default"}">${n+1}º</div>
          <div class="student-info">
            <div class="student-avatar" style="background: ${["#6E63E8","#00CFE8","#28C76F","#FF9F43","#EA5455"][n]};">
          ...
          <div class="score" style="color: #28C76F;">${i.p}</div>
          <div style="display: flex; align-items: center; gap: 6px; font-weight: 600; color: ${i.c};">
            <i class="bi bi-${i.i}"></i>
            ${i.t}
          </div>
        </div>
  ...
  `},l={render:()=>`
    ...
    <div class="ranking-table" style="max-width: 400px;">
      ...
      ${[{n:"Ana Silva",p:2850},{n:"Bruno Costa",p:2720},{n:"Diana Santos",p:2650}].map((i,n)=>`
        <div class="ranking-row">
          <div class="position position-${n+1}">${n+1}º</div>
          <div class="student-info">
            <div class="student-name">${i.n}</div>
          </div>
          <div style="font-weight: 700; color: #6E63E8;">${i.p} XP</div>
        </div>
      `).join("")}
    </div>
    <p style="margin-top: 16px; font-size: 13px; color: #6E6B7B;">
  ...
  `};var c,g,u;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="ranking-table">
      <div class="ranking-header">
  ...
  \`
}`,...(u=(g=a.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var m,x,f;d.parameters={...d.parameters,docs:{...(m=d.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; overflow: hidden;">
      <div class="podium">
  ...
  \`
}`,...(f=(x=d.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};var E,b,$;t.parameters={...t.parameters,docs:{...(E=t.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="ranking-table">
      <div class="ranking-header">
  ...
  \`
}`,...($=(b=t.parameters)==null?void 0:b.docs)==null?void 0:$.source}}};var y,F,k;e.parameters={...e.parameters,docs:{...(y=e.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="ranking-table">
      <div class="ranking-header">
  ...
  \`
}`,...(k=(F=e.parameters)==null?void 0:F.docs)==null?void 0:k.source}}};var h,C,B;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="ranking-table">
      <div class="ranking-header">
  ...
  \`
}`,...(B=(C=r.parameters)==null?void 0:C.docs)==null?void 0:B.source}}};var w,D,A;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="ranking-table" style="max-width: 400px;">
      <div style="padding: 16px; background: #6E63E8; color: #fff; font-weight: 700; font-size: 16px;">
  ...
  \`
}`,...(A=(D=l.parameters)==null?void 0:D.docs)==null?void 0:A.source}}};var P,z,S;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
  ...
  \`
}`,...(S=(z=p.parameters)==null?void 0:z.docs)==null?void 0:S.source}}};var j,T,M;v.parameters={...v.parameters,docs:{...(j=v.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="ranking-table">
      <div class="ranking-header">
  ...
  \`
}`,...(M=(T=v.parameters)==null?void 0:T.docs)==null?void 0:M.source}}};const X=["Default","TopTres","ComBadges","PorDisciplina","ComTendencia","MiniRanking","Completo","Empty"];export{t as ComBadges,r as ComTendencia,p as Completo,a as Default,v as Empty,l as MiniRanking,e as PorDisciplina,d as TopTres,X as __namedExportsOrder,L as default};
