const A={title:"Educacross Components V2/Cards/Card",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
<style>
...
- Page-break configurado
    ...
    <div class="print-grid">
      ...
      ${Array.from({length:5}).map((y,s)=>`
        <div class="student-card-body print-component">
          <div class="background">
            <div class="card-head-container">
              <img src="/vuexy/images/logo.png" alt="Logo" class="logo">
              <span class="font-bold text-black font-12">CARTÃO ${s+2}</span>
            </div>
            <div class="d-flex justify-between" style="height: 100px">
              <div class="info-container">
                <div class="d-flex flex-col">
                  <span class="font-bold font-16">ALUNO ${s+2}</span>
                  <div class="d-flex flex-col" style="margin-top: 10px">
                    <span class="font-bold font-14">
                      USUÁRIO: <span style="font-weight: normal">user${s+2}</span>
                    </span>
                    <span class="font-bold font-14">
                      SENHA: <span style="font-weight: normal">pass${s+2}</span>
                    </span>
                  </div>
                </div>
              </div>
  ...
  `};var t,o,r,d,l;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
- 4 frutas aleatórias para gamificação
  ...
  \`
}`,...(r=(o=e.parameters)==null?void 0:o.docs)==null?void 0:r.source},description:{story:`Matriz de UX Writing para Student Access Card
...
Cartão padrão com dados de exemplo`,...(l=(d=e.parameters)==null?void 0:d.docs)==null?void 0:l.description}}};var c,p,f,g,x;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
- Frutas específicas: Maçã, Banana, Uva, Laranja
  ...
  \`
}`,...(f=(p=a.parameters)==null?void 0:p.docs)==null?void 0:f.source},description:{story:`Story: WithStudentData - Card com Dados Reais
Cartão preenchido com informações de estudante`,...(x=(g=a.parameters)==null?void 0:g.docs)==null?void 0:x.description}}};var m,v,h,u,b;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
- Page-break configurado
  ...
  \`
}`,...(h=(v=n.parameters)==null?void 0:v.docs)==null?void 0:h.source},description:{story:`Story: PrintReady - Pronto para Impressão
Múltiplos cards em layout de impressão A4`,...(b=(u=n.parameters)==null?void 0:u.docs)==null?void 0:b.description}}};const E=["Default","WithStudentData","PrintReady"];export{e as Default,n as PrintReady,a as WithStudentData,E as __namedExportsOrder,A as default};
