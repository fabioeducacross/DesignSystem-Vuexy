const C={title:"Educacross Components V2/Feedback/ConditionalValueDisplay",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
`,i={render:()=>`
  ...
  `},e={render:()=>`
    ...
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 700px;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
          ${[{nome:"Ana Silva",media:"8.5",presenca:"95%",status:"available"},{nome:"Bruno Costa",media:"7.2",presenca:null,status:"pending"},{nome:"Carlos Mendes",media:null,presenca:"88%",status:"loading"},{nome:"Diana Santos",media:"9.0",presenca:"92%",status:"available"},{nome:"Eduardo Lima",media:null,presenca:null,status:"empty"}].map(n=>`
            <tr style="border-bottom: 1px solid #F3F2F7;">
              <td style="padding: 12px; font-size: 14px; color: #5E5873; font-weight: 600;">${n.nome}</td>
              <td style="padding: 12px; text-align: center;">
                ${n.media?`<span style="font-weight: 700; color: #28C76F;">${n.media}</span>`:n.status==="loading"?'<span class="conditional-loading" style="font-size: 12px; color: #00CFE8;">Calculando...</span>':'<span class="conditional-hidden" style="font-size: 12px;">Pendente</span>'}
              </td>
              <td style="padding: 12px; text-align: center;">
                ${n.presenca?`<span style="font-weight: 700; color: #6E63E8;">${n.presenca}</span>`:'<span class="conditional-hidden" style="font-size: 12px;">Não registrada</span>'}
              </td>
              <td style="padding: 12px; text-align: center;">
                ${n.status==="available"?'<i class="bi bi-check-circle-fill" style="color: #28C76F; font-size: 18px;"></i>':n.status==="loading"?'<i class="bi bi-arrow-clockwise" style="color: #00CFE8; font-size: 18px; animation: spin 1s linear infinite;"></i>':'<i class="bi bi-exclamation-circle-fill" style="color: #FF9F43; font-size: 18px;"></i>'}
              </td>
            </tr>
          `).join("")}
        </tbody>
  ...
  `};var d,c,p;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="display: flex; flex-direction: column; gap: 12px;">
      <div class="conditional-display">
  ...
  \`
}`,...(p=(c=i.parameters)==null?void 0:c.docs)==null?void 0:p.source}}};var r,x,m;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="display: flex; flex-direction: column; gap: 12px;">
      <div class="conditional-display">
  ...
  \`
}`,...(m=(x=o.parameters)==null?void 0:x.docs)==null?void 0:m.source}}};var v,g,f;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="display: flex; flex-direction: column; gap: 12px;">
      <div class="conditional-display conditional-hidden">
  ...
  \`
}`,...(f=(g=s.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var y,u,b;l.parameters={...l.parameters,docs:{...(y=l.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 24px; max-width: 550px;">
      <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 24px;">
  ...
  \`
}`,...(b=(u=l.parameters)==null?void 0:u.docs)==null?void 0:b.source}}};var h,E,w;e.parameters={...e.parameters,docs:{...(h=e.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 700px;">
      <h3 style="margin: 0 0 16px; font-size: 18px; font-weight: 600; color: #5E5873;">
    ...
    status: 'empty'
            ...
            <tr style="border-bottom: 1px solid #F3F2F7;">
              ...
              <td style="padding: 12px; text-align: center;">
                \${aluno.media ? \`<span style="font-weight: 700; color: #28C76F;">\${aluno.media}</span>\` : aluno.status === 'loading' ? '<span class="conditional-loading" style="font-size: 12px; color: #00CFE8;">Calculando...</span>' : '<span class="conditional-hidden" style="font-size: 12px;">Pendente</span>'}
              </td>
              <td style="padding: 12px; text-align: center;">
                \${aluno.presenca ? \`<span style="font-weight: 700; color: #6E63E8;">\${aluno.presenca}</span>\` : '<span class="conditional-hidden" style="font-size: 12px;">Não registrada</span>'}
              </td>
              <td style="padding: 12px; text-align: center;">
                \${aluno.status === 'available' ? '<i class="bi bi-check-circle-fill" style="color: #28C76F; font-size: 18px;"></i>' : aluno.status === 'loading' ? '<i class="bi bi-arrow-clockwise" style="color: #00CFE8; font-size: 18px; animation: spin 1s linear infinite;"></i>' : '<i class="bi bi-exclamation-circle-fill" style="color: #FF9F43; font-size: 18px;"></i>'}
              </td>
            </tr>
          \`).join('')}
        </tbody>
  ...
  \`
}`,...(w=(E=e.parameters)==null?void 0:E.docs)==null?void 0:w.source}}};var F,z,B;t.parameters={...t.parameters,docs:{...(F=t.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 850px;">
      <h3 style="margin: 0 0 20px; font-size: 18px; font-weight: 600; color: #5E5873;">
  ...
  \`
}`,...(B=(z=t.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};const D=["Default","ComValor","SemValor","PerfilDoAluno","RelatorioComDadosPendentes","DashboardComMetricas"];export{o as ComValor,t as DashboardComMetricas,i as Default,l as PerfilDoAluno,e as RelatorioComDadosPendentes,s as SemValor,D as __namedExportsOrder,C as default};
