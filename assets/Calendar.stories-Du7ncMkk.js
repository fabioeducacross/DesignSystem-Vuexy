import{f as W}from"./snippets-m8t1HIl1.js";const G={title:"Vuexy/Organisms/Productivity/Calendar",tags:["autodocs"],parameters:{docs:{description:{component:`
# Calendar
...
- Color + icon para categorias
        `}}},argTypes:{view:{control:"select",options:["month","week","day"],description:"Visualização do calendário",table:{defaultValue:{summary:"month"}}},withSidebar:{control:"boolean",description:"Incluir sidebar com filtros",table:{defaultValue:{summary:!0}}}}},P=({view:n="month",withSidebar:t=!0})=>`<div class="app-calendar">
  <div class="row g-0">
    ...
    <!-- Calendar Area -->
    <div class="${t?"col-lg-9 col-md-8":"col-12"}">
      <div class="card">
        <div class="card-body">
          <!-- Calendar Toolbar -->
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="btn-group" role="group">
              <button type="button" class="btn btn-sm ${n==="month"?"btn-primary":"btn-outline-primary"}">Month</button>
              <button type="button" class="btn btn-sm ${n==="week"?"btn-primary":"btn-outline-primary"}">Week</button>
              <button type="button" class="btn btn-sm ${n==="day"?"btn-primary":"btn-outline-primary"}">Day</button>
            </div>
          </div>
...
var calendar = new FullCalendar.Calendar(element, {
  ...
  `},u=()=>P({view:"month",withSidebar:!0}),r=v.bind({});r.args={view:"month",withSidebar:!0};const i=v.bind({});i.args={view:"month",withSidebar:!1};const d=v.bind({});d.args={view:"week",withSidebar:!0};const c=v.bind({});c.args={view:"day",withSidebar:!0};const o={parameters:{docs:{description:{story:`
...
5. Redimensione eventos (nas bordas)
        `}}},loaders:[async()=>typeof window<"u"?document.querySelector('link[href*="fullcalendar.css"]')?{fullcalendarLoaded:!0}:new Promise((n,t)=>{const l=document.createElement("link");l.rel="stylesheet",l.href="/vuexy/vendors/libs/fullcalendar/fullcalendar.css",l.onload=()=>{if(window.FullCalendar)n({fullcalendarLoaded:!0});else{const e=document.createElement("script");e.src="/vuexy/vendors/libs/fullcalendar/fullcalendar.js",e.onload=()=>{console.log("✅ FullCalendar CSS + JS carregados"),n({fullcalendarLoaded:!0})},e.onerror=()=>t(new Error("Failed to load FullCalendar JS")),document.head.appendChild(e)}},l.onerror=()=>t(new Error("Failed to load FullCalendar CSS")),document.head.appendChild(l)}):{}],render:()=>(setTimeout(()=>{if(window.FullCalendar){const n=document.getElementById("fullcalendar-interactive"),t=[{id:"1",title:"Reunião de Projeto",start:new Date(new Date().setHours(10,0,0)),end:new Date(new Date().setHours(11,30,0)),backgroundColor:"#7367f0",borderColor:"#7367f0",extendedProps:{category:"Reunião"}},{id:"2",title:"Almoço com Cliente",start:new Date(new Date().setHours(12,30,0)),end:new Date(new Date().setHours(14,0,0)),backgroundColor:"#28c76f",borderColor:"#28c76f",extendedProps:{category:"Cliente"}},{id:"3",title:"Apresentação Q1",start:new Date(new Date().setDate(new Date().getDate()+1)),allDay:!0,backgroundColor:"#ea5455",borderColor:"#ea5455",extendedProps:{category:"Importante"}},{id:"4",title:"Code Review",start:new Date(new Date().setDate(new Date().getDate()+2)),start:new Date(new Date(new Date().setDate(new Date().getDate()+2)).setHours(15,0,0)),end:new Date(new Date(new Date().setDate(new Date().getDate()+2)).setHours(16,0,0)),backgroundColor:"#ff9f43",borderColor:"#ff9f43",extendedProps:{category:"Desenvolvimento"}},{id:"5",title:"Workshop",start:new Date(new Date().setDate(new Date().getDate()+3)),allDay:!0,backgroundColor:"#00cfe8",borderColor:"#00cfe8",extendedProps:{category:"Treinamento"}},{id:"6",title:"Sprint Planning",start:new Date(new Date().setDate(new Date().getDate()+5)),start:new Date(new Date(new Date().setDate(new Date().getDate()+5)).setHours(9,0,0)),end:new Date(new Date(new Date().setDate(new Date().getDate()+5)).setHours(11,0,0)),backgroundColor:"#7367f0",borderColor:"#7367f0",extendedProps:{category:"Reunião"}},{id:"7",title:"Deploy Produção",start:new Date(new Date().setDate(new Date().getDate()+7)),allDay:!0,backgroundColor:"#ea5455",borderColor:"#ea5455",extendedProps:{category:"Importante"}}],l=new FullCalendar.Calendar(n,{initialView:"dayGridMonth",locale:"pt-br",headerToolbar:{left:"prev,next today",center:"title",right:"dayGridMonth,timeGridWeek,timeGridDay,listWeek"},buttonText:{today:"Hoje",month:"Mês",week:"Semana",day:"Dia",list:"Lista"},editable:!0,droppable:!0,eventResizableFromStart:!0,dayMaxEvents:!0,navLinks:!0,height:"auto",events:t,eventClick:function(e){const a=e.event,s=document.getElementById("event-modal"),m=document.getElementById("modal-event-title"),L=document.getElementById("modal-event-category"),p=document.getElementById("modal-event-time"),j=document.getElementById("modal-delete-btn");if(m.textContent=a.title,L.textContent=a.extendedProps.category||"Sem categoria",a.allDay)p.textContent="Dia inteiro";else{const b=a.start.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}),g=a.end?a.end.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"}):"";p.textContent=g?b+" - "+g:b}j.onclick=()=>{confirm("Deseja excluir este evento?")&&(a.remove(),s.style.display="none")},s.style.display="block"},dateClick:function(e){const a=prompt("Título do evento:");if(a){const s=["#7367f0","#28c76f","#ea5455","#ff9f43","#00cfe8"],m=s[Math.floor(Math.random()*s.length)];l.addEvent({title:a,start:e.date,allDay:e.allDay,backgroundColor:m,borderColor:m})}},eventDrop:function(e){console.log("Evento movido:",e.event.title)},eventResize:function(e){console.log("Evento redimensionado:",e.event.title)}});l.render(),document.getElementById("modal-close-btn").onclick=()=>{document.getElementById("event-modal").style.display="none"},document.getElementById("event-modal").onclick=e=>{e.target.id==="event-modal"&&(document.getElementById("event-modal").style.display="none")},console.log("✅ FullCalendar inicializado com",t.length,"eventos")}},100),`
      <style>
    ...
    `)};setTimeout(()=>{const n=document.getElementById("modal-close-btn-footer");n&&(n.onclick=()=>{document.getElementById("event-modal").style.display="none"})},150);var f,y,h;u.parameters={...u.parameters,docs:{...(f=u.parameters)==null?void 0:f.docs,source:{originalSource:`() => createCalendar({
  view: 'month',
  withSidebar: true
})`,...(h=(y=u.parameters)==null?void 0:y.docs)==null?void 0:h.source}}};var x,D,w;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`args => {
...
var calendar = new FullCalendar.Calendar(element, {
  ...
  \`;
}`,...(w=(D=r.parameters)==null?void 0:D.docs)==null?void 0:w.source}}};var C,k,E;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`args => {
  const markup = createCalendar(args);
  return \`
    \${markup}
...
var calendar = new FullCalendar.Calendar(element, {
  ...
  \`;
}`,...(E=(k=i.parameters)==null?void 0:k.docs)==null?void 0:E.source}}};var S,F,I;d.parameters={...d.parameters,docs:{...(S=d.parameters)==null?void 0:S.docs,source:{originalSource:`args => {
  const markup = createCalendar(args);
  return \`
    \${markup}
...
var calendar = new FullCalendar.Calendar(element, {
  ...
  \`;
}`,...(I=(F=d.parameters)==null?void 0:F.docs)==null?void 0:I.source}}};var T,M,z;c.parameters={...c.parameters,docs:{...(T=c.parameters)==null?void 0:T.docs,source:{originalSource:`args => {
  const markup = createCalendar(args);
  return \`
    \${markup}
...
var calendar = new FullCalendar.Calendar(element, {
  ...
  \`;
}`,...(z=(M=c.parameters)==null?void 0:M.docs)==null?void 0:z.source}}};var R,A,H,V,B;o.parameters={...o.parameters,docs:{...(R=o.parameters)==null?void 0:R.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
        ...
        const calendar = new FullCalendar.Calendar(calendarEl, {
          ...
          eventClick: function (info) {
            ...
            if (event.allDay) {
              ...
              const end = event.end ? event.end.toLocaleTimeString('pt-BR', {
                hour: '2-digit',
                minute: '2-digit'
              }) : '';
...
}`,...(H=(A=o.parameters)==null?void 0:A.docs)==null?void 0:H.source},description:{story:`====================================
INTERACTIVE STORY - FullCalendar Real
====================================`,...(B=(V=o.parameters)==null?void 0:V.docs)==null?void 0:B.description}}};const $=["Overview","WithSidebar","NoSidebar","WeekView","DayView","Interactive"];export{c as DayView,o as Interactive,i as NoSidebar,u as Overview,d as WeekView,r as WithSidebar,$ as __namedExportsOrder,G as default};
