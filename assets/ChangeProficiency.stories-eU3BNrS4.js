const J={title:"Educacross Components V2/Proficiency/ChangeProficiency",tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:`ChangeProficiency - Proficiency Level Change Component
=========================================
...
`,r=(e,a="")=>`
<div class="change-prof-shell ${a}">
  <div class="change-prof-modal">
    ${e}
  </div>
</div>
<style>${L}</style>
`,i=(e,a="Avaliação manual")=>`
...
`,b=(e,a)=>`
  <div class="proficiency-grid">
    <div class="proficiency-card current" data-label="ATUAL">
      ...
      <div class="proficiency-score">${e.score}</div>
      <div class="badge-pill">${e.label}</div>
      <div class="delta-chip ${e.delta>0?"up":"down"}">${e.delta>0?"▲":"▼"} ${Math.abs(e.delta)} pts desde o último ciclo</div>
    </div>
    <div class="proficiency-card target" data-label="NOVA">
      <div class="proficiency-label">Aplicar para</div>
      <div class="proficiency-score">${a.score}</div>
      <div class="badge-pill">${a.label}</div>
      <div style="font-size:12px;color:#6e6b7b">Justifique a mudança antes de confirmar.</div>
    </div>
  </div>
`,o=(e="Confirmar alteração",a=!1)=>`
  <div class="change-prof-footer">
    ...
    <div class="footer-actions">
      ...
      <button class="btn primary" ${a?"disabled":""}>${a?"Processando...":e}</button>
    </div>
  </div>
`,H=e=>`
  <div class="reason-box">
    <div style="font-weight:700;font-size:14px;color:#2f2b3d">Deseja registrar um motivo?</div>
    <textarea placeholder="${e}"></textarea>
...
`,I=()=>`
  <div class="timeline">
    ${[{label:"Coordenação",desc:"Proficiente → Avançado",time:"Ontem, 15:40"},{label:"Professor",desc:"Básico → Proficiente",time:"23 Jan"},{label:"Análise automática",desc:"Sugeriu revisão por discrepância",time:"21 Jan"}].map(e=>`
      <div class="timeline-item">
        <div style="font-weight:700;color:#2f2b3d">${e.label}</div>
        <div style="font-size:13px;color:#4b465c">${e.desc}</div>
        <div style="font-size:12px;color:#7f7b96">${e.time}</div>
      </div>
    `).join("")}
  </div>
`,n={render:()=>r(`
    ${i("Alterar proficiência do aluno")}
    <div class="change-prof-body">
      ${b({score:"B+",label:"Básico Superior",delta:1.2},{score:"A-",label:"Proficiente"})}
      ${I()}
    </div>
    ${o()}
  `)},s={render:()=>r(`
    ${i("Registrar justificativa detalhada","Obrigatório")}
    <div class="change-prof-body">
      ${b({score:"C+",label:"Básico",delta:-.4},{score:"B",label:"Proficiente inicial"})}
      ${H("Descreva a evidência que motivou a alteração...")}
    </div>
    ${o("Salvar justificativa")}
  `)},d={render:()=>r(`
    ${i("Relatar inconsistência na análise automática","Fluxo de validação")}
    <div class="change-prof-body">
      ...
      ${H("Relate o motivo da inconsistência ou anexe link da evidência.")}
      <div class="timeline">
        <div class="timeline-item">
    ...
    ${o("Enviar reporte")}
  `)},t={render:()=>r(`
    ${i("Escolher escala de proficiência","Multi-escala")}
    <div class="change-prof-body">
      <div class="scale-grid">
        ${[{label:"Avançado",desc:"Entrega acima do esperado",className:"advanced"},{label:"Proficiente",desc:"Cumpre todos os critérios",className:"proficient"},{label:"Básico",desc:"Atende parcialmente",className:"basic"},{label:"Abaixo do básico",desc:"Precisa de reforço",className:"below"}].map(e=>`
          <div class="scale-chip ${e.className}">
            <span>${e.label}</span>
            <small>${e.desc}</small>
          </div>
        `).join("")}
    ...
    ${o("Aplicar escala")}
  `)},c={render:()=>r(`
    ${i("Histórico de alterações","Log completo")}
    <div class="change-prof-body">
      ${I()}
    </div>
    ${o("Exportar registro")}
  `,"mobile")},l={render:()=>r(`
    ${i("Aviso rápido","Banner inline")}
    <div class="change-prof-body">
      <div class="inline-banner">
      ...
      ${b({score:"B",label:"Básico",delta:.2},{score:"A",label:"Avançado"})}
    </div>
    ${o("Confirmar para todos")}
  `)},p={render:()=>r(`
    ${i("Processando alteração","Sincronizando")}
    <div class="change-prof-body">
      ${b({score:"A-",label:"Proficiente",delta:.8},{score:"A",label:"Avançado"})}
    ...
    ${o("Salvando...",!0)}
  `)},f={render:()=>r(`
    ${i("Nenhuma alteração pendente","Limpo")}
  ...
  `)};var v,g,x;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => shell(\`
    \${header('Alterar proficiência do aluno')}
    <div class="change-prof-body">
      \${proficiencyCards({
    score: 'B+',
    label: 'Básico Superior',
    delta: 1.2
  }, {
    score: 'A-',
    label: 'Proficiente',
    ...
    \${footer()}
  \`)
}`,...(x=(g=n.parameters)==null?void 0:g.docs)==null?void 0:x.source}}};var m,u,h;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => shell(\`
  ...
  \`)
}`,...(h=(u=s.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};var y,$,E;d.parameters={...d.parameters,docs:{...(y=d.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => shell(\`
  ...
  \`)
}`,...(E=($=d.parameters)==null?void 0:$.docs)==null?void 0:E.source}}};var A,w,z;t.parameters={...t.parameters,docs:{...(A=t.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => shell(\`
    ...
    <div class="change-prof-body">
      <div class="scale-grid">
        \${[{
    label: 'Avançado',
    desc: 'Entrega acima do esperado',
    className: 'advanced'
  }, {
    label: 'Proficiente',
    desc: 'Cumpre todos os critérios',
    className: 'proficient'
  }, {
    label: 'Básico',
    desc: 'Atende parcialmente',
    className: 'basic'
  }, {
    label: 'Abaixo do básico',
    desc: 'Precisa de reforço',
    className: 'below'
  }].map(item => \`
  ...
  \`)
}`,...(z=(w=t.parameters)==null?void 0:w.docs)==null?void 0:z.source}}};var k,P,C;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => shell(\`
  ...
  \`, 'mobile')
}`,...(C=(P=c.parameters)==null?void 0:P.docs)==null?void 0:C.source}}};var S,B,j;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => shell(\`
  ...
  \`)
}`,...(j=(B=l.parameters)==null?void 0:B.docs)==null?void 0:j.source}}};var N,D,R;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => shell(\`
  ...
  \`)
}`,...(R=(D=p.parameters)==null?void 0:D.docs)==null?void 0:R.source}}};var V,q,F;f.parameters={...f.parameters,docs:{...(V=f.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: () => shell(\`
  ...
  \`)
}`,...(F=(q=f.parameters)==null?void 0:q.docs)==null?void 0:F.source}}};const O=["Default","ComJustificativa","ReportarInconsistencia","SelecionarEscala","HistoricoCompacto","BannerInline","ProcessoEmAndamento","EstadoVazio"];export{l as BannerInline,s as ComJustificativa,n as Default,f as EstadoVazio,c as HistoricoCompacto,p as ProcessoEmAndamento,d as ReportarInconsistencia,t as SelecionarEscala,O as __namedExportsOrder,J as default};
