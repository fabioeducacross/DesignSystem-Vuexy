...
`,na={title:"Educacross Components V2/Navigation/Tab",tags:["autodocs"],parameters:{docs:{description:{component:"Horizontal tab navigation with shadow effects, active states, and custom transform positioning. Supports scrollable tabs, icons, and notification badges."}}}},s={render:()=>`
    ${a}
  ...
  `},r={render:()=>(setTimeout(()=>{const b=document.querySelectorAll("#interactive-tabs .tab-link"),v=document.querySelector("#interactive-content-title"),p=document.querySelector("#interactive-content-text"),aa={"Visão Geral":{title:"Visão Geral",text:"Dashboard principal com resumo de todas as atividades e estatísticas gerais da turma."},"Minhas Missões":{title:"Minhas Missões",text:"Lista de todas as missões criadas. Você pode editar, duplicar ou excluir missões existentes."},Desempenho:{title:"Desempenho dos Alunos",text:"Gráficos e relatórios detalhados sobre o desempenho individual e coletivo dos alunos."},Configurações:{title:"Configurações",text:"Configure preferências da plataforma, notificações e personalização da interface."}};b.forEach((l,sa)=>{l.addEventListener("click",ia=>{ia.preventDefault(),b.forEach(ta=>ta.classList.remove("active")),l.classList.add("active");const ea=l.textContent.trim(),d=aa[ea];d&&v&&p&&(v.textContent=d.title,p.textContent=d.text),console.log("Evento @update:currentTab emitido com index: "+sa)})})},100),`
      ${a}
      <div class="demo-container">
    ...
    `)};var m,x,u,h,g;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="demo-container">
      <div class="demo-label">Navegação por Abas Padrão</div>
  ...
  \`
}`,...(u=(x=s.parameters)==null?void 0:x.docs)==null?void 0:u.source},description:{story:"3 tabs (Visão Geral, Detalhes, Histórico) with first tab active",...(g=(h=s.parameters)==null?void 0:h.docs)==null?void 0:g.description}}};var f,E,k,w,A;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="demo-container">
      <div class="demo-label">Segunda Aba Ativa com Z-Index</div>
  ...
  \`
}`,...(k=(E=i.parameters)==null?void 0:E.docs)==null?void 0:k.source},description:{story:'5 tabs with second tab ("Minhas Missões") active, z-index layering visible',...(A=(w=i.parameters)==null?void 0:w.docs)==null?void 0:A.description}}};var D,F,y,T,M;e.parameters={...e.parameters,docs:{...(D=e.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="demo-container">
      <div class="demo-label">Abas com Scroll Horizontal (8 tabs)</div>
  ...
  \`
}`,...(y=(F=e.parameters)==null?void 0:F.docs)==null?void 0:y.source},description:{story:"8 tabs demonstrating horizontal scroll with overflow-x auto",...(M=(T=e.parameters)==null?void 0:T.docs)==null?void 0:M.description}}};var C,S,z,V,B;t.parameters={...t.parameters,docs:{...(C=t.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="demo-container">
      <div class="demo-label">Abas com Ícones Bootstrap</div>
  ...
  \`
}`,...(z=(S=t.parameters)==null?void 0:S.docs)==null?void 0:z.source},description:{story:"Tabs with Bootstrap Icons (bi-house, bi-book, bi-graph-up, bi-gear)",...(B=(V=t.parameters)==null?void 0:V.docs)==null?void 0:B.description}}};var G,q,I,$,P;n.parameters={...n.parameters,docs:{...(G=n.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="demo-container">
      <div class="demo-label">Abas de Disciplinas Educacionais</div>
  ...
  \`
}`,...(I=(q=n.parameters)==null?void 0:q.docs)==null?void 0:I.source},description:{story:"4 subject tabs (Matemática, Português, Ciências, História) for content filtering",...(P=($=n.parameters)==null?void 0:$.docs)==null?void 0:P.description}}};var L,H,R,j,N;o.parameters={...o.parameters,docs:{...(L=o.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="demo-container mobile-viewport">
      <div class="demo-label">Visualização Mobile (375px)</div>
  ...
  \`
}`,...(R=(H=o.parameters)==null?void 0:H.docs)==null?void 0:R.source},description:{story:"375px showing scrollbar-width thin and touch-scrolling behavior",...(N=(j=o.parameters)==null?void 0:j.docs)==null?void 0:N.description}}};var W,U,_,Z,O;c.parameters={...c.parameters,docs:{...(W=c.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="demo-container">
      <div class="demo-label">Abas com Badges de Notificação</div>
  ...
  \`
}`,...(_=(U=c.parameters)==null?void 0:U.docs)==null?void 0:_.source},description:{story:'Tabs with notification badges (Turmas with "3", Pendentes with "12")',...(O=(Z=c.parameters)==null?void 0:Z.docs)==null?void 0:O.description}}};var J,K,Q,X,Y;r.parameters={...r.parameters,docs:{...(J=r.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => {
    setTimeout(() => {
...
}`,...(Q=(K=r.parameters)==null?void 0:K.docs)==null?void 0:Q.source},description:{story:"Tabs with click handlers using setTimeout to emit @update:currentTab event and update active class",...(Y=(X=r.parameters)==null?void 0:X.docs)==null?void 0:Y.description}}};const oa=["Default","ActiveSecond","Scrollable","WithIcons","Educational","MobileView","WithBadge","Interactive"];export{i as ActiveSecond,s as Default,n as Educational,r as Interactive,o as MobileView,e as Scrollable,c as WithBadge,t as WithIcons,oa as __namedExportsOrder,na as default};
