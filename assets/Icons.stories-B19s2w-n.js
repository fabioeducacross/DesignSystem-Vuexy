import{f as e}from"./feather-Jf-owMTG.js";import"./_commonjsHelpers-CqkleIqs.js";const I={title:"Vuexy/Foundations/Icons",parameters:{docs:{description:{component:`
...
⚠️ **Importante**: Novos componentes devem usar **Feather Icons** para consistência.
    ...
    <div style="padding: 2rem;">
      <div style="padding: 2rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 16px; color: white; margin-bottom: 2rem;">
        <div style="display: flex; align-items: center; gap: 1.5rem; margin-bottom: 1rem;">
          ${e.icons.feather.toSvg({width:48,height:48})}
          <div>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
        <div style="padding: 1.5rem; background: #f8f7fa; border-radius: 12px; border-left: 4px solid #28c76f;">
          <h4 style="color: #28c76f; margin-bottom: 1rem;">
            ${e.icons.check.toSvg({width:24,height:24,class:"me-2"})}
            Vantagens
          </h4>
        ...
        <div style="padding: 1.5rem; background: #f8f7fa; border-radius: 12px; border-left: 4px solid #7367f0;">
          <h4 style="color: #7367f0; margin-bottom: 1rem;">
            ${e.icons.code.toSvg({width:24,height:24,class:"me-2"})}
            Como Usar
          </h4>
          ...
          <a href="?path=/docs/vuexy-atoms-data-display-icon--docs" style="display: inline-block; margin-top: 1rem; color: #7367f0; text-decoration: none; font-weight: 600;">
            ${e.icons["external-link"].toSvg({width:16,height:16})}
      ...
      <div style="margin-top: 2rem; padding: 1.5rem; background: #fff3cd; border-radius: 12px; border-left: 4px solid #ff9f43;">
        <h4 style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1rem;">
          ${e.icons["alert-circle"].toSvg({width:24,height:24})}
  ...
  `},y={plus:"plus",x:"x",trash:"trash-2",pencil:"edit-2",check:"check",download:"download",upload:"upload",search:"search","chevron-left":"chevron-left","chevron-right":"chevron-right","chevron-up":"chevron-up","chevron-down":"chevron-down","arrow-left":"arrow-left","arrow-right":"arrow-right",house:"home",list:"menu",person:"user",people:"users","person-circle":"user","box-arrow-right":"log-out",bell:"bell",envelope:"mail",chat:"message-circle",telephone:"phone","check-circle":"check-circle","x-circle":"x-circle","exclamation-triangle":"alert-triangle","info-circle":"info",gear:"settings",sliders:"sliders","three-dots-vertical":"more-vertical","file-earmark":"file-text",folder:"folder",image:"image",eye:"eye","eye-slash":"eye-off",star:"star",heart:"heart",share:"share-2",lock:"lock",unlock:"unlock"},o={render:()=>`
    <div class="p-4">
      <h2 class="mb-4">
        ${e.icons["git-branch"].toSvg({width:32,height:32,class:"me-2"})}
        Guia de Migração: Bootstrap Icons → Feather Icons
      </h2>

      <div class="alert alert-info mb-4">
        <h5 class="alert-heading">
          ${e.icons.info.toSvg({width:20,height:20,class:"me-2"})}
          Quando migrar?
        </h5>
        <ul class="mb-0">
      ...
      <div class="table-responsive">
        <table class="table table-hover">
          ...
          <tbody>
            ${Object.entries(y).map(([s,t])=>`
              <tr>
                <td><code>bi bi-${s}</code></td>
                <td><code>${t}</code></td>
                <td>
                  <i class="bi bi-${s}" style="font-size: 1.5rem; color: #dc3545; margin-right: 1rem;"></i>
                  ${e.icons[t]?e.icons[t].toSvg({width:24,height:24}):""}
                </td>
              </tr>
            `).join("")}
          </tbody>
        ...
        <div class="col-md-6">
          <div class="card border-danger">
            <div class="card-header bg-danger text-white">
              ${e.icons.x.toSvg({width:16,height:16,class:"me-2"})}
...
&lt;FeatherIcon icon="check-circle" size="24" /&gt;</code></pre>
      ...
      <div class="alert alert-warning mt-4">
        <h6 class="alert-heading">
          ${e.icons["alert-triangle"].toSvg({width:20,height:20,class:"me-2"})}
          Importante
        </h6>
        <ul class="mb-0">
  ...
  `},a={render:()=>`
    <div class="p-4">
      ...
      <div class="mb-3" style="max-width: 400px;">
        <div class="input-group">
          <span class="input-group-text">
            ${e.icons.search.toSvg({width:16,height:16})}
          </span>
      ...
      <div class="mb-5" style="max-width: 400px;">
        <div class="input-group">
          <span class="input-group-text">
            ${e.icons.mail.toSvg({width:16,height:16})}
          </span>
      ...
      <div class="row g-3 mb-5">
        ${["users","activity","star","heart"].map(s=>`
          <div class="col-6 col-md-3">
            <div class="card text-center">
              <div class="card-body">
                ${e.icons[s].toSvg({width:48,height:48,class:"text-primary mb-3"})}
                <h6 class="card-title text-capitalize">${s}</h6>
              </div>
            </div>
          </div>
        `).join("")}
      ...
      <div class="alert alert-success">
        ${e.icons["check-circle"].toSvg({width:20,height:20,class:"me-2"})}
  ...
  \`
}`,...(l=(c=i.parameters)==null?void 0:c.docs)==null?void 0:l.source}}};var d,m,p;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h2 style="margin-bottom: 1rem;">Bibliotecas Adicionais</h2>
      <p style="color: #6c757d; margin-bottom: 3rem;">
  ...
  render: () => \`
    <div class="p-4">
      <h2 class="mb-4">
        \${feather.icons['git-branch'].toSvg({
    width: 32,
    height: 32,
    class: 'me-2'
  })}
            ...
            \${Object.entries(bootstrapToFeatherMap).map(([bootstrap, feather_icon]) => \`
              <tr>
                ...
                <td>
                  ...
                  \${feather.icons[feather_icon] ? feather.icons[feather_icon].toSvg({
    width: 24,
    height: 24
  }) : ''}
                </td>
...
&lt;FeatherIcon icon="check-circle" size="24" /&gt;</code></pre>
  ...
  \`
}`,...(b=(h=o.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};var f,v,u;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => \`
    <div class="p-4">
      <h4 class="mb-4">Exemplos Práticos com Feather Icons</h4>
  ...
  \`
}`,...(u=(v=a.parameters)==null?void 0:v.docs)==null?void 0:u.source}}};const k=["OfficialLibrary","OtherLibraries","MigrationGuide","PracticalExamples"];export{o as MigrationGuide,i as OfficialLibrary,n as OtherLibraries,a as PracticalExamples,k as __namedExportsOrder,I as default};
