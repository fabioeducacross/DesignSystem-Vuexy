import{c as Je,b as v,d as Ne}from"./docTemplate-RKjNfURf.js";const Ge={title:"Educacross Components V2/Forms/ESelect",tags:["autodocs"],parameters:{docs:{description:{component:`
...
`,a={render:()=>`
  ...
  `},x={render:()=>Je({title:"ESelect",subtitle:"Select customizado com busca, múltipla seleção e paginação",badge:"Forms / Filters",colors:{primary:"#6E63E8",secondary:"#00CFE8"},stats:[{label:"Baseado em",value:"vue-select",description:"Biblioteca robusta e testada"},{label:"Funcionalidades",value:"4",description:"busca, múltipla, paginação, validação"},{label:"Casos de Uso",value:"8+",description:"turmas, disciplinas, anos, períodos, escolas"},{label:"Performance",value:"Lazy Load",description:"Paginação para grandes listas"}],content:`
${v({title:"Select Básico",description:"Dropdown simples com opções",preview:'<div style="padding: 20px; max-width: 400px;"><label style="display: block; margin-bottom: 8px; color: #5E5873; font-size: 14px; font-weight: 500;">Selecione uma Turma</label><select style="width: 100%; height: 38px; padding: 8px 12px; border: 1px solid #D8D6DE; border-radius: 6px; font-size: 14px; color: #4B465C; background-color: white; cursor: pointer;"><option value="">Selecione...</option><option>Turma A - 5º Ano</option><option>Turma B - 6º Ano</option><option>Turma C - 7º Ano</option></select></div>',code:`<ESelect
...
${v({title:"Múltipla Seleção",description:"Permite selecionar vários itens",preview:'<div style="padding: 20px; max-width: 400px;"><label style="display: block; margin-bottom: 8px; color: #5E5873; font-size: 14px; font-weight: 500;">Selecione Disciplinas</label><div style="display: flex; flex-wrap: wrap; gap: 8px; padding: 8px; border: 1px solid #D8D6DE; border-radius: 6px; min-height: 38px;"><span style="display: inline-flex; align-items: center; gap: 4px; padding: 4px 8px; background-color: #6E63E8; color: white; border-radius: 4px; font-size: 13px;">Matemática <i class="bi bi-x" style="font-size: 14px; cursor: pointer;"></i></span><span style="display: inline-flex; align-items: center; gap: 4px; padding: 4px 8px; background-color: #6E63E8; color: white; border-radius: 4px; font-size: 13px;">Português <i class="bi bi-x" style="font-size: 14px; cursor: pointer;"></i></span><input type="text" placeholder="Digite para buscar..." style="flex: 1; min-width: 120px; border: none; outline: none; font-size: 14px;" /></div></div>',code:`<ESelect
...
${v({title:"Com Busca",description:"Input de busca integrado para filtrar opções",preview:'<div style="padding: 20px; max-width: 400px;"><label style="display: block; margin-bottom: 8px; color: #5E5873; font-size: 14px; font-weight: 500;">Buscar Aluno</label><div style="position: relative;"><input type="text" placeholder="Digite o nome do aluno..." style="width: 100%; height: 38px; padding: 8px 32px 8px 12px; border: 1px solid #D8D6DE; border-radius: 6px; font-size: 14px;" /><i class="bi bi-search" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); color: #A8AAAE;"></i></div></div>',code:`<ESelect
  v-model="selectedStudent"
  :options="students"
  :searchable="true"
...
${Ne([{name:"value",type:"Any",default:"null",description:"Valor selecionado (v-model)"},{name:"options",type:"Array",default:"[]",description:"Lista de opções"},{name:"multiple",type:"Boolean",default:"false",description:"Permite múltipla seleção"},{name:"searchable",type:"Boolean",default:"false",description:"Habilita busca/filtro"},{name:"clearable",type:"Boolean",default:"true",description:"Mostra botão X para limpar"},{name:"loading",type:"Boolean",default:"false",description:"Estado de carregamento"}])}
    `,features:[{icon:"search",title:"Busca Integrada",description:"Filtra opções em tempo real"},{icon:"stack",title:"Múltipla Seleção",description:"Selecione vários itens com chips visuais"},{icon:"arrow-clockwise",title:"Paginação",description:"Lazy loading para grandes listas"},{icon:"universal-access",title:"Acessível",description:"ARIA, keyboard navigation, screen readers"}],relatedComponents:[{name:"FilterChip",path:"/story/front-office-forms-filterchip--default"},{name:"EInput",path:"/story/front-office-forms-einput--default"}]})};var f,h,y,E,S;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 120px;">
      <label class="form-label" for="select-default">Selecione uma disciplina</label>
  ...
  \`
}`,...(y=(h=a.parameters)==null?void 0:h.docs)==null?void 0:y.source},description:{story:`Default - Estado inicial com placeholder

Representa o estado padrão do componente ao carregar a página.
Usuário ainda não interagiu com o campo.`,...(S=(E=a.parameters)==null?void 0:E.docs)==null?void 0:S.description}}};var w,A,C,k,P;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 350px;">
      <label class="form-label" for="select-opened">Disciplina</label>
  ...
  \`
}`,...(C=(A=o.parameters)==null?void 0:A.docs)==null?void 0:C.source},description:{story:`Opened - Dropdown aberto mostrando opções

Usuário clicou no campo e o dropdown expandiu mostrando todas as opções disponíveis.
Caso de uso: Filtro de disciplinas no dashboard de alunos.`,...(P=(k=o.parameters)==null?void 0:k.docs)==null?void 0:P.description}}};var D,F,z,B,M;s.parameters={...s.parameters,docs:{...(D=s.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 120px;">
      <label class="form-label" for="select-single">Disciplina selecionada</label>
  ...
  \`
}`,...(z=(F=s.parameters)==null?void 0:F.docs)==null?void 0:z.source},description:{story:`SingleSelected - Uma opção selecionada (modo single)

Usuário selecionou uma disciplina e o dropdown fechou.
O valor selecionado aparece no campo.`,...(M=(B=s.parameters)==null?void 0:B.docs)==null?void 0:M.description}}};var O,T,I,L,_;n.parameters={...n.parameters,docs:{...(O=n.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 120px;">
      <label class="form-label" for="select-multiple">Turmas selecionadas</label>
  ...
  \`
}`,...(I=(T=n.parameters)==null?void 0:T.docs)==null?void 0:I.source},description:{story:`MultipleSelected - Múltiplas opções selecionadas com badge de contagem

Coordenador selecionou 3 turmas para comparar no relatório.
Badge mostra contagem com i18n (gênero + pluralização).`,...(_=(L=n.parameters)==null?void 0:L.docs)==null?void 0:_.description}}};var $,R,U,j,J;i.parameters={...i.parameters,docs:{...($=i.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 380px;">
      <label class="form-label" for="select-checkboxes">Selecione as turmas</label>
  ...
  \`
}`,...(U=(R=i.parameters)==null?void 0:R.docs)==null?void 0:U.source},description:{story:`MultipleWithCheckboxes - Dropdown aberto mostrando checkboxes

Modo múltiplo com "Selecionar todas" no topo.
Caso de uso: Coordenador filtrando turmas do 5º ano.`,...(J=(j=i.parameters)==null?void 0:j.docs)==null?void 0:J.description}}};var N,V,G,q,W;l.parameters={...l.parameters,docs:{...(N=l.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 380px;">
      <label class="form-label" for="select-searchable">Buscar aluno</label>
  ...
  \`
}`,...(G=(V=l.parameters)==null?void 0:V.docs)==null?void 0:G.source},description:{story:`Searchable - Campo com busca interna

Professor procurando aluno específico em lista grande.
Campo de busca com debounce de 500ms.`,...(W=(q=l.parameters)==null?void 0:q.docs)==null?void 0:W.description}}};var H,X,Y,Q,K;r.parameters={...r.parameters,docs:{...(H=r.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 120px;">
      <label class="form-label" for="select-loading">Carregando anos letivos...</label>
  ...
  \`
}`,...(Y=(X=r.parameters)==null?void 0:X.docs)==null?void 0:Y.source},description:{story:`Loading - Estado de carregamento (spinner)

Componente aguardando resposta da API.
Mostra spinner ao invés do ícone de dropdown.`,...(K=(Q=r.parameters)==null?void 0:Q.docs)==null?void 0:K.description}}};var Z,ee,ae,oe,se;t.parameters={...t.parameters,docs:{...(Z=t.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 120px;">
      <label class="form-label" for="select-disabled">Turma (selecione uma escola primeiro)</label>
  ...
  \`
}`,...(ae=(ee=t.parameters)==null?void 0:ee.docs)==null?void 0:ae.source},description:{story:`Disabled - Campo desabilitado (não interativo)

Campo bloqueado porque filtro anterior não foi preenchido.
Ex: "Turma" desabilitado até selecionar "Escola".`,...(se=(oe=t.parameters)==null?void 0:oe.docs)==null?void 0:se.description}}};var ne,ie,le,re,te;d.parameters={...d.parameters,docs:{...(ne=d.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 140px;">
      <label class="form-label" for="select-invalid">Disciplina <span style="color: var(--danger);">*</span></label>
  ...
  \`
}`,...(le=(ie=d.parameters)==null?void 0:ie.docs)==null?void 0:le.source},description:{story:`Invalid - Estado de erro de validação

Campo obrigatório não preenchido.
Mostra mensagem de feedback abaixo do campo.`,...(te=(re=d.parameters)==null?void 0:re.docs)==null?void 0:te.description}}};var de,ce,pe,me,be;c.parameters={...c.parameters,docs:{...(de=c.parameters)==null?void 0:de.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4">
      <div class="row g-3">
  ...
  \`
}`,...(pe=(ce=c.parameters)==null?void 0:ce.docs)==null?void 0:pe.source},description:{story:`Variants - Diferentes cores de badge (primary, success, warning, danger)

Demonstra as 4 variantes de cor disponíveis.
Uso real: Coordenador diferencia tipos de filtro por cor.`,...(be=(me=c.parameters)==null?void 0:me.docs)==null?void 0:be.description}}};var ue,ge,xe,ve,fe;p.parameters={...p.parameters,docs:{...(ue=p.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 120px;">
      <label class="form-label" for="select-empty">Escola (nenhuma cadastrada)</label>
  ...
  \`
}`,...(xe=(ge=p.parameters)==null?void 0:ge.docs)==null?void 0:xe.source},description:{story:`NoOptions - Sem opções disponíveis (array vazio)

API retornou array vazio ou filtro não encontrou resultados.
Slot customizável para mensagem.`,...(fe=(ve=p.parameters)==null?void 0:ve.docs)==null?void 0:fe.description}}};var he,ye,Ee,Se,we;m.parameters={...m.parameters,docs:{...(he=m.parameters)==null?void 0:he.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 120px;">
      <label class="form-label" for="select-all">Turmas (todas selecionadas)</label>
  ...
  \`
}`,...(Ee=(ye=m.parameters)==null?void 0:ye.docs)==null?void 0:Ee.source},description:{story:`AllSelected - Todas as opções selecionadas (modo múltiplo)

Usuário marcou "Selecionar todas" no checkbox.
Badge mostra mensagem especial customizável.`,...(we=(Se=m.parameters)==null?void 0:Se.docs)==null?void 0:we.description}}};var Ae,Ce,ke,Pe,De;b.parameters={...b.parameters,docs:{...(Ae=b.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 280px;">
      <label class="form-label" for="school-year">Ano Escolar</label>
  ...
  \`
}`,...(ke=(Ce=b.parameters)==null?void 0:Ce.docs)==null?void 0:ke.source},description:{story:`SchoolYearFilter - Caso de uso real: Filtro de Ano Letivo

Componente usado em SchoolsPerformanceFilter.vue
Opções dinâmicas carregadas da API + "Todos" no início.`,...(De=(Pe=b.parameters)==null?void 0:Pe.docs)==null?void 0:De.description}}};var Fe,ze,Be,Me,Oe;u.parameters={...u.parameters,docs:{...(Fe=u.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 380px;">
      <label class="form-label" for="period">Período</label>
  ...
  \`
}`,...(Be=(ze=u.parameters)==null?void 0:ze.docs)==null?void 0:Be.source},description:{story:`PeriodFilter - Caso de uso real: Filtro de Período/Mês

Componente usado em Filter.vue (Dashboard de Alunos)
Mostra meses do ano + "Todo o período".`,...(Oe=(Me=u.parameters)==null?void 0:Me.docs)==null?void 0:Oe.description}}};var Te,Ie,Le,_e,$e;g.parameters={...g.parameters,docs:{...(Te=g.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  render: () => \`
    \${eSelectStyles}
    <div class="p-4" style="min-height: 240px;">
      <div class="d-flex align-items-center gap-1">
  ...
  \`
}`,...(Le=(Ie=g.parameters)==null?void 0:Ie.docs)==null?void 0:Le.source},description:{story:`PerPageSelector - Caso de uso real: Paginação de Resultados

Componente usado em RoundsFilter.vue
Opções: 5, 10, 25 itens por página.`,...($e=(_e=g.parameters)==null?void 0:_e.docs)==null?void 0:$e.description}}};var Re,Ue,je;x.parameters={...x.parameters,docs:{...(Re=x.parameters)==null?void 0:Re.docs,source:{originalSource:`{
  render: () => createDocPage({
    ...
    stats: [{
      label: 'Baseado em',
      value: 'vue-select',
      description: 'Biblioteca robusta e testada'
    }, {
      label: 'Funcionalidades',
      value: '4',
      description: 'busca, múltipla, paginação, validação'
    }, {
      label: 'Casos de Uso',
      value: '8+',
      description: 'turmas, disciplinas, anos, períodos, escolas'
    }, {
      label: 'Performance',
      value: 'Lazy Load',
      description: 'Paginação para grandes listas'
    }],
    content: \`
\${createExampleCard({
      title: 'Select Básico',
...
\${createPropsTable([{
      ...
      type: 'Boolean',
      default: 'false',
      description: 'Habilita busca/filtro'
    }, {
      name: 'clearable',
      type: 'Boolean',
      default: 'true',
      description: 'Mostra botão X para limpar'
    }, {
      name: 'loading',
      type: 'Boolean',
      default: 'false',
    ...
    features: [{
      ...
      description: 'Filtra opções em tempo real'
    }, {
      icon: 'stack',
      title: 'Múltipla Seleção',
      description: 'Selecione vários itens com chips visuais'
    }, {
      icon: 'arrow-clockwise',
      title: 'Paginação',
      description: 'Lazy loading para grandes listas'
    }, {
    ...
    relatedComponents: [{
      name: 'FilterChip',
      path: '/story/front-office-forms-filterchip--default'
    }, {
      name: 'EInput',
      path: '/story/front-office-forms-einput--default'
    }]
  })
}`,...(je=(Ue=x.parameters)==null?void 0:Ue.docs)==null?void 0:je.source}}};const qe=["Default","Opened","SingleSelected","MultipleSelected","MultipleWithCheckboxes","Searchable","Loading","Disabled","Invalid","Variants","NoOptions","AllSelected","SchoolYearFilter","PeriodFilter","PerPageSelector","Documentation"];export{m as AllSelected,a as Default,t as Disabled,x as Documentation,d as Invalid,r as Loading,n as MultipleSelected,i as MultipleWithCheckboxes,p as NoOptions,o as Opened,g as PerPageSelector,u as PeriodFilter,b as SchoolYearFilter,l as Searchable,s as SingleSelected,c as Variants,qe as __namedExportsOrder,Ge as default};
