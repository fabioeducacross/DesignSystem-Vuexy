import{f as $,a as G}from"./snippets-m8t1HIl1.js";const T={title:"Vuexy/Molecules/Content/ListGroup",tags:["autodocs"],parameters:{docs:{description:{component:`
# List Group
...
- Navegável por teclado quando interativo
        `}}},argTypes:{variant:{control:{type:"select"},options:["default","primary","secondary","success","danger","warning","info"],description:"Variante de cor",table:{defaultValue:{summary:"default"}}},flush:{control:"boolean",description:"Remove bordas e arredondamento",table:{defaultValue:{summary:!1}}},horizontal:{control:"boolean",description:"Layout horizontal",table:{defaultValue:{summary:!1}}}}},H=({variant:a="default",flush:s=!1,horizontal:j=!1})=>{const E=s?"list-group-flush":"",I=j?"list-group-horizontal":"",c=a!=="default"?`list-group-item-${a}`:"";return`<ul class="list-group ${E} ${I}">
...
`,t=r.bind({});t.args={variant:"default",flush:!1,horizontal:!1};const e=r.bind({});e.args={...t.args,variant:"primary"};const i=r.bind({});i.args={...t.args,flush:!0};const l=r.bind({});l.args={...t.args,horizontal:!0};const o={render:()=>`
    ...
    `,parameters:{docs:{source:{code:`<div class="list-group">
...
</div>`}}}};var m,d,p;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`() => \`
  <div class="row g-4">
    <div class="col-md-6">
      <h5>Default</h5>
      <ul class="list-group">
...
\``,...(p=(d=n.parameters)==null?void 0:d.docs)==null?void 0:p.source}}};var u,g,v;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(v=(g=t.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};var b,h,f;e.parameters={...e.parameters,docs:{...(b=e.parameters)==null?void 0:b.docs,source:{originalSource:`args => {
  const markup = createListGroup(args);
  return \`
    <div style="max-width: 500px;">
      \${markup}
  ...
  \`;
}`,...(f=(h=e.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var x,y,w;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`args => {
  const markup = createListGroup(args);
  return \`
    <div style="max-width: 500px;">
      \${markup}
  ...
  \`;
}`,...(w=(y=i.parameters)==null?void 0:y.docs)==null?void 0:w.source}}};var S,A,C;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`args => {
  const markup = createListGroup(args);
  return \`
    <div style="max-width: 500px;">
      \${markup}
...
}`,...(D=(L=o.parameters)==null?void 0:L.docs)==null?void 0:D.source}}};const B=["Overview","Default","Primary","Flush","Horizontal","Interactive"];export{t as Default,i as Flush,l as Horizontal,o as Interactive,n as Overview,e as Primary,B as __namedExportsOrder,T as default};
