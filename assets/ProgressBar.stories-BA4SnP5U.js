const O={title:"Educacross Components V2/Feedback/ProgressBar",tags:["autodocs"],parameters:{docs:{description:{component:`
...
`,a={render:()=>`
  ...
  `},l={render:()=>`
    ...
    <div class="p-4" style="max-width: 500px;">
      ...
      ${[0,10,25,30,45,60,70,80,90,100].map(r=>{let e="legend-below-basic";return r>=70?e="legend-proficient":r>=30&&(e="legend-basic"),`
          <div class="progress-bar-container" style="margin-bottom: 0.75rem;">
            <div class="progress-bar-header">
              <span class="progress-bar-label" style="font-size: 0.875rem;">${r}%</span>
              <span class="progress-bar-value text-${e}" style="font-size: 0.875rem;">${r}%</span>
            </div>
            <div class="progress-bar-bg bg-progress-bar-${e} rounded-lg">
              <div class="progress">
                <div class="progress-bar bg-${e}" style="width: ${r}%;"></div>
              </div>
            </div>
          </div>
        `}).join("")}
  ...
  `};var p,c,t,b,v;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => \`
    \${progressBarStyles}
    <div class="p-4" style="max-width: 400px;">
      <div class="progress-bar-container">
  ...
  \`
}`,...(t=(c=a.parameters)==null?void 0:c.docs)==null?void 0:t.source},description:{story:"Default - Exemplo básico",...(v=(b=a.parameters)==null?void 0:b.docs)==null?void 0:v.description}}};var m,u,x,f,h;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => \`
    \${progressBarStyles}
    <div class="p-4" style="max-width: 500px;">
      <h6 class="mb-4">Sistema de Cores por Faixa de Valor</h6>
  ...
  \`
}`,...(x=(u=n.parameters)==null?void 0:u.docs)==null?void 0:x.source},description:{story:"ColorRanges - Demonstração das faixas de cores",...(h=(f=n.parameters)==null?void 0:f.docs)==null?void 0:h.description}}};var w,y,C,B,S;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => \`
    \${progressBarStyles}
    <div class="p-4" style="max-width: 400px;">
      <div class="progress-bar-container">
  ...
  \`
}`,...(C=(y=o.parameters)==null?void 0:y.docs)==null?void 0:C.source},description:{story:"WithSufix - Com sufixo",...(S=(B=o.parameters)==null?void 0:B.docs)==null?void 0:S.description}}};var P,$,E,A,V;i.parameters={...i.parameters,docs:{...(P=i.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => \`
    \${progressBarStyles}
    <div class="p-4" style="max-width: 400px;">
      <div class="progress-bar-container">
  ...
  \`
}`,...(E=($=i.parameters)==null?void 0:$.docs)==null?void 0:E.source},description:{story:"PositionBottom - Valor abaixo da barra",...(V=(A=i.parameters)==null?void 0:A.docs)==null?void 0:V.description}}};var k,z,D,R,F;d.parameters={...d.parameters,docs:{...(k=d.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => \`
    \${progressBarStyles}
    <style>
      .demo-card {
  ...
  \`
}`,...(D=(z=d.parameters)==null?void 0:z.docs)==null?void 0:D.source},description:{story:"InCard - Dentro de um card",...(F=(R=d.parameters)==null?void 0:R.docs)==null?void 0:F.description}}};var M,j,T,H,I;l.parameters={...l.parameters,docs:{...(M=l.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => \`
    \${progressBarStyles}
    <div class="p-4" style="max-width: 500px;">
      <h6 class="mb-3">Todos os Estados</h6>
  ...
  \`
}`,...(T=(j=l.parameters)==null?void 0:j.docs)==null?void 0:T.source},description:{story:"AllStates - Todos os estados possíveis",...(I=(H=l.parameters)==null?void 0:H.docs)==null?void 0:I.description}}};var W,_,q,L,N;g.parameters={...g.parameters,docs:{...(W=g.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => \`
    \${progressBarStyles}
    <style>
      .progress-compact {
  ...
  \`
}`,...(q=(_=g.parameters)==null?void 0:_.docs)==null?void 0:q.source},description:{story:"Compact - Versão compacta",...(N=(L=g.parameters)==null?void 0:L.docs)==null?void 0:N.description}}};const U=["Default","ColorRanges","WithSufix","PositionBottom","InCard","AllStates","Compact"];export{l as AllStates,n as ColorRanges,g as Compact,a as Default,d as InCard,i as PositionBottom,o as WithSufix,U as __namedExportsOrder,O as default};
