import{f as J,a as O}from"./snippets-m8t1HIl1.js";const z={title:"Vuexy/Molecules/Overlays/Popover",tags:["autodocs"],parameters:{docs:{description:{component:`
# Popover
...
- Fechável via ESC
        `}}},argTypes:{placement:{control:{type:"select"},options:["top","right","bottom","left"],description:"Posicionamento do popover",table:{defaultValue:{summary:"right"}}},title:{control:"text",description:"Título do popover",table:{defaultValue:{summary:"Popover title"}}},content:{control:"text",description:"Conteúdo do popover",table:{defaultValue:{summary:"Popover content"}}},trigger:{control:{type:"select"},options:["click","hover","focus"],description:"Tipo de ativação",table:{defaultValue:{summary:"click"}}}}},o=({placement:n="right",title:e="Popover title",content:a="And here's some amazing content. It's very engaging. Right?",trigger:m="click"})=>`<button type="button" class="btn btn-primary" 
  data-bs-toggle="popover" 
  data-bs-placement="${n}" 
  data-bs-trigger="${m}"
  data-bs-title="${e}"
  data-bs-content="${a}">
  ${m==="click"?"Click me":m==="hover"?"Hover me":"Focus me"}
</button>`,s=n=>{const e=o(n);return`
    ...
    <details>
      ...
      <div class="mt-3">
        <h6>HTML</h6>
        <pre><code>${J(e).replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
        <h6>React</h6>
        <pre><code>${O(e,"Popover").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
  ...
  <div class="row g-4">
    <div class="col-12">
      ...
      <div class="d-flex justify-content-center align-items-center gap-3" style="padding: 150px 50px;">
        ${o({placement:"top",title:"Popover on top"})}
        ${o({placement:"right",title:"Popover on right"})}
        ${o({placement:"bottom",title:"Popover on bottom"})}
        ${o({placement:"left",title:"Popover on left"})}
      </div>
    </div>
    ...
    <div class="col-12 mt-5">
      ...
      <div class="d-flex justify-content-center gap-3" style="padding: 100px 0;">
        ${o({title:"Click Trigger",content:"This popover is triggered by click",trigger:"click"})}
        ${o({title:"Hover Trigger",content:"This popover is triggered by hover",trigger:"hover"})}
        ${o({title:"Focus Trigger",content:"This popover is triggered by focus",trigger:"focus"})}
      </div>
    </div>
...
[...popoverTriggerList].map(el => new bootstrap.Popover(el));</code></pre>
  ...
  <\/script>
`,t=s.bind({});t.args={placement:"right",title:"Popover title",content:"And here's some amazing content. It's very engaging. Right?",trigger:"click"};const i=s.bind({});i.args={...t.args,placement:"top",title:"Popover on top"};const p=s.bind({});p.args={...t.args,placement:"bottom",title:"Popover on bottom"};const c=s.bind({});c.args={...t.args,placement:"left",title:"Popover on left"};const l=s.bind({});l.args={...t.args,title:"Hover to view",content:"This popover appears on hover and disappears when you move away",trigger:"hover"};const d=s.bind({});d.args={...t.args,title:"Dismissible popover",content:"Click outside or press ESC to close",trigger:"focus"};const r={parameters:{docs:{description:{story:`
...
4. Observe o ajuste automático nas bordas
        `}}},loaders:[async()=>typeof window<"u"&&!window.bootstrap?new Promise((n,e)=>{const a=document.createElement("script");a.src="/vuexy/js/bootstrap.js",a.onload=()=>{console.log("✅ Bootstrap JS carregado para Popover"),n({bootstrapLoaded:!0})},a.onerror=()=>e(new Error("Failed to load Bootstrap JS")),document.head.appendChild(a)}):{bootstrapLoaded:!0}],render:()=>(setTimeout(()=>{typeof bootstrap<"u"&&[...document.querySelectorAll('[data-bs-toggle="popover"]')].map(e=>new bootstrap.Popover(e))},100),`
    ...
    `)};var u,g,v;b.parameters={...b.parameters,docs:{...(u=b.parameters)==null?void 0:u.docs,source:{originalSource:`() => \`
  <div class="row g-4">
    <div class="col-12">
      <h5>Posicionamento</h5>
      <div class="d-flex justify-content-center align-items-center gap-3" style="padding: 150px 50px;">
...
[...popoverTriggerList].map(el => new bootstrap.Popover(el));</code></pre>
  ...
  <\/script>
\``,...(v=(g=b.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};var h,f,x;t.parameters={...t.parameters,docs:{...(h=t.parameters)==null?void 0:h.docs,source:{originalSource:`args => {
...
const popoverList = [...popoverTriggerList].map(el => new bootstrap.Popover(el));</code></pre>
  ...
  \`;
}`,...(x=(f=t.parameters)==null?void 0:f.docs)==null?void 0:x.source}}};var y,P,T;i.parameters={...i.parameters,docs:{...(y=i.parameters)==null?void 0:y.docs,source:{originalSource:`args => {
  const markup = createPopover(args);
  return \`
    <div style="padding: 150px; text-align: center;">
      \${markup}
...
const popoverList = [...popoverTriggerList].map(el => new bootstrap.Popover(el));</code></pre>
  ...
  \`;
}`,...(T=(P=i.parameters)==null?void 0:P.docs)==null?void 0:T.source}}};var C,E,S;p.parameters={...p.parameters,docs:{...(C=p.parameters)==null?void 0:C.docs,source:{originalSource:`args => {
  const markup = createPopover(args);
  return \`
    <div style="padding: 150px; text-align: center;">
      \${markup}
...
const popoverList = [...popoverTriggerList].map(el => new bootstrap.Popover(el));</code></pre>
  ...
  \`;
}`,...(S=(E=p.parameters)==null?void 0:E.docs)==null?void 0:S.source}}};var w,L,H;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`args => {
  const markup = createPopover(args);
  return \`
    <div style="padding: 150px; text-align: center;">
      \${markup}
...
const popoverList = [...popoverTriggerList].map(el => new bootstrap.Popover(el));</code></pre>
  ...
  \`;
}`,...(H=(L=c.parameters)==null?void 0:L.docs)==null?void 0:H.source}}};var D,k,q;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`args => {
  const markup = createPopover(args);
  return \`
    <div style="padding: 150px; text-align: center;">
      \${markup}
...
const popoverList = [...popoverTriggerList].map(el => new bootstrap.Popover(el));</code></pre>
  ...
  \`;
}`,...(q=(k=l.parameters)==null?void 0:k.docs)==null?void 0:q.source}}};var $,R,j;d.parameters={...d.parameters,docs:{...($=d.parameters)==null?void 0:$.docs,source:{originalSource:`args => {
  const markup = createPopover(args);
  return \`
    <div style="padding: 150px; text-align: center;">
      \${markup}
...
const popoverList = [...popoverTriggerList].map(el => new bootstrap.Popover(el));</code></pre>
  ...
  \`;
}`,...(j=(R=d.parameters)==null?void 0:R.docs)==null?void 0:j.source}}};var F,M,A,I,B;r.parameters={...r.parameters,docs:{...(F=r.parameters)==null?void 0:F.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
}`,...(A=(M=r.parameters)==null?void 0:M.docs)==null?void 0:A.source},description:{story:`====================================
INTERACTIVE STORY - Bootstrap JS Real
====================================`,...(B=(I=r.parameters)==null?void 0:I.docs)==null?void 0:B.description}}};const U=["Overview","Default","Top","Bottom","Left","OnHover","Dismissible","Interactive"];export{p as Bottom,t as Default,d as Dismissible,r as Interactive,c as Left,l as OnHover,b as Overview,i as Top,U as __namedExportsOrder,z as default};
