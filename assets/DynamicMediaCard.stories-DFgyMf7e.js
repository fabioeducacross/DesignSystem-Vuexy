const _={title:"Educacross Components V2/Cards/DynamicMediaCard",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
| icon | String |
| color | String |
        `}}},argTypes:{format:{control:"select",options:["number","percentage","currency"]},color:{control:"select",options:["primary","success","warning","danger"]}}},n=`
<style>
  .dynamic-card {
    background: #fff;
...
`,c={args:{title:"Total Alunos",value:1234,previousValue:1189,format:"number",icon:"bi-people",color:"primary"},render:a=>{const i=a.value-a.previousValue,J=(i/a.previousValue*100).toFixed(1),O=a.format==="percentage"?`${a.value}%`:a.format==="currency"?`R$ ${a.value.toLocaleString("pt-BR")}`:a.value.toLocaleString("pt-BR");return`
      ${n}
      <div class="dynamic-card color-${a.color} animating">
        <div class="dynamic-card-header">
          <span class="dynamic-card-title">${a.title}</span>
          <div class="dynamic-card-icon">
            <i class="bi ${a.icon}"></i>
          </div>
        </div>
        <h2 class="dynamic-card-value">${O}</h2>
        <div class="dynamic-card-change ${i>=0?"positive":"negative"}">
          <i class="bi bi-arrow-${i>=0?"up":"down"}"></i>
          <span>${i>=0?"+":""}${J}% vs. mês anterior</span>
        </div>
      </div>
    `}},s={render:()=>`
    ${n}
  ...
  `},m={render:()=>{let a=1234;return`
      ...
      <div style="display: flex; gap: 20px; align-items: flex-start;">
        <div class="dynamic-card color-primary" id="interactive-card">
          ...
          <h2 class="dynamic-card-value">${a}</h2>
          <div class="dynamic-card-change positive">
            <i class="bi bi-arrow-up"></i>
    ...
    `}};var v,y,u;c.parameters={...c.parameters,docs:{...(v=c.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    title: 'Total Alunos',
    value: 1234,
    previousValue: 1189,
  ...
  render: args => {
    ...
    const formatted = args.format === 'percentage' ? \`\${args.value}%\` : args.format === 'currency' ? \`R$ \${args.value.toLocaleString('pt-BR')}\` : args.value.toLocaleString('pt-BR');
    return \`
      \${styles}
...
}`,...(u=(y=c.parameters)==null?void 0:y.docs)==null?void 0:u.source}}};var g,h,b;s.parameters={...s.parameters,docs:{...(g=s.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="dynamic-card color-primary animating">
      <div class="dynamic-card-header">
  ...
  \`
}`,...(b=(h=s.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};var x,f,E;e.parameters={...e.parameters,docs:{...(x=e.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="dynamic-card color-success animating">
      <div class="dynamic-card-header">
  ...
  \`
}`,...(E=(f=e.parameters)==null?void 0:f.docs)==null?void 0:E.source}}};var B,$,w;d.parameters={...d.parameters,docs:{...(B=d.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="dynamic-card color-warning animating">
      <div class="dynamic-card-header">
  ...
  \`
}`,...(w=($=d.parameters)==null?void 0:$.docs)==null?void 0:w.source}}};var A,C,V;r.parameters={...r.parameters,docs:{...(A=r.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="dynamic-card color-danger animating">
      <div class="dynamic-card-header">
  ...
  \`
}`,...(V=(C=r.parameters)==null?void 0:C.docs)==null?void 0:V.source}}};var S,k,z;o.parameters={...o.parameters,docs:{...(S=o.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
      <div class="dynamic-card color-primary animating">
  ...
  \`
}`,...(z=(k=o.parameters)==null?void 0:k.docs)==null?void 0:z.source}}};var R,F,I;t.parameters={...t.parameters,docs:{...(R=t.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px;">
      <div class="dynamic-card color-primary">
  ...
  \`
}`,...(I=(F=t.parameters)==null?void 0:F.docs)==null?void 0:I.source}}};var T,D,M;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <style>
      @keyframes pulse {
  ...
  \`
}`,...(M=(D=l.parameters)==null?void 0:D.docs)==null?void 0:M.source}}};var L,N,P;p.parameters={...p.parameters,docs:{...(L=p.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px;">
      <div class="dynamic-card color-primary">
  ...
  \`
}`,...(P=(N=p.parameters)==null?void 0:N.docs)==null?void 0:P.source}}};var q,U,j;m.parameters={...m.parameters,docs:{...(q=m.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => {
    let value = 1234;
    return \`
      \${styles}
...
}`,...(j=(U=m.parameters)==null?void 0:U.docs)==null?void 0:j.source}}};const H=["Default","NumberAnimation","PercentageAnimation","CurrencyAnimation","DecreaseAnimation","DashboardRealTime","ComparacaoMensal","LoadingState","AllFormats","Interactive"];export{p as AllFormats,t as ComparacaoMensal,d as CurrencyAnimation,o as DashboardRealTime,r as DecreaseAnimation,c as Default,m as Interactive,l as LoadingState,s as NumberAnimation,e as PercentageAnimation,H as __namedExportsOrder,_ as default};
