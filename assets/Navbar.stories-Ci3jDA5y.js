import{f as T,a as V}from"./snippets-m8t1HIl1.js";const q={title:"Vuexy/Organisms/Navigation/Navbar",tags:["autodocs"],parameters:{docs:{description:{component:`
# Navbar
  ...
  <div class="container-fluid">
    ...
    <details>
      ...
      <div class="mt-3">
        ...
        <h6>React</h6>
        <pre><code>${V(e,"Navbar").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
      </div>
    </details>
  `},p=()=>`
  <div class="row g-4">
