const $={title:"Educacross Components V2/Data Display/QuestionStatus",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
`,o={render:()=>`
  ...
  `},i={render:()=>`
    ...
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 650px;">
      ...
      <div style="display: flex; flex-direction: column; gap: 12px;">
        ${[{n:1,s:"correct",t:"10/10"},{n:2,s:"correct",t:"10/10"},{n:3,s:"partial",t:"5/10"},{n:4,s:"incorrect",t:"0/10"},{n:5,s:"correct",t:"10/10"},{n:6,s:"skipped",t:"0/10"},{n:7,s:"pending",t:"-"},{n:8,s:"pending",t:"-"}].map(s=>{const t={correct:{icon:"check-circle-fill",label:"Correta",color:"#28C76F"},incorrect:{icon:"x-circle-fill",label:"Incorreta",color:"#EA5455"},partial:{icon:"dash-circle-fill",label:"Parcial",color:"#FF9F43"},skipped:{icon:"skip-forward",label:"Não Resp.",color:"#00CFE8"},pending:{icon:"clock",label:"Pendente",color:"#6E6B7B"}}[s.s];return`
            <div style="display: flex; align-items: center; justify-content: space-between; padding: 12px; background: #F8F8F8; border-radius: 6px;">
              <div style="display: flex; align-items: center; gap: 12px;">
                <span style="width: 32px; height: 32px; border-radius: 50%; background: #6E63E8; color: #fff; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 14px;">${s.n}</span>
                <span class="question-status status-${s.s}">
                  <i class="bi bi-${t.icon}"></i>
                  ${t.label}
                </span>
              </div>
              <span style="font-size: 16px; font-weight: 700; color: ${t.color};">${s.t}</span>
            </div>
          `}).join("")}
      </div>
  ...
  `},r={render:()=>`
    ...
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 900px;">
      ...
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px;">
        ${[1,2,3,4,5,6,7,8].map(s=>{const n=Math.floor(Math.random()*20)+8,t=Math.floor(Math.random()*8)+2,p=28-n-t;return`
            <div style="background: #F8F8F8; border-radius: 8px; padding: 16px;">
              <div style="font-size: 32px; font-weight: 700; color: #6E63E8; margin-bottom: 12px;">Q${s}</div>
              <div style="display: flex; flex-direction: column; gap: 8px;">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                  ...
                  <span style="font-size: 12px; font-weight: 600; color: #28C76F;">${Math.round(n/28*100)}%</span>
                </div>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                  ...
                  <span style="font-size: 12px; font-weight: 600; color: #FF9F43;">${Math.round(p/28*100)}%</span>
                </div>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                  ...
                  <span style="font-size: 12px; font-weight: 600; color: #EA5455;">${Math.round(t/28*100)}%</span>
                </div>
              </div>
            </div>
          `}).join("")}
  ...
  `},c={render:()=>`
    ...
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 850px;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
          ${[{nome:"Ana Silva",respostas:["correct","correct","pending","pending"],corrigido:!1},{nome:"Bruno Costa",respostas:["correct","incorrect","partial","pending"],corrigido:!1},{nome:"Carlos Mendes",respostas:["correct","correct","correct","correct"],corrigido:!0},{nome:"Diana Santos",respostas:["incorrect","pending","pending","pending"],corrigido:!1},{nome:"Eduardo Lima",respostas:["skipped","skipped","skipped","skipped"],corrigido:!0}].map(s=>{const n={correct:"check-circle-fill",incorrect:"x-circle-fill",partial:"dash-circle-fill",pending:"clock",skipped:"skip-forward"};return`
              <tr style="border-bottom: 1px solid #F3F2F7;">
                <td style="padding: 12px; font-size: 14px; color: #5E5873; font-weight: 600;">${s.nome}</td>
                ${s.respostas.map(t=>`
                  <td style="padding: 12px; text-align: center;">
                    <span class="question-status question-status-compact status-${t}">
                      <i class="bi bi-${n[t]}"></i>
                    </span>
                  </td>
                `).join("")}
                <td style="padding: 12px; text-align: center;">
                  ${s.corrigido?'<span style="color: #28C76F; font-weight: 600; font-size: 12px;">✓ Corrigido</span>':'<span style="color: #FF9F43; font-weight: 600; font-size: 12px;">⏳ Pendente</span>'}
                </td>
              </tr>
            `}).join("")}
        </tbody>
  ...
  \`
}`,...(x=(u=o.parameters)==null?void 0:u.docs)==null?void 0:x.source}}};var f,g,b;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="display: flex; flex-direction: column; gap: 16px;">
      <div class="status-with-score">
  ...
  \`
}`,...(b=(g=a.parameters)==null?void 0:g.docs)==null?void 0:b.source}}};var m,y,h;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 650px;">
      <h3 style="margin: 0 0 16px; font-size: 18px; font-weight: 600; color: #5E5873;">
  ...
  \`
}`,...(h=(y=i.parameters)==null?void 0:y.docs)==null?void 0:h.source}}};var v,E,w;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 900px;">
      <h3 style="margin: 0 0 16px; font-size: 18px; font-weight: 600; color: #5E5873;">
  ...
  \`
}`,...(w=(E=r.parameters)==null?void 0:E.docs)==null?void 0:w.source}}};var F,z,k;c.parameters={...c.parameters,docs:{...(F=c.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 850px;">
      <h3 style="margin: 0 0 16px; font-size: 18px; font-weight: 600; color: #5E5873;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
          \${[{
    nome: 'Ana Silva',
    respostas: ['correct', 'correct', 'pending', 'pending'],
    corrigido: false
  }, {
    nome: 'Bruno Costa',
    respostas: ['correct', 'incorrect', 'partial', 'pending'],
    corrigido: false
  }, {
    nome: 'Carlos Mendes',
    respostas: ['correct', 'correct', 'correct', 'correct'],
    corrigido: true
  }, {
    nome: 'Diana Santos',
    respostas: ['incorrect', 'pending', 'pending', 'pending'],
    corrigido: false
  }, {
    nome: 'Eduardo Lima',
    respostas: ['skipped', 'skipped', 'skipped', 'skipped'],
    corrigido: true
  }].map(aluno => {
    const statusIcons = {
    ...
    return \`
              <tr style="border-bottom: 1px solid #F3F2F7;">
                ...
                \`).join('')}
                <td style="padding: 12px; text-align: center;">
                  \${aluno.corrigido ? '<span style="color: #28C76F; font-weight: 600; font-size: 12px;">✓ Corrigido</span>' : '<span style="color: #FF9F43; font-weight: 600; font-size: 12px;">⏳ Pendente</span>'}
                </td>
              </tr>
            \`;
  }).join('')}
  ...
  \`
}`,...(k=(z=c.parameters)==null?void 0:z.docs)==null?void 0:k.source}}};var C,B,q;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; padding: 24px; max-width: 500px; color: #fff;">
      <h2 style="margin: 0 0 20px; font-size: 24px; font-weight: 700;">Sua Missão foi Corrigida! 🎉</h2>
  ...
  \`
}`,...(q=(B=l.parameters)==null?void 0:B.docs)==null?void 0:q.source}}};const D=["Default","WithScore","ResultadoIndividual","DesempenhoPorQuestao","TabelaDeCorrecao","FeedbackAluno"];export{o as Default,r as DesempenhoPorQuestao,l as FeedbackAluno,i as ResultadoIndividual,c as TabelaDeCorrecao,a as WithScore,D as __namedExportsOrder,$ as default};
