const V={title:"Educacross Components V2/Modals/StudentGameDetailsModal",tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:`StudentGameDetailsModal - Modal de Detalhes do Jogo do Aluno
=============================================================
...
`,a=(e,p=[])=>`
  <div class="student-header">
    <div>
      <div class="student-title">${e}</div>
      <div class="student-meta">
        ${p.map(S=>`<span>${S}</span>`).join("")}
      </div>
    </div>
    <div class="student-close"><i class="bi bi-x-lg"></i></div>
  </div>
`,i={render:()=>s(`
    ${a("Seu progresso no jogo • Frações Intergalácticas",["Missão ativa","XP total: 1280","Equipe Cosmos"])}
    <div class="student-body">
      <div class="student-section">
        <div class="student-section-title"><i class="bi bi-flag"></i> Etapas da missão</div>
        <div class="progress-track">
          ${[{title:"Explorar tutorial",status:"Concluído",done:!0},{title:"Desafios cooperativos",status:"Em andamento",done:!0},{title:"Quiz relâmpago",status:"Faltam 2 questões",done:!1}].map(e=>`
            <div class="progress-step" style="border-color:${e.done?"#6E63E8":"#E5E3F3"}">
              <div class="progress-title">${e.title}</div>
              <div class="progress-status">${e.status}</div>
              <span class="pill">${e.done?"✔ Completo":"Em progresso"}</span>
            </div>
          `).join("")}
        </div>
      </div>
  ...
  `)},o={render:()=>s(`
    ${a("Missões em andamento",["2 de 4 concluídas","Tempo estimado restante: 35 min"])}
    <div class="student-body">
      <div class="student-section">
        <div class="student-section-title"><i class="bi bi-list-check"></i> Próximos passos</div>
        <div class="timeline">
          ${[{icon:"bi-journal-text",title:"Registrar diário de bordo",desc:"Conte o que sua equipe descobriu sobre frações equivalentes."},{icon:"bi-camera-video",title:"Enviar vídeo curto",desc:"Explique a solução do enigma 3 usando exemplos do cotidiano."},{icon:"bi-upload",title:"Upload da evidência final",desc:"Anexe o arquivo PDF com todas as etapas resolvidas."}].map(e=>`
            <div class="timeline-item">
              <div class="timeline-icon"><i class="bi ${e.icon}"></i></div>
              <div>
                <div style="font-size:13px;font-weight:600;color:#3F3F46">${e.title}</div>
                <div class="student-text" style="font-size:12px">${e.desc}</div>
              </div>
            </div>
          `).join("")}
        </div>
  ...
  `)},d={render:()=>s(`
    ${a("Suas conquistas liberadas",["Total de badges: 6","Próxima recompensa em 120 XP"])}
    <div class="student-body">
      <div class="student-section">
        <div class="student-section-title"><i class="bi bi-award"></i> Badges conquistadas</div>
        <div class="badge-collection">
          ${[{icon:"🚀",name:"Explorador",label:"Primeira missão"},{icon:"🧠",name:"Estrategista",label:"Plano da equipe"},{icon:"⚡",name:"Velocista",label:"Quiz em <5min"},{icon:"🤝",name:"Mentor",label:"Ajudou colegas"}].map(e=>`
  ...
  `)},t={render:()=>s(`
    ${a("Feedback do professor",["Profª Camila","Enviado em 09/02 às 11h"])}
    <div class="student-body">
  ...
  `)},n={render:()=>s(`
    ${a("Resumo estatístico pessoal",["Rodadas jogadas: 5","XP médio: 910"])}
    <div class="student-body">
      <div class="student-section">
        ...
        <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:12px;align-items:end;height:140px;padding:16px;border:1px solid #E5E3F3;border-radius:12px;background:#F8F7FD">
          ${[620,780,860,790,950].map(e=>`
            <div style="background:linear-gradient(180deg,#6E63E8,#9F93F8);height:${e/8}px;border-radius:8px;position:relative">
              <span style="position:absolute;bottom:100%;left:50%;transform:translate(-50%,-6px);font-size:11px;color:#3F3F46">${e}</span>
            </div>
          `).join("")}
        </div>
      </div>
  ...
  `)},r={render:()=>s(`
    ${a("Modo cooperativo",["Equipe Cosmos","Membros: Ana, Júlia, Pedro, Robson"])}
    <div class="student-body">
      <div class="student-section">
        <div class="student-section-title"><i class="bi bi-people"></i> Responsabilidades da equipe</div>
        <div class="timeline">
          ${[{icon:"bi-person",name:"Ana",task:"Coordena diário de bordo"},{icon:"bi-mic",name:"Júlia",task:"Grava vídeo explicativo"},{icon:"bi-layers",name:"Pedro",task:"Organiza evidências no app"},{icon:"bi-palette",name:"Robson",task:"Cria apresentação final"}].map(e=>`
            <div class="timeline-item" style="background:#fff">
              <div class="timeline-icon" style="background:#E6E4FF;color:#433878"><i class="${e.icon}"></i></div>
              <div>
                <div style="font-size:13px;font-weight:600;color:#3F3F46">${e.name}</div>
                <div class="student-text" style="font-size:12px">${e.task}</div>
              </div>
            </div>
          `).join("")}
        </div>
  ...
  `)},l={render:()=>s(`
    ${a("Resumo rápido",["XP atual: 1280","Lugar no ranking: #4"])}
  ...
  `)};var v,u,m;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => renderModal(\`
  ...
  \`)
}`,...(m=(u=i.parameters)==null?void 0:u.docs)==null?void 0:m.source}}};var x,b,g;o.parameters={...o.parameters,docs:{...(x=o.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => renderModal(\`
    ...
    title: 'Registrar diário de bordo',
    desc: 'Conte o que sua equipe descobriu sobre frações equivalentes.'
  }, {
    icon: 'bi-camera-video',
    title: 'Enviar vídeo curto',
    desc: 'Explique a solução do enigma 3 usando exemplos do cotidiano.'
  }, {
    icon: 'bi-upload',
    title: 'Upload da evidência final',
    desc: 'Anexe o arquivo PDF com todas as etapas resolvidas.'
  }].map(item => \`
            <div class="timeline-item">
  ...
  \`)
}`,...(g=(b=o.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};var f,E,F;d.parameters={...d.parameters,docs:{...(f=d.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => renderModal(\`
  ...
  \`)
}`,...(F=(E=d.parameters)==null?void 0:E.docs)==null?void 0:F.source}}};var h,y,$;t.parameters={...t.parameters,docs:{...(h=t.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => renderModal(\`
  ...
  \`)
}`,...($=(y=t.parameters)==null?void 0:y.docs)==null?void 0:$.source}}};var k,z,P;n.parameters={...n.parameters,docs:{...(k=n.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => renderModal(\`
  ...
  \`)
}`,...(P=(z=n.parameters)==null?void 0:z.docs)==null?void 0:P.source}}};var D,w,q;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => renderModal(\`
    ...
    icon: 'bi-person',
    name: 'Ana',
    task: 'Coordena diário de bordo'
  }, {
    icon: 'bi-mic',
    name: 'Júlia',
    task: 'Grava vídeo explicativo'
  }, {
    icon: 'bi-layers',
    name: 'Pedro',
    task: 'Organiza evidências no app'
  }, {
    icon: 'bi-palette',
    name: 'Robson',
    task: 'Cria apresentação final'
  }].map(member => \`
            <div class="timeline-item" style="background:#fff">
  ...
  \`)
}`,...(q=(w=r.parameters)==null?void 0:w.docs)==null?void 0:q.source}}};var M,j,C;l.parameters={...l.parameters,docs:{...(M=l.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => renderModal(\`
  ...
  \`, 'compact')
}`,...(C=(j=l.parameters)==null?void 0:j.docs)==null?void 0:C.source}}};var B,A,R;c.parameters={...c.parameters,docs:{...(B=c.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => renderModal(\`
    <div class="student-body" style="padding:48px 30px">
      <div class="empty">
        <img src="/educacross-assets/belinha/belinha-school-doubt.png" class="mascot-image" alt="Belinha - dúvida" />
  ...
  \`)
}`,...(R=(A=c.parameters)==null?void 0:A.docs)==null?void 0:R.source}}};const T=["Default","MissoesParciais","Conquistas","FeedbackProfessor","Estatisticas","Cooperativo","Compacto","Vazio"];export{l as Compacto,d as Conquistas,r as Cooperativo,i as Default,n as Estatisticas,t as FeedbackProfessor,o as MissoesParciais,c as Vazio,T as __namedExportsOrder,V as default};
