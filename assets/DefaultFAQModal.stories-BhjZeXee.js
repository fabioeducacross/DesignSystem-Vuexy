const U={title:"Educacross Components V2/Modals/DefaultFAQModal",tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:`DefaultFAQModal - Modal de Perguntas Frequentes
================================================
...
`,i=(e,a={})=>`
<div class="faq-shell ${a.extra||""}">
  <div class="faq-modal">
    <div class="faq-header">
      <div class="faq-title"><i class="bi bi-question-circle"></i> ${a.title||"Central de Ajuda"}</div>
...
<\/script>
`,Q=(e,a=0)=>e.map((u,R)=>`
  <div class="faq-item ${R===a?"active":""}">
    <div class="faq-question">${u.q} <i class="bi bi-chevron-down"></i></div>
    <div class="faq-answer">${u.a}</div>
  </div>
`).join(""),s={render:()=>i(`
    ...
    <div class="faq-scroll">
      <div class="faq-section">
        ...
        ${Q([{q:"Como adicionar um novo aluno à turma?",a:"Acesse Turmas > Adicionar Aluno e escolha CSV ou manual."},{q:"Posso editar uma missão após publicá-la?",a:"Apenas ajustes de texto e configurações são seguros. Para mudanças estruturais, duplique a missão."},{q:"Como enviar feedback para o aluno?",a:"Abra a evidência, clique em Feedback e registre o retorno com rubricas."}])}
      </div>
    </div>
  `)},o={render:()=>i(`
    <div class="faq-scroll">
  ...
  `,{title:"Precisa de ajuda?"})},t={render:()=>i(`
    <div class="faq-scroll">
      <div class="faq-section">
        <div class="faq-section-title"><i class="bi bi-bookmark"></i> Acesso rápido</div>
        ${[{icon:"bi-book",title:"Guia do Professor",desc:"Manual completo de uso",badge:"Atualizado"},{icon:"bi-play-circle",title:"Vídeos tutoriais",desc:"18 aulas em vídeo",badge:"Novo"},{icon:"bi-file-earmark-pdf",title:"Download PDF",desc:"Documentação offline"},{icon:"bi-journal-code",title:"API e integrações",desc:"Para desenvolvedores"}].map(e=>`
          <div class="quick-link">
            <div style="width:36px;height:36px;border-radius:10px;display:grid;place-items:center;background:#efeefe;color:#4b3cc4;"><i class="bi ${e.icon}"></i></div>
            <div style="flex:1;">
              <div style="font-weight:800;color:var(--text);">${e.title}</div>
              <div style="font-size:12px;color:var(--muted);">${e.desc}</div>
            </div>
            ${e.badge?`<span class="badge-pill">${e.badge}</span>`:""}
            <i class="bi bi-arrow-right" style="color:var(--muted);"></i>
          </div>
        `).join("")}
      </div>
    </div>
  `,{title:"Recursos e documentação"})},r={render:()=>i(`
    <div class="faq-scroll">
      ${[{title:"Primeiros passos",icon:"bi-rocket-takeoff",count:8},{title:"Gestão de turmas",icon:"bi-people",count:12},{title:"Missões e jogos",icon:"bi-trophy",count:15},{title:"Avaliação e relatórios",icon:"bi-graph-up",count:9},{title:"Configurações da conta",icon:"bi-gear",count:6}].map(e=>`
        <div class="faq-section">
          <div class="faq-section-title"><i class="bi ${e.icon}"></i> ${e.title} <span class="badge-pill">${e.count} artigos</span></div>
          <div style="font-size:13px;color:var(--muted);">Clique para explorar artigos desta categoria</div>
        </div>
      `).join("")}
    </div>
  `,{title:"Tópicos de ajuda"})},n={render:()=>i(`
    <div class="faq-search">
      <i class="bi bi-search"></i>
    ...
    <div class="faq-scroll">
      ${Q([{q:"Como importar alunos via CSV?",a:"Prepare um arquivo com nome, email, data_nascimento, responsável e importe em Turmas > Importar."},{q:"Formatos aceitos para importação",a:"CSV separado por vírgula ou ponto e vírgula, com cabeçalho."},{q:"Corrigir erros de importação",a:"Baixe o log de erros, ajuste o CSV e reenviar."}],0)}
    </div>
  `,{title:"Buscar ajuda"})},d={render:()=>i(`
    <div class="faq-scroll">
      <div class="video-box">
      ...
      <div class="faq-section" style="background:#fff;">
        ...
        ${["Importar alunos (3:20)","Configurar pontos XP (5:15)","Usar relatórios (6:40)"].map(e=>`
  ...
  `,{title:"Tutorial em vídeo"})},c={render:()=>i(`
    <div class="faq-scroll">
      <div class="faq-section">
        <div class="faq-section-title"><i class="bi bi-activity"></i> Serviços operacionais</div>
        ${[{service:"Plataforma web",status:"operational",desc:"Todos os sistemas funcionando"},{service:"API de integrações",status:"operational",desc:"Tempo de resposta: 120ms"},{service:"Upload de arquivos",status:"degraded",desc:"Lentidão temporária detectada"}].map(e=>{const a=e.status==="operational"?{bg:"#e6f7ed",border:"#34c759",text:"#1b874e",label:"✓ Operacional"}:{bg:"#fff4e5",border:"#ff9500",text:"#b86e00",label:"⚠ Degradado"};return`
            <div class="status-card">
              <div style="display:flex;justify-content:space-between;align-items:center;">
                <div>
                  <div style="font-weight:800;color:var(--text);">${e.service}</div>
                  <div style="font-size:12px;color:var(--muted);">${e.desc}</div>
                </div>
                <span style="padding:6px 12px;border-radius:999px;background:${a.bg};border:1px solid ${a.border};color:${a.text};font-weight:700;font-size:12px;">${a.label}</span>
              </div>
            </div>
          `}).join("")}
      </div>
    </div>
  `,{title:"Status do sistema"})},l={render:()=>i(`
    <div class="faq-search">
      <i class="bi bi-search"></i>
  ...
  `,{extra:"compact",title:"Ajuda"})},p={render:()=>i(`
  ...
  `)};var v,f,b;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => render(\`
    <div class="faq-search">
      <i class="bi bi-search"></i>
      <input type="text" placeholder="Buscar dúvidas frequentes..." />
    ...
    <div class="faq-scroll">
      <div class="faq-section">
        <div class="faq-section-title"><i class="bi bi-patch-question"></i> Perguntas frequentes</div>
        \${faqList([{
    q: 'Como adicionar um novo aluno à turma?',
    a: 'Acesse Turmas > Adicionar Aluno e escolha CSV ou manual.'
  }, {
    q: 'Posso editar uma missão após publicá-la?',
    a: 'Apenas ajustes de texto e configurações são seguros. Para mudanças estruturais, duplique a missão.'
  }, {
    q: 'Como enviar feedback para o aluno?',
    a: 'Abra a evidência, clique em Feedback e registre o retorno com rubricas.'
  }])}
      </div>
    </div>
  \`)
}`,...(b=(f=s.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var m,x,g;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => render(\`
    <div class="faq-scroll">
      <div class="faq-section">
        <div class="faq-section-title"><i class="bi bi-chat-dots"></i> Canais de suporte <small>Escolha o canal preferido</small></div>
...
}`,...(g=(x=o.parameters)==null?void 0:x.docs)==null?void 0:g.source}}};var q,y,h;t.parameters={...t.parameters,docs:{...(q=t.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => render(\`
    <div class="faq-scroll">
      <div class="faq-section">
        <div class="faq-section-title"><i class="bi bi-bookmark"></i> Acesso rápido</div>
    ...
    desc: 'Manual completo de uso',
    badge: 'Atualizado'
  }, {
    icon: 'bi-play-circle',
    title: 'Vídeos tutoriais',
    desc: '18 aulas em vídeo',
    badge: 'Novo'
  }, {
    icon: 'bi-file-earmark-pdf',
    title: 'Download PDF',
    desc: 'Documentação offline'
  }, {
    icon: 'bi-journal-code',
    title: 'API e integrações',
    desc: 'Para desenvolvedores'
  }].map(link => \`
          <div class="quick-link">
...
}`,...(h=(y=t.parameters)==null?void 0:y.docs)==null?void 0:h.source}}};var k,E,w;r.parameters={...r.parameters,docs:{...(k=r.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => render(\`
    <div class="faq-scroll">
      \${[{
...
}`,...(w=(E=r.parameters)==null?void 0:E.docs)==null?void 0:w.source}}};var $,C,A;n.parameters={...n.parameters,docs:{...($=n.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => render(\`
    <div class="faq-search">
      <i class="bi bi-search"></i>
      <input type="text" value="como importar alunos" />
    ...
    <div class="faq-scroll">
      \${faqList([{
    q: 'Como importar alunos via CSV?',
    a: 'Prepare um arquivo com nome, email, data_nascimento, responsável e importe em Turmas > Importar.'
  }, {
    q: 'Formatos aceitos para importação',
    a: 'CSV separado por vírgula ou ponto e vírgula, com cabeçalho.'
  }, {
    q: 'Corrigir erros de importação',
    a: 'Baixe o log de erros, ajuste o CSV e reenviar.'
  }], 0)}
    </div>
  \`, {
    title: 'Buscar ajuda'
  })
}`,...(A=(C=n.parameters)==null?void 0:C.docs)==null?void 0:A.source}}};var j,P,z;d.parameters={...d.parameters,docs:{...(j=d.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => render(\`
    <div class="faq-scroll">
      <div class="video-box">
        <div style="width:72px;height:72px;border-radius:50%;background:var(--primary);color:#fff;display:grid;place-items:center;font-size:32px;cursor:pointer;"><i class="bi bi-play-fill"></i></div>
...
}`,...(z=(P=d.parameters)==null?void 0:P.docs)==null?void 0:z.source}}};var D,S,T;c.parameters={...c.parameters,docs:{...(D=c.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => render(\`
    <div class="faq-scroll">
      <div class="faq-section">
        <div class="faq-section-title"><i class="bi bi-activity"></i> Serviços operacionais</div>
    ...
    status: 'operational',
    desc: 'Todos os sistemas funcionando'
  }, {
    service: 'API de integrações',
    status: 'operational',
    desc: 'Tempo de resposta: 120ms'
  }, {
    service: 'Upload de arquivos',
    status: 'degraded',
    desc: 'Lentidão temporária detectada'
  }].map(item => {
...
}`,...(T=(S=c.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var F,V,M;l.parameters={...l.parameters,docs:{...(F=l.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => render(\`
    <div class="faq-search">
      <i class="bi bi-search"></i>
      <input type="text" placeholder="O que você precisa?" />
...
}`,...(M=(V=l.parameters)==null?void 0:V.docs)==null?void 0:M.source}}};var I,L,B;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: () => render(\`
    <div class="faq-scroll" style="align-content:center;">
      <div class="empty">
        <div style="font-size:44px;">🔍</div>
  ...
  \`)
}`,...(B=(L=p.parameters)==null?void 0:L.docs)==null?void 0:B.source}}};const _=["Default","ComContato","LinksRapidos","CategoriasPorTopico","ComBusca","TutorialVideo","StatusDoSistema","Compacto","Vazio"];export{r as CategoriasPorTopico,n as ComBusca,o as ComContato,l as Compacto,s as Default,t as LinksRapidos,c as StatusDoSistema,d as TutorialVideo,p as Vazio,_ as __namedExportsOrder,U as default};
