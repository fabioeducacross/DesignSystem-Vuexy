const j={title:"Vuexy/Foundations/Typography",parameters:{previewTabs:{canvas:{hidden:!1}},docs:{description:{component:`==============================================
...
`,i={render:()=>`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      ${o("Font Family","As famílias tipográficas utilizadas no Design System Educacross. Public Sans é nossa fonte principal, escolhida por sua legibilidade e modernidade.")}
      
      <div style="padding: 0 1rem; display: flex; flex-direction: column; gap: 1.5rem;">
        
        <!-- Public Sans -->
        ${n("Public Sans","✨","#FAB84A",`
          <div style="
          ...
          ${m('font-family: "Public Sans", sans-serif;')}
        ...
        ${n("Monospace","💻","#0C5257",`
          ...
          ${m("font-family: var(--bs-font-monospace);")}
  ...
  `},r={render:()=>`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      ${o("Headings","Hierarquia de títulos para criar estrutura visual clara e organizada. Use de forma consistente para melhorar a escaneabilidade.")}
  ...
  `},t={render:()=>`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      ${o("Body Text","Tamanhos de texto para diferentes contextos. Escolha o tamanho adequado para garantir legibilidade e hierarquia visual.")}
  ...
  `},a={render:()=>`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      ${o("Font Weights","Pesos tipográficos disponíveis para criar hierarquia e ênfase. Use com moderação para manter a consistência visual.")}
  ...
  `},d={render:()=>`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      ${o("Text Styles","Utilitários de texto para alinhamento, decoração, transformação e comportamento. Aplique conforme a necessidade do layout.")}
      
      <div style="padding: 0 1rem; display: flex; flex-direction: column; gap: 1.5rem;">
        
        ${n("Alinhamento","↔️","#0C5257",`
          <div style="display: flex; flex-direction: column; gap: 0.75rem;">
  ...
  `},s={render:()=>`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      ${o("Line Height","Espaçamento entre linhas para melhorar a legibilidade. Textos mais longos precisam de mais espaço.")}
  ...
  `},l={render:()=>{const e="typography-interactive-"+Math.random().toString(36).substr(2,9);return`
      <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
        ${o("Demo Interativo","Experimente diferentes combinações tipográficas em tempo real. Ajuste os controles para ver como afetam a apresentação do texto.")}
          ...
          ">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
              <div>
                ...
                <select 
                  class="form-select" 
                  onchange="document.getElementById('demoContent-${e}').style.fontSize = this.value;"
              ...
              <div>
                ...
                <select 
                  class="form-select" 
                  onchange="document.getElementById('demoContent-${e}').style.fontWeight = this.value;"
                  style="border-color: #E0DDD4;"
                >
              ...
              <div>
                ...
                <select 
                  class="form-select" 
                  onchange="document.getElementById('demoContent-${e}').style.lineHeight = this.value;"
                  style="border-color: #E0DDD4;"
                >
    ...
    `}};var c,g,x;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      \${heroSection('Font Family', 'As famílias tipográficas utilizadas no Design System Educacross. Public Sans é nossa fonte principal, escolhida por sua legibilidade e modernidade.')}
  ...
  \`
}`,...(x=(g=i.parameters)==null?void 0:g.docs)==null?void 0:x.source}}};var u,b,y;r.parameters={...r.parameters,docs:{...(u=r.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      \${heroSection('Headings', 'Hierarquia de títulos para criar estrutura visual clara e organizada. Use de forma consistente para melhorar a escaneabilidade.')}
  ...
  \`
}`,...(y=(b=r.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};var v,f,h;t.parameters={...t.parameters,docs:{...(v=t.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      \${heroSection('Body Text', 'Tamanhos de texto para diferentes contextos. Escolha o tamanho adequado para garantir legibilidade e hierarquia visual.')}
  ...
  \`
}`,...(h=(f=t.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};var F,E,w;a.parameters={...a.parameters,docs:{...(F=a.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      \${heroSection('Font Weights', 'Pesos tipográficos disponíveis para criar hierarquia e ênfase. Use com moderação para manter a consistência visual.')}
  ...
  \`
}`,...(w=(E=a.parameters)==null?void 0:E.docs)==null?void 0:w.source}}};var z,k,C;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      \${heroSection('Text Styles', 'Utilitários de texto para alinhamento, decoração, transformação e comportamento. Aplique conforme a necessidade do layout.')}
  ...
  \`
}`,...(C=(k=d.parameters)==null?void 0:k.docs)==null?void 0:C.source}}};var D,A,B;s.parameters={...s.parameters,docs:{...(D=s.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
      \${heroSection('Line Height', 'Espaçamento entre linhas para melhorar a legibilidade. Textos mais longos precisam de mais espaço.')}
  ...
  \`
}`,...(B=(A=s.parameters)==null?void 0:A.docs)==null?void 0:B.source}}};var S,H,T;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => {
    const containerId = 'typography-interactive-' + Math.random().toString(36).substr(2, 9);
    return \`
      <div style="padding: 1rem; max-width: 900px; background: #F8F6EF; min-height: 100vh;">
        \${heroSection('Demo Interativo', 'Experimente diferentes combinações tipográficas em tempo real. Ajuste os controles para ver como afetam a apresentação do texto.')}
...
}`,...(T=(H=l.parameters)==null?void 0:H.docs)==null?void 0:T.source}}};const M=["FontFamily","Headings","BodyText","FontWeights","TextStyles","LineHeight","Interactive"];export{t as BodyText,i as FontFamily,a as FontWeights,r as Headings,l as Interactive,s as LineHeight,d as TextStyles,M as __namedExportsOrder,j as default};
