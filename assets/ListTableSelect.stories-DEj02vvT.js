const L={title:"Educacross Components V2/Tables/ListTableSelect",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
`,i={render:()=>`
    ...
    <div class="select-table">
      ...
      ${[{n:"Ana Silva",t:"8º A",m:9.5,c:"#6E63E8"},{n:"Bruno Costa",t:"8º B",m:8.8,c:"#00CFE8"},{n:"Diana Santos",t:"8º A",m:9.2,c:"#28C76F"}].map((n,e)=>`
        <div class="select-row${e===0?" selected":""}">
          <div><div class="checkbox${e===0?" checked":""}"></div></div>
          <div class="student-info">
            <div class="student-avatar" style="background: ${n.c};">
              ${n.n.split(" ").map(P=>P[0]).join("")}
            </div>
            <div class="student-name">${n.n}</div>
          </div>
          <div style="font-size: 13px; color: #6E6B7B;">${n.t}</div>
          <div style="font-weight: 700; color: #28C76F;">${n.m}</div>
        </div>
      `).join("")}
    </div>
  `},o={render:()=>`
    ...
    <div class="select-table">
      ...
      ${[{n:"Ana Silva",t:"8º A",m:9.5,c:"#6E63E8"},{n:"Bruno Costa",t:"8º B",m:8.8,c:"#00CFE8"},{n:"Diana Santos",t:"8º A",m:9.2,c:"#28C76F"}].map(n=>`
        <div class="select-row selected">
          <div><div class="checkbox checked"></div></div>
          <div class="student-info">
            <div class="student-avatar" style="background: ${n.c};">
              ${n.n.split(" ").map(e=>e[0]).join("")}
            </div>
            <div class="student-name">${n.n}</div>
          </div>
          <div style="font-size: 13px; color: #6E6B7B;">${n.t}</div>
  ...
  `},t={render:()=>`
    ...
    <div class="select-table">
      ...
      ${[{n:"Ana Silva",t:"8º A",s:"Ativo",c:"#6E63E8"},{n:"Bruno Costa",t:"8º B",s:"Ativo",c:"#00CFE8"}].map(n=>`
        <div class="select-row selected">
          <div><div class="checkbox checked"></div></div>
          <div class="student-info">
            <div class="student-avatar" style="background: ${n.c};">
          ...
          <div style="font-size: 13px; color: #6E6B7B;">${n.t}</div>
          <div style="font-size: 13px; color: #28C76F;">${n.s}</div>
        </div>
      `).join("")}
  ...
  `},a={render:()=>`
    ...
    <div class="select-table">
      ...
      ${[{n:"Ana Silva",t:"8º A",m:9.5,sel:!0,c:"#6E63E8"},{n:"Bruno Costa",t:"8º B",m:8.8,sel:!1,c:"#00CFE8"},{n:"Diana Santos",t:"8º A",m:9.2,sel:!0,c:"#28C76F"},{n:"Eduardo Lima",t:"9º A",m:8.5,sel:!1,c:"#FF9F43"}].map(n=>`
        <div class="select-row${n.sel?" selected":""}">
          <div><div class="checkbox${n.sel?" checked":""}"></div></div>
          <div class="student-info">
            <div class="student-avatar" style="background: ${n.c};">
              ${n.n.split(" ").map(e=>e[0]).join("")}
            </div>
  ...
  `},d={render:()=>`
    ...
    <div class="select-table">
      ...
      ${[{m:"Frações Básicas",d:"10/02/2026",s:"Aberta",c:"#28C76F"},{m:"Verbos e Conjugações",d:"12/02/2026",s:"Aberta",c:"#6E63E8"},{m:"Sistema Solar",d:"15/02/2026",s:"Rascunho",c:"#FF9F43"}].map(n=>`
        <div class="select-row selected">
          <div><div class="checkbox checked"></div></div>
          <div style="font-weight: 600; color: #5E5873;">${n.m}</div>
          <div style="font-size: 13px; color: #6E6B7B;">${n.d}</div>
          <div>
            <span style="padding: 4px 10px; border-radius: 6px; font-size: 12px; font-weight: 600; background: ${n.c}20; color: ${n.c};">
              ${n.s}
            </span>
          </div>
        </div>
  ...
  `},c={render:()=>`
    ...
    <div class="select-table">
      ...
      ${[{n:"Ana Silva",t:"8º A",m:9.5,c:"#6E63E8"}].map(n=>`
  ...
  `},r={render:()=>`
    ...
    <div class="select-table">
      ...
      ${[{n:"Ana Silva",e:"ana@aluno.com",t:"8º A",c:"#6E63E8"},{n:"Bruno Costa",e:"bruno@aluno.com",t:"8º B",c:"#00CFE8"}].map(n=>`
        <div class="select-row selected">
          <div><div class="checkbox checked"></div></div>
          <div class="student-info">
            <div class="student-avatar" style="background: ${n.c};">
          ...
          <div style="font-size: 13px; color: #6E6B7B;">${n.e}</div>
          <div style="font-size: 13px; color: #6E6B7B;">${n.t}</div>
        </div>
      `).join("")}
      <div class="actions-bar">
  ...
  `};var v,p,x;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="select-table">
      <div class="select-header">
  ...
  \`
}`,...(x=(p=i.parameters)==null?void 0:p.docs)==null?void 0:x.source}}};var u,m,b;o.parameters={...o.parameters,docs:{...(u=o.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="select-table">
      <div class="select-header">
  ...
  \`
}`,...(b=(m=o.parameters)==null?void 0:m.docs)==null?void 0:b.source}}};var E,f,g;t.parameters={...t.parameters,docs:{...(E=t.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="select-table">
      <div class="select-header">
  ...
  \`
}`,...(h=(B=a.parameters)==null?void 0:B.docs)==null?void 0:h.source}}};var $,k,A;d.parameters={...d.parameters,docs:{...($=d.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="select-table">
      <div class="select-header">
  ...
  \`
}`,...(A=(k=d.parameters)==null?void 0:k.docs)==null?void 0:A.source}}};var C,F,S;c.parameters={...c.parameters,docs:{...(C=c.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="select-table">
      <div class="filter">
  ...
  \`
}`,...(S=(F=c.parameters)==null?void 0:F.docs)==null?void 0:S.source}}};var z,w,D;r.parameters={...r.parameters,docs:{...(z=r.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div class="select-table">
      <div class="select-header">
  ...
  \`
}`,...(D=(w=r.parameters)==null?void 0:w.docs)==null?void 0:D.source}}};var j,T,M;l.parameters={...l.parameters,docs:{...(j=l.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
  ...
  \`
}`,...(M=(T=l.parameters)==null?void 0:T.docs)==null?void 0:M.source}}};const I=["Default","TodosSelecionados","ComAcoes","Parcial","MultiSelecao","ComFiltro","Exportar","Completa"];export{t as ComAcoes,c as ComFiltro,l as Completa,i as Default,r as Exportar,d as MultiSelecao,a as Parcial,o as TodosSelecionados,I as __namedExportsOrder,L as default};
