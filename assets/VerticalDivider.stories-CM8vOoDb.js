const es={title:"Educacross Components V2/Layout/VerticalDivider",tags:["autodocs"],parameters:{docs:{description:{component:`
# VerticalDivider
...
.demo-item {
  ...
  `};var d,c,x,m,v;e.parameters={...e.parameters,docs:{...(d=e.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="demo-container">
      <span class="demo-item">Item 1</span>
  ...
  \`
}`,...(x=(c=e.parameters)==null?void 0:c.docs)==null?void 0:x.source},description:{story:`Story: Default

3 items separados (Item 1, Item 2, Item 3) com dividers 24px height, 16px spacing.

Educational context: Separator padrão inline entre elementos.`,...(v=(m=e.parameters)==null?void 0:m.docs)==null?void 0:v.description}}};var g,y,f,h,b;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div style="display: flex; flex-direction: column; gap: 20px">
      <div class="demo-container">
  ...
  \`
}`,...(f=(y=n.parameters)==null?void 0:y.docs)==null?void 0:f.source},description:{story:`Story: AllHeights

4 variants de altura: 16px, 24px, 32px, 48px.

Educational context: Showcase de alturas disponíveis.`,...(b=(h=n.parameters)==null?void 0:h.docs)==null?void 0:b.description}}};var u,E,B,z,D;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div style="display: flex; flex-direction: column; gap: 20px">
      <div class="demo-container">
  ...
  \`
}`,...(B=(E=i.parameters)==null?void 0:E.docs)==null?void 0:B.source},description:{story:`Story: AllColors

4 cores: default (#D8D6DE), primary (#6E63E8), success (#28C76F), light (#F3F2F7).

Educational context: Showcase de cores disponíveis.`,...(D=(z=i.parameters)==null?void 0:z.docs)==null?void 0:D.description}}};var F,C,I,k,A;a.parameters={...a.parameters,docs:{...(F=a.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <nav style="display: flex; justify-content: space-between; align-items: center; padding: 12px 24px; background: #fff; border: 1px solid #D8D6DE; border-radius: 8px">
      <div style="font-size: 18px; font-weight: 700; color: #6E63E8">
  ...
  \`
}`,...(I=(C=a.parameters)==null?void 0:C.docs)==null?void 0:I.source},description:{story:`Story: NavbarActions

Navbar com logo + actions (search, bell, gear) separados + avatar.

Educational context: Navbar com actions separados por dividers.`,...(A=(k=a.parameters)==null?void 0:k.docs)==null?void 0:A.description}}};var w,S,M,$,N;t.parameters={...t.parameters,docs:{...(w=t.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="demo-container">
      <a href="#" style="font-size: 14px; color: #6E6B7B; text-decoration: none" onmouseover="this.style.color='#6E63E8'" onmouseout="this.style.color='#6E6B7B'">Dashboard</a>
  ...
  \`
}`,...(M=(S=t.parameters)==null?void 0:S.docs)==null?void 0:M.source},description:{story:`Story: Breadcrumbs

Dashboard > Missões > Matemática > Frações (16px height, 12px spacing).

Educational context: Breadcrumbs de navegação (4 níveis).`,...(N=($=t.parameters)==null?void 0:$.docs)==null?void 0:N.description}}};var R,j,V,q,H;o.parameters={...o.parameters,docs:{...(R=o.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="demo-container">
      <div style="display: flex; align-items: center; gap: 6px; font-size: 14px; color: #6E6B7B">
  ...
  \`
}`,...(V=(j=o.parameters)==null?void 0:j.docs)==null?void 0:V.source},description:{story:`Story: Metadata

Card meta com 4 items (pessoa Mariana Silva, data 15/01/2024, alunos 28, disciplina Matemática) com ícones 16px.

Educational context: Metadata de card com 4 informações separadas.`,...(H=(q=o.parameters)==null?void 0:q.docs)==null?void 0:H.description}}};var L,T,_,G,P;r.parameters={...r.parameters,docs:{...(L=r.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div style="max-width: 600px; background: #fff; border: 1px solid #D8D6DE; border-radius: 8px">
      <div style="padding: 20px; border-bottom: 1px solid #E8E8E8">
  ...
  \`
}`,...(_=(T=r.parameters)==null?void 0:T.docs)==null?void 0:_.source},description:{story:`Story: CardFooterActions

Card footer com 3 botões (Cancelar, Editar, Aplicar) separados (20px height, 8px spacing).

Educational context: Card footer com actions separados.`,...(P=(G=r.parameters)==null?void 0:G.docs)==null?void 0:P.description}}};var O,Q,J,K,U;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div style="display: flex; align-items: center; padding: 24px; background: #fff; border: 1px solid #D8D6DE; border-radius: 8px">
      <div style="flex: 1; text-align: center">
  ...
  \`
}`,...(J=(Q=p.parameters)==null?void 0:Q.docs)==null?void 0:J.source},description:{story:`Story: StatisticsRow

4 stats grandes (156 Alunos, 45 Missões, 87% Taxa, 8.2 Média) com ícones 32px e dividers 64px height.

Educational context: Dashboard com 4 estatísticas grandes separadas.`,...(U=(K=p.parameters)==null?void 0:K.docs)==null?void 0:U.description}}};var W,X,Y,Z,ss;l.parameters={...l.parameters,docs:{...(W=l.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <style>
      @media (max-width: 768px) {
  ...
  \`
}`,...(Y=(X=l.parameters)==null?void 0:X.docs)==null?void 0:Y.source},description:{story:`Story: Responsive

Media query escondendo dividers em mobile (<768px).

Educational context: Layout responsivo (dividers desaparecem em mobile).`,...(ss=(Z=l.parameters)==null?void 0:Z.docs)==null?void 0:ss.description}}};const ns=["Default","AllHeights","AllColors","NavbarActions","Breadcrumbs","Metadata","CardFooterActions","StatisticsRow","Responsive"];export{i as AllColors,n as AllHeights,t as Breadcrumbs,r as CardFooterActions,e as Default,o as Metadata,a as NavbarActions,l as Responsive,p as StatisticsRow,ns as __namedExportsOrder,es as default};
