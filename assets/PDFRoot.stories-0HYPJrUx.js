const R={title:"Educacross Components V2/PDF/PDFRoot",tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:`
# PDFRoot
...
`,n=`<svg class="back-icon" viewBox="0 0 24 24" fill="none" stroke="#5D596C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="pdf-content-area">
        ...
        <div style="border-top: 1px solid #DBDADE; padding-top: 24px;">
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 16px;">
            ${[{label:"Média Geral",value:"7.8",icon:"bi-graph-up",color:"#28C76F"},{label:"Missões Completas",value:"18/20",icon:"bi-check-circle",color:"#6E63E8"},{label:"Taxa Aprovação",value:"92%",icon:"bi-trophy",color:"#FF9F43"}].map(e=>`
              <div style="border: 1px solid #DBDADE; border-radius: 8px; padding: 16px; text-align: center;">
                <i class="bi ${e.icon}" style="font-size: 32px; color: ${e.color}; margin-bottom: 8px;"></i>
                <div style="font-size: 24px; font-weight: 700; color: #5D596C; margin-bottom: 4px;">${e.value}</div>
                <div style="font-size: 12px; color: #6E6B7B;">${e.label}</div>
              </div>
            `).join("")}
          </div>
        </div>
    ...
    <div class="pdf-container">
      ...
      <div class="pdf-content-area">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: 16px;">
          ${["Ana Silva","Bruno Costa","Carlos Mendes","Daniela Souza","Eduardo Lima","Fernanda Oliveira"].map(e=>`
            <div style="border: 1px solid #DBDADE; border-radius: 12px; padding: 20px; text-align: center; background: linear-gradient(135deg, rgba(110,99,232,0.05), rgba(40,199,111,0.05));">
              ...
              <p style="margin: 0; font-size: 14px; color: #5D596C; font-weight: 600;">${e}</p>
  ...
  `},p={render:()=>(setTimeout(()=>{document.querySelectorAll(".header-button").forEach(i=>{i.disabled||i.addEventListener("click",V=>{const b=i.textContent.trim().split(`
`)[0].trim();alert(`Ação "${b}" executada!

Em produção, isso iniciaria o processo de ${b.toLowerCase()}.`)})});const e=document.querySelector(".header-back-button");e&&e.addEventListener("click",()=>{alert("Voltando para a listagem de relatórios...")})},100),`
      ${t}
      <style>
    ...
    `)};var u,v,m;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="pdf-container">
      <div class="header printOcult">
  ...
  \`
}`,...(m=(v=a.parameters)==null?void 0:v.docs)==null?void 0:m.source}}};var x,h,g;o.parameters={...o.parameters,docs:{...(x=o.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="pdf-container">
      <div class="header printOcult">
  ...
  \`
}`,...(g=(h=o.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};var f,y,E;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="pdf-container">
      <div class="header printOcult">
  ...
  \`
}`,...(E=(y=r.parameters)==null?void 0:y.docs)==null?void 0:E.source}}};var D,B,w;s.parameters={...s.parameters,docs:{...(D=s.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="pdf-container">
      <div class="header printOcult">
  ...
  \`
}`,...(w=(B=s.parameters)==null?void 0:B.docs)==null?void 0:w.source}}};var k,F,$;d.parameters={...d.parameters,docs:{...(k=d.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="pdf-container">
      <div class="header printOcult">
  ...
  \`
}`,...($=(F=d.parameters)==null?void 0:F.docs)==null?void 0:$.source}}};var C,z,S;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => \`
    \${componentStyles}
    <div class="pdf-container">
      <div class="header printOcult">
  ...
  \`
}`,...(S=(z=l.parameters)==null?void 0:z.docs)==null?void 0:S.source}}};var P,A,I;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
  parameters: {
    viewport: {
  ...
  \`
}`,...(I=(A=c.parameters)==null?void 0:A.docs)==null?void 0:I.source}}};var M,O,G;p.parameters={...p.parameters,docs:{...(M=p.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => {
    setTimeout(() => {
...
}`,...(G=(O=p.parameters)==null?void 0:O.docs)==null?void 0:G.source}}};const j=["Default","WithBackButton","AllActions","LoadingState","PerformanceReport","CertificatesPDF","MobileView375","Interactive"];export{r as AllActions,l as CertificatesPDF,a as Default,p as Interactive,s as LoadingState,c as MobileView375,d as PerformanceReport,o as WithBackButton,j as __namedExportsOrder,R as default};
