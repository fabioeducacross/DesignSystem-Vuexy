...
- Indicação visual de progresso
        `}}},argTypes:{vertical:{control:"boolean",description:"Orientação vertical",table:{defaultValue:{summary:!1}}},linear:{control:"boolean",description:"Navegação linear (sequencial)",table:{defaultValue:{summary:!0}}}}},N=({vertical:s=!1,linear:n=!0})=>`<div class="bs-stepper ${s?"bs-stepper-vertical":""}" id="stepper1" data-${n?"linear":""}>
...
3. No non-linear, clique direto nas etapas
        `}}},loaders:[async()=>typeof window<"u"?document.querySelector('link[href*="bs-stepper"]')?{bsStepperLoaded:!0}:new Promise((s,n)=>{const e=document.createElement("link");e.rel="stylesheet",e.href="/vuexy/vendors/libs/bs-stepper/bs-stepper.css",e.onload=()=>{if(window.Stepper)s({bsStepperLoaded:!0});else{const t=document.createElement("script");t.src="/vuexy/vendors/libs/bs-stepper/bs-stepper.js",t.onload=()=>{console.log("✅ BS Stepper CSS + JS carregados"),s({bsStepperLoaded:!0})},t.onerror=()=>n(new Error("Failed to load BS Stepper JS")),document.head.appendChild(t)}},e.onerror=()=>n(new Error("Failed to load BS Stepper CSS")),document.head.appendChild(e)}):{}],render:()=>(setTimeout(()=>{if(window.Stepper){const s=new Stepper(document.querySelector("#stepper-linear"),{linear:!0,animation:!0});document.getElementById("btn-next-1").addEventListener("click",function(){const e=document.getElementById("input-name").value,t=document.getElementById("input-email").value;if(!e||!t){alert("Preencha todos os campos obrigatórios!");return}s.next()}),document.getElementById("btn-next-2").addEventListener("click",function(){const e=document.getElementById("input-address").value,t=document.getElementById("input-city").value;if(!e||!t){alert("Preencha todos os campos obrigatórios!");return}s.next()}),document.getElementById("btn-submit").addEventListener("click",function(){const e=document.getElementById("input-name").value,t=document.getElementById("input-email").value,B=document.getElementById("input-address").value,I=document.getElementById("input-city").value;alert(`Cadastro completo!
