import{f as M,a as I}from"./snippets-m8t1HIl1.js";const B={title:"Vuexy/Molecules/Overlays/Tooltip",tags:["autodocs"],parameters:{docs:{description:{component:`
# Tooltip
...
[...tooltipTriggerList].map(el => new bootstrap.Tooltip(el));</code></pre>
  ...
  <\/script>
`,s=c.bind({});s.args={placement:"top",text:"Tooltip on top",trigger:"hover"};const i=c.bind({});i.args={placement:"right",text:"Tooltip on right",trigger:"hover"};const l=c.bind({});l.args={placement:"bottom",text:"Tooltip on bottom",trigger:"hover"};const r=c.bind({});r.args={placement:"left",text:"Tooltip on left",trigger:"hover"};const p=c.bind({});p.args={placement:"top",text:"Click tooltip",trigger:"click"};const a={parameters:{docs:{description:{story:`
...
3. Observe o posicionamento automático
    ...
    `)};var b,g,u;d.parameters={...d.parameters,docs:{...(b=d.parameters)==null?void 0:b.docs,source:{originalSource:`() => \`
  <div class="row g-4">
    <div class="col-12">
      <h5>Posicionamento</h5>
      <div class="d-flex justify-content-center align-items-center gap-3" style="padding: 100px 0;">
...
[...tooltipTriggerList].map(el => new bootstrap.Tooltip(el));</code></pre>
  ...
  <\/script>
\``,...(u=(g=d.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var m,v,y;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`args => {
...
const tooltipList = [...tooltipTriggerList].map(el => new bootstrap.Tooltip(el));</code></pre>
  ...
  \`;
}`,...(y=(v=s.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};var x,T,h;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`args => {
  const markup = createTooltip(args);
  return \`
    <div style="padding: 100px; text-align: center;">
      \${markup}
...
const tooltipList = [...tooltipTriggerList].map(el => new bootstrap.Tooltip(el));</code></pre>
  ...
  \`;
}`,...(h=(T=i.parameters)==null?void 0:T.docs)==null?void 0:h.source}}};var f,w,S;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`args => {
  const markup = createTooltip(args);
  return \`
    <div style="padding: 100px; text-align: center;">
      \${markup}
...
====================================`,...(J=(D=a.parameters)==null?void 0:D.docs)==null?void 0:J.description}}};const A=["Overview","Top","Right","Bottom","Left","OnClick","Interactive"];export{l as Bottom,a as Interactive,r as Left,p as OnClick,d as Overview,i as Right,s as Top,A as __namedExportsOrder,B as default};
