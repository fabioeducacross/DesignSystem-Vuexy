const O={title:"Educacross Components V2/Cards/MediaCard",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
<style>
...
**Última Atualização**: 2 de fevereiro de 2026
        `}}}},e=()=>{if(typeof window<"u"&&!document.getElementById("material-symbols")){const c=document.createElement("link");c.id="material-symbols",c.rel="stylesheet",c.href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200",document.head.appendChild(c)}},a=`
<style>
...
`,i={render:()=>(e(),`
    ...
    `)};var l,m,p,v,u;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: () => {
    loadMaterialIcons();
    return \`
      \${mediaCardStyles}
...
}`,...(p=(m=i.parameters)==null?void 0:m.docs)==null?void 0:p.source},description:{story:"Default - Card básico com ícone e valor",...(u=(v=i.parameters)==null?void 0:v.docs)==null?void 0:u.description}}};var b,g,h,f,y;s.parameters={...s.parameters,docs:{...(b=s.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: () => {
    loadMaterialIcons();
    return \`
      \${mediaCardStyles}
...
}`,...(h=(g=s.parameters)==null?void 0:g.docs)==null?void 0:h.source},description:{story:"AllVariants - Todas as variantes de cor com contextos reais",...(y=(f=s.parameters)==null?void 0:f.docs)==null?void 0:y.description}}};var x,C,k,A,w;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => {
    loadMaterialIcons();
    return \`
      \${mediaCardStyles}
...
}`,...(k=(C=d.parameters)==null?void 0:C.docs)==null?void 0:k.source},description:{story:"WithClickAction - Card clicável com ícone de visualização",...(w=(A=d.parameters)==null?void 0:A.docs)==null?void 0:w.description}}};var T,S,D,E,M;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => {
    loadMaterialIcons();
    return \`
      \${mediaCardStyles}
...
}`,...(D=(S=o.parameters)==null?void 0:S.docs)==null?void 0:D.source},description:{story:"WithTooltip - Card com ícone de informação e tooltip explicativo",...(M=(E=o.parameters)==null?void 0:E.docs)==null?void 0:M.description}}};var I,z,P,V,B;r.parameters={...r.parameters,docs:{...(I=r.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: () => {
    loadMaterialIcons();
    return \`
      \${mediaCardStyles}
...
}`,...(P=(z=r.parameters)==null?void 0:z.docs)==null?void 0:P.source},description:{story:"WithBorderHighlight - Card com borda colorida para destaque",...(B=(V=r.parameters)==null?void 0:V.docs)==null?void 0:B.description}}};var $,L,N,W,R;n.parameters={...n.parameters,docs:{...($=n.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => {
    return \`
      \${mediaCardStyles}
      <div class="p-4" style="max-width: 350px;">
...
}`,...(N=(L=n.parameters)==null?void 0:L.docs)==null?void 0:N.source},description:{story:"LoadingSkeleton - Estado de carregamento",...(R=(W=n.parameters)==null?void 0:W.docs)==null?void 0:R.description}}};var F,q,_,U,G;t.parameters={...t.parameters,docs:{...(F=t.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => {
    loadMaterialIcons();
    return \`
      \${mediaCardStyles}
...
}`,...(_=(q=t.parameters)==null?void 0:q.docs)==null?void 0:_.source},description:{story:"DashboardExample - Exemplo completo de dashboard de professor",...(G=(U=t.parameters)==null?void 0:U.docs)==null?void 0:G.description}}};const j=["Default","AllVariants","WithClickAction","WithTooltip","WithBorderHighlight","LoadingSkeleton","DashboardExample"];export{s as AllVariants,t as DashboardExample,i as Default,n as LoadingSkeleton,r as WithBorderHighlight,d as WithClickAction,o as WithTooltip,j as __namedExportsOrder,O as default};
