const I={title:"Foundations/Spacing",parameters:{previewTabs:{canvas:{hidden:!1}}}},B=[{name:"0",value:"0",rem:"0rem",px:"0px"},{name:"1",value:"0.25rem",rem:"0.25rem",px:"4px"},{name:"2",value:"0.5rem",rem:"0.5rem",px:"8px"},{name:"3",value:"1rem",rem:"1rem",px:"16px"},{name:"4",value:"1.5rem",rem:"1.5rem",px:"24px"},{name:"5",value:"3rem",rem:"3rem",px:"48px"}],d={render:()=>`
