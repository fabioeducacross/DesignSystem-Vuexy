const G={title:"Educacross Components V2/Navigation/NewDeepLink",tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
# NewDeepLink
...
`,n={render:()=>`
  ...
  `},l={render:()=>(setTimeout(()=>{document.querySelectorAll(".deeplink-option").forEach((M,c)=>{M.addEventListener("click",()=>{alert(`Deep link selecionado: ${["Aluno","Professor","Administrador"][c]||"Opção "+(c+1)}
...
Navegando...`)})})},100),`
    ...
    `)};var r,p,v;n.parameters={...n.parameters,docs:{...(r=n.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: () => \`
    \${newDeepLinkStyles}
    <div class="deeplink-card">
      <svg class="brand-logo" viewBox="0 0 200 60" xmlns="http://www.w3.org/2000/svg">
  ...
  \`
}`,...(v=(p=n.parameters)==null?void 0:p.docs)==null?void 0:v.source}}};var g,x,u;e.parameters={...e.parameters,docs:{...(g=e.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => \`
    \${newDeepLinkStyles}
    <div class="deeplink-card">
      <svg class="brand-logo" viewBox="0 0 200 60" xmlns="http://www.w3.org/2000/svg">
  ...
  \`
}`,...(u=(x=e.parameters)==null?void 0:x.docs)==null?void 0:u.source}}};var k,m,f;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => \`
    \${newDeepLinkStyles}
    <div class="deeplink-card">
      <div class="deeplink-options">
  ...
  \`
}`,...(f=(m=s.parameters)==null?void 0:m.docs)==null?void 0:f.source}}};var h,b,w;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => \`
    \${newDeepLinkStyles}
    <div class="deeplink-card">
      <div class="deeplink-options">
  ...
  \`
}`,...(w=(b=o.parameters)==null?void 0:b.docs)==null?void 0:w.source}}};var y,E,D;t.parameters={...t.parameters,docs:{...(y=t.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => \`
    \${newDeepLinkStyles}
    <div class="deeplink-card">
      <h2 style="font-size: 22px; color: #5D596C; margin-bottom: 24px;">
  ...
  \`
}`,...(D=(E=t.parameters)==null?void 0:E.docs)==null?void 0:D.source}}};var z,C,F;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => \`
    \${newDeepLinkStyles}
    <div style="max-width: 375px; margin: 0 auto;">
      <div class="deeplink-card" style="padding: 24px;">
  ...
  \`
}`,...(F=(C=d.parameters)==null?void 0:C.docs)==null?void 0:F.source}}};var A,B,S;a.parameters={...a.parameters,docs:{...(A=a.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => \`
    \${newDeepLinkStyles}
    <div class="deeplink-card" style="background: linear-gradient(180deg, #F8F7FA 0%, #FFFFFF 100%);">
      <div style="text-align: center; margin-bottom: 32px;">
  ...
  \`
}`,...(S=(B=a.parameters)==null?void 0:B.docs)==null?void 0:S.source}}};var P,L,$;l.parameters={...l.parameters,docs:{...(P=l.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => {
    setTimeout(() => {
...
}`,...($=(L=l.parameters)==null?void 0:L.docs)==null?void 0:$.source}}};const R=["Default","WithMultipleOptions","StudentContext","TeacherContext","GameContext","MobileView","WithBranding","Interactive"];export{n as Default,t as GameContext,l as Interactive,d as MobileView,s as StudentContext,o as TeacherContext,a as WithBranding,e as WithMultipleOptions,R as __namedExportsOrder,G as default};
