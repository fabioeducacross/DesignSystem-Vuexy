const V={title:"Educacross Components V2/Missions/MissionBookDetails",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`MissionBookDetails - Detalhes de Livro/Conteúdo de Missão
===========================================================
...
`,s={render:()=>o(`
      ...
      <div class="book-body">
        ...
        <div class="book-section">
          ...
          <div class="chapter-list">
            ${[{title:"Capítulo 1 • Conhecendo o Cerrado",tags:["Podcast introdutório","Mapa mental"],progress:100},{title:"Capítulo 2 • Fauna e flora",tags:["Laboratório virtual","Glossário colaborativo"],progress:82},{title:"Capítulo 3 • Comunidades tradicionais",tags:["Entrevista guiada","Registro fotográfico"],progress:65}].map(a=>`
              <div class="chapter-item">
                <div style="font-weight:600;color:#2F2B3D">${a.title}</div>
                <div class="chapter-meta">
                  ${a.tags.map(S=>`<span>${S}</span>`).join("")}
                </div>
                <div class="chapter-progress"><span style="width:${a.progress}%"></span></div>
              </div>
            `).join("")}
          </div>
        </div>
  ...
  `)},i={render:()=>o(`
    <div class="book-card">
      ...
      <div class="book-body">
        <div class="chapter-list">
          ${[{number:"Cap. 1",title:"Terra: nosso ponto de partida",detail:"Observação guiada e quiz diagnóstico",status:"Concluído"},{number:"Cap. 2",title:"Planetas rochosos",detail:"Modelagem 3D e produção de podcasts",status:"Em andamento"},{number:"Cap. 3",title:"Gigantes gasosos",detail:"Análise de dados da NASA e infográfico colaborativo",status:"Agendado"}].map(a=>`
            <div class="chapter-item" style="background:#F1FCFF;border-color:#CDECF7">
              <div style="display:flex;justify-content:space-between;align-items:center">
                <div style="display:flex;align-items:center;gap:12px">
                  <span class="resource-chip" style="background:#E0F7FA;color:#0D4E75">${a.number}</span>
                  <div style="font-weight:600;color:#0C4A6E">${a.title}</div>
                </div>
                <span class="resource-chip" style="background:#E0F2FE;color:#0C4A6E">${a.status}</span>
              </div>
              <div class="section-text" style="color:#0C4A6E">${a.detail}</div>
            </div>
          `).join("")}
        </div>
      </div>
      ...
      <div class="book-body">
        <div class="book-section">
          ...
          <div class="activity-grid">
            ${[{name:"Receita em família",xp:"+150 XP",entrega:"Upload de vídeo até 12/02"},{name:"Linha do tempo histórica",xp:"+90 XP",entrega:"Quadro colaborativo"},{name:"Podcast com entrevistas",xp:"+120 XP",entrega:"Aplicativo mobile"},{name:"Caderno de campo ilustrado",xp:"+80 XP",entrega:"Fotos e relatos"}].map(a=>`
              <div class="activity-card">
                <strong>${a.name}</strong>
                <div class="section-text" style="font-size:12px">${a.entrega}</div>
                <div class="activity-meta">
                  <span class="resource-chip" style="background:#FFE8CC;color:#A43E00">${a.xp}</span>
    ...
    <div class="book-card">
      ...
      <div class="book-body">
        <div class="book-section">
          ...
          <div class="activity-grid">
            ${[{grupo:"Coletivo Vozes",foco:"Poetas contemporâneos",encontro:"Quartas às 14h"},{grupo:"Ritmo da Cidade",foco:"Slam e poesia falada",encontro:"Segundas às 16h"},{grupo:"Verso & Metrô",foco:"Lirismo e memória",encontro:"Sextas às 10h"}].map(a=>`
              <div class="activity-card" style="background:#F3F2FF;border-color:#D7D4FF">
                <strong>${a.grupo}</strong>
                <div class="section-text">${a.foco}</div>
                <div class="activity-meta">
                  <span><i class="bi bi-calendar-event"></i> ${a.encontro}</span>
        ...
        <div class="book-section">
          ...
          <div class="notes-grid">
            ${["Quais imagens da cidade aparecem nos poemas e como dialogam com a realidade dos estudantes?","Como a voz poética se manifesta em diferentes estilos? Comparar com produções dos estudantes.","Que conexões podem ser feitas entre poesia urbana e movimentos sociais atuais?"].map(a=>`
              <div class="note-item">
                <div class="note-icon"><i class="bi bi-lightbulb"></i></div>
                <div class="note-text">${a}</div>
              </div>
            `).join("")}
          </div>
        </div>
  ...
  `)},t={render:()=>o(`
    <div class="book-card">
      ...
      <div class="book-body">
        <div class="timeline">
          ${[{etapa:"Leitura orientada",detalhe:"Capítulos 1 e 2 com foco em sistemas agroflorestais",data:"Semana 1",status:"Concluído"},{etapa:"Visita técnica",detalhe:"Registro de diário de campo e entrevistas",data:"Semana 2",status:"Em andamento"},{etapa:"Produção de cartilha",detalhe:"Equipe define layout e recursos multimídia",data:"Semana 3",status:"Planejado"}].map(a=>`
            <div class="timeline-row">
              <span class="timeline-dot" style="background:${a.status==="Concluído"?"#28C76F":a.status==="Em andamento"?"#6E63E8":"#FF9F43"}"></span>
              <div>
                <div style="font-weight:600;color:#2F2B3D">${a.etapa}</div>
                <div style="font-size:12px;color:#6E6B7B">${a.detalhe}</div>
              </div>
    ...
    <div class="book-card">
      ...
      <div class="book-body">
        <div class="book-section">
          ...
          <div class="chapter-list">
            ${[{item:"Aplicar sondagem diagnóstica antes do Cap. 1",status:"Concluído",obs:"Dados registrados no painel da turma"},{item:"Reservar laboratório para experiência do Cap. 3",status:"Em andamento",obs:"Solicitação enviada à coordenação"},{item:"Disponibilizar rubrica de avaliação no app",status:"Pendente",obs:"Criar modelo para feedback em vídeo"}].map(a=>`
              <div class="chapter-item" style="background:#F8F7FD">
                <div style="font-weight:600;color:#2F2B3D">${a.item}</div>
                <div class="section-text" style="font-size:12px;color:#6E6B7B">${a.obs}</div>
                <div class="resource-chip" style="width:max-content;background:${a.status==="Concluído"?"#E3FCEC":"#E0E7FF"};color:${a.status==="Concluído"?"#1F9D55":"#3F3F8F"}">${a.status}</div>
              </div>
            `).join("")}
          </div>
        </div>
    ...
    <div class="book-card" style="max-width:540px;margin:0 auto">
      ...
      <div class="book-body" style="padding:20px">
        <div class="compact-list">
          ${[{title:"Cap. 1 • Viagem inaugural",entrega:"Áudio reflexivo",status:"Concluído"},{title:"Cap. 2 • Obstáculos e aprendizados",entrega:"Texto breve",status:"Em andamento"},{title:"Cap. 3 • Projeção de futuro",entrega:"Infográfico",status:"Agendado"}].map(a=>`
            <div class="compact-item">
              <div>
                <strong>${a.title}</strong>
                <div style="font-size:11px;color:#6E6B7B">${a.entrega}</div>
              </div>
              <span class="resource-chip" style="background:${a.status==="Concluído"?"#E3FCEC":"#F1F0F7"};color:${a.status==="Concluído"?"#1F9D55":"#6E63E8"}">${a.status}</span>
            </div>
          `).join("")}
        </div>
      </div>
  ...
  `)};var l,p,v;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: () => wrap(\`
    <div class="book-card">
      <div class="book-header">
        <div class="book-cover">
      ...
      <div class="book-body">
        ...
        <div class="book-section">
          ...
          <div class="chapter-list">
            \${[{
    title: 'Capítulo 1 • Conhecendo o Cerrado',
    tags: ['Podcast introdutório', 'Mapa mental'],
    progress: 100
  }, {
    title: 'Capítulo 2 • Fauna e flora',
    tags: ['Laboratório virtual', 'Glossário colaborativo'],
    progress: 82
  }, {
    title: 'Capítulo 3 • Comunidades tradicionais',
    tags: ['Entrevista guiada', 'Registro fotográfico'],
    progress: 65
  }].map(cap => \`
              <div class="chapter-item">
  ...
  \`)
}`,...(v=(p=s.parameters)==null?void 0:p.docs)==null?void 0:v.source}}};var u,m,g;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => wrap(\`
    <div class="book-card">
      <div class="book-header" style="background:linear-gradient(135deg,#00CFE8,#2F8DEE)">
        <div class="book-cover">
      ...
      <div class="book-body">
        <div class="chapter-list">
          \${[{
    number: 'Cap. 1',
    title: 'Terra: nosso ponto de partida',
    detail: 'Observação guiada e quiz diagnóstico',
    status: 'Concluído'
  }, {
    number: 'Cap. 2',
    title: 'Planetas rochosos',
    detail: 'Modelagem 3D e produção de podcasts',
    status: 'Em andamento'
  }, {
    number: 'Cap. 3',
    title: 'Gigantes gasosos',
    detail: 'Análise de dados da NASA e infográfico colaborativo',
    status: 'Agendado'
  }].map(chapter => \`
            <div class="chapter-item" style="background:#F1FCFF;border-color:#CDECF7">
              <div style="display:flex;justify-content:space-between;align-items:center">
  ...
  \`)
}`,...(g=(m=i.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};var x,b,E;e.parameters={...e.parameters,docs:{...(x=e.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => wrap(\`
    <div class="book-card">
      <div class="book-header" style="background:linear-gradient(135deg,#FF9F43,#F76B1C)">
        <div class="book-cover">
      ...
      <div class="book-body">
        <div class="book-section">
          ...
          <div class="activity-grid">
            \${[{
    name: 'Receita em família',
    xp: '+150 XP',
    entrega: 'Upload de vídeo até 12/02'
  }, {
    name: 'Linha do tempo histórica',
    xp: '+90 XP',
    entrega: 'Quadro colaborativo'
  }, {
    name: 'Podcast com entrevistas',
    xp: '+120 XP',
    entrega: 'Aplicativo mobile'
  }, {
    name: 'Caderno de campo ilustrado',
    xp: '+80 XP',
    entrega: 'Fotos e relatos'
  }].map(act => \`
              <div class="activity-card">
  ...
  \`)
}`,...(E=(b=e.parameters)==null?void 0:b.docs)==null?void 0:E.source}}};var f,h,k;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => wrap(\`
    <div class="book-card">
      <div class="book-header" style="background:linear-gradient(135deg,#2F8DEE,#7847FB)">
        <div class="book-cover">
      ...
      <div class="book-body">
        <div class="book-section">
          ...
          <div class="activity-grid">
            \${[{
    grupo: 'Coletivo Vozes',
    foco: 'Poetas contemporâneos',
    encontro: 'Quartas às 14h'
  }, {
    grupo: 'Ritmo da Cidade',
    foco: 'Slam e poesia falada',
    encontro: 'Segundas às 16h'
  }, {
    grupo: 'Verso & Metrô',
    foco: 'Lirismo e memória',
    encontro: 'Sextas às 10h'
  }].map(group => \`
              <div class="activity-card" style="background:#F3F2FF;border-color:#D7D4FF">
        ...
        <div class="book-section">
          <div class="section-heading"><i class="bi bi-chat-square-text"></i> Perguntas disparadoras</div>
          <div class="notes-grid">
            \${['Quais imagens da cidade aparecem nos poemas e como dialogam com a realidade dos estudantes?', 'Como a voz poética se manifesta em diferentes estilos? Comparar com produções dos estudantes.', 'Que conexões podem ser feitas entre poesia urbana e movimentos sociais atuais?'].map(note => \`
              <div class="note-item">
                <div class="note-icon"><i class="bi bi-lightbulb"></i></div>
  ...
  \`)
}`,...(k=(h=n.parameters)==null?void 0:h.docs)==null?void 0:k.source}}};var F,y,C;t.parameters={...t.parameters,docs:{...(F=t.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => wrap(\`
    <div class="book-card">
      <div class="book-header" style="background:linear-gradient(135deg,#28C76F,#19A463)">
        <div class="book-cover">
      ...
      <div class="book-body">
        <div class="timeline">
          \${[{
    etapa: 'Leitura orientada',
    detalhe: 'Capítulos 1 e 2 com foco em sistemas agroflorestais',
    data: 'Semana 1',
    status: 'Concluído'
  }, {
    etapa: 'Visita técnica',
    detalhe: 'Registro de diário de campo e entrevistas',
    data: 'Semana 2',
    status: 'Em andamento'
  }, {
    etapa: 'Produção de cartilha',
    detalhe: 'Equipe define layout e recursos multimídia',
    data: 'Semana 3',
    status: 'Planejado'
  }].map(line => \`
            <div class="timeline-row">
  ...
  \`)
}`,...(C=(y=t.parameters)==null?void 0:y.docs)==null?void 0:C.source}}};var D,A,$;d.parameters={...d.parameters,docs:{...(D=d.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => wrap(\`
    <div class="book-card">
      <div class="book-header" style="background:linear-gradient(135deg,#3F3F8F,#171742)">
        <div class="book-cover">
      ...
      <div class="book-body">
        <div class="book-section">
          ...
          <div class="chapter-list">
            \${[{
    item: 'Aplicar sondagem diagnóstica antes do Cap. 1',
    status: 'Concluído',
    obs: 'Dados registrados no painel da turma'
  }, {
    item: 'Reservar laboratório para experiência do Cap. 3',
    status: 'Em andamento',
    obs: 'Solicitação enviada à coordenação'
  }, {
    item: 'Disponibilizar rubrica de avaliação no app',
    status: 'Pendente',
    obs: 'Criar modelo para feedback em vídeo'
  }].map(check => \`
              <div class="chapter-item" style="background:#F8F7FD">
  ...
  \`)
}`,...($=(A=d.parameters)==null?void 0:A.docs)==null?void 0:$.source}}};var w,z,B;r.parameters={...r.parameters,docs:{...(w=r.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => wrap(\`
    <div class="book-card" style="max-width:540px;margin:0 auto">
      <div class="book-header" style="padding:20px">
        <div class="book-info" style="gap:8px">
      ...
      <div class="book-body" style="padding:20px">
        <div class="compact-list">
          \${[{
    title: 'Cap. 1 • Viagem inaugural',
    entrega: 'Áudio reflexivo',
    status: 'Concluído'
  }, {
    title: 'Cap. 2 • Obstáculos e aprendizados',
    entrega: 'Texto breve',
    status: 'Em andamento'
  }, {
    title: 'Cap. 3 • Projeção de futuro',
    entrega: 'Infográfico',
    status: 'Agendado'
  }].map(item => \`
            <div class="compact-item">
  ...
  \`)
}`,...(B=(z=r.parameters)==null?void 0:z.docs)==null?void 0:B.source}}};var P,j,M;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => wrap(\`
    <div class="empty-state">
      <svg viewBox="0 0 32 32" fill="currentColor">
        <path d="M7 5h18a2 2 0 0 1 2 2v18l-6-3-6 3-6-3-6 3V7a2 2 0 0 1 2-2z"/>
  ...
  \`)
}`,...(M=(j=c.parameters)==null?void 0:j.docs)==null?void 0:M.source}}};const q=["Default","SequenciaCapitulos","AtividadesComplementares","LeiturasGuiadas","LinhaDoTempo","ChecklistProfessor","Compacto","Vazio"];export{e as AtividadesComplementares,d as ChecklistProfessor,r as Compacto,s as Default,n as LeiturasGuiadas,t as LinhaDoTempo,i as SequenciaCapitulos,c as Vazio,q as __namedExportsOrder,V as default};
