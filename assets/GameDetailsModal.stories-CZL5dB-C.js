const q={title:"Educacross Components V2/Modals/GameDetailsModal",tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:`GameDetailsModal - Modal de Detalhes de Jogo/Gamificação
========================================================
...
`,i={render:()=>s(`
    ...
    <div class="modal-body">
      <div class="section">
        ...
        <div class="stats-grid">
          ${[{label:"Pontuação média",value:"912 XP",percent:72},{label:"Concluíram missão",value:"27 / 32",percent:84},{label:"Tempo médio",value:"18min",percent:58}].map(a=>`
            <div class="stat-card">
              <div class="stat-label">${a.label}</div>
              <div class="stat-value">${a.value}</div>
              <div class="progress-bar"><span style="width:${a.percent}%"></span></div>
            </div>
          `).join("")}
        </div>
      </div>
      <div class="section">
        ...
        <div class="list">
          ${[{name:"Equipe Astros - 8º Ano A",detail:"1º lugar • 1280 XP acumulados"},{name:"Equipe Orbitas - 8º Ano B",detail:"Missão concluída com todas as evidências"}].map(a=>`
            <div class="list-item">
              <div class="list-info">
                <strong>${a.name}</strong>
                <span style="font-size:12px;color:#6E6B7B">${a.detail}</span>
              </div>
  ...
  `)},o={render:()=>s(`
    ...
    <div class="modal-body">
      <table class="table">
        ...
        <tbody>
          ${[{pos:1,name:"Ana Silva",class:"8º A",xp:"1480 XP",badge:'<span class="badge badge-gold"><i class="bi bi-trophy"></i> Lendária</span>'},{pos:2,name:"Bruno Costa",class:"8º B",xp:"1395 XP",badge:'<span class="badge badge-silver"><i class="bi bi-award"></i> Épica</span>'},{pos:3,name:"Diana Santos",class:"8º A",xp:"1310 XP",badge:'<span class="badge badge-bronze"><i class="bi bi-gem"></i> Rara</span>'},{pos:4,name:"Eduardo Lima",class:"8º B",xp:"1205 XP",badge:'<span class="badge badge-info"><i class="bi bi-lightning"></i> Mentor</span>'}].map(a=>`
            <tr>
              <td>${a.pos}</td>
              <td>${a.name}</td>
              <td>${a.class}</td>
    ...
    <div class="modal-body">
      <div class="section">
        ...
        <div class="toggle-list">
          ${[{title:"Introdução ao tabuleiro digital",desc:"Vídeo tutorial com explicação do jogo",on:!0},{title:"Missão colaborativa",desc:"Equipes com 4 alunos para resolver desafios",on:!0},{title:"Desafio bônus relâmpago",desc:"Questões extras valendo XP dobrado",on:!1}].map(a=>`
      ...
      <div class="section">
        ...
        <div class="list">
          ${[{name:"8º Ano A",detail:"32 alunos • segunda-feira às 10h"},{name:"8º Ano B",detail:"29 alunos • terça-feira às 14h"}].map(a=>`
            <div class="list-item">
              <div class="list-info">
                <strong>${a.name}</strong>
                <span style="font-size:12px;color:#6E6B7B">${a.detail}</span>
  ...
  `)},e={render:()=>s(`
    ...
    <div class="modal-body">
      <div class="section">
        ...
        <div class="stats-grid">
          ${[{label:"Guardião Lendário",value:"Requer 2000 XP",color:"#FFD700"},{label:"Mentor da Turma",value:"Apoia 3 colegas",color:"#6E63E8"},{label:"Velocista",value:"Conclui em < 5 min",color:"#00CFE8"}].map(a=>`
            <div class="stat-card" style="border-color:${a.color}33;background:#fff">
              <div class="stat-label" style="color:${a.color}">${a.label}</div>
              <div class="stat-value" style="font-size:16px;color:#3F3F46">${a.value}</div>
            </div>
          `).join("")}
        </div>
      </div>
      <div class="section">
        ...
        <div class="list">
          ${[{name:"Passe VIP Maker",detail:"Acesso extra à sala maker por 1 semana"},{name:"Cartas de poder",detail:"Itens especiais para próxima rodada"}].map(a=>`
            <div class="list-item">
              <div class="list-info">
                <strong>${a.name}</strong>
                <span style="font-size:12px;color:#6E6B7B">${a.detail}</span>
    ...
    <div class="modal-body">
      <div class="section">
        ...
        <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:12px;align-items:end;height:140px;background:linear-gradient(180deg,#F8F7FD 0%,#fff 70%);padding:16px;border:1px solid #E5E3F3;border-radius:12px">
          ${[480,620,710,780,820,910].map(a=>`
            <div style="background:linear-gradient(180deg,#6E63E8,#00CFE8);height:${a/11}px;border-radius:8px;position:relative">
              <span style="position:absolute;bottom:100%;left:50%;transform:translate(-50%, -6px);font-size:11px;color:#3F3F46">${a}</span>
            </div>
          `).join("")}
        </div>
      </div>
      <div class="section">
        ...
        <div class="stats-grid">
          ${[{label:"Interações por aluno",value:"9.4",percent:82},{label:"Feedback respondido",value:"94%",percent:94},{label:"Uso mobile",value:"68%",percent:68}].map(a=>`
            <div class="stat-card">
              <div class="stat-label">${a.label}</div>
              <div class="stat-value">${a.value}</div>
              <div class="progress-bar"><span style="width:${a.percent}%"></span></div>
  ...
  `)},t={render:()=>s(`
    ...
    <div class="modal-body">
      <div class="toggle-list">
        ${[{name:"Ativar modo colaborativo",detail:"Times com até 5 alunos por rodada",on:!0},{name:"Permitir dicas automáticas",detail:"Libera 1 dica após 2 tentativas sem sucesso",on:!0},{name:"Bloquear respostas repetidas",detail:"Evita spam de tentativas idênticas",on:!0},{name:"Ranking público",detail:"Exibe ranking para alunos em tempo real",on:!1}].map(a=>`
          <div class="toggle-row">
            <div>
              <span>${a.name}</span>
  ...
  `)},l={render:()=>s(`
    ...
    <div class="modal-body">
      <div class="stats-grid">
        ${[{label:"Equipes",value:"8"},{label:"Rodadas",value:"6"},{label:"XP médio",value:"840"}].map(a=>`
          <div class="stat-card">
            <div class="stat-label">${a.label}</div>
            <div class="stat-value">${a.value}</div>
          </div>
  ...
  `)};var c,p,v;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => wrapModal(\`
    <div class="modal-header">
      <div class="modal-heading">
        <div class="modal-title">Game Center • Frações Intergalácticas</div>
    ...
    percent: 58
      ...
      <div class="section">
        ...
        <div class="list">
          \${[{
    name: 'Equipe Astros - 8º Ano A',
    detail: '1º lugar • 1280 XP acumulados'
  }, {
    name: 'Equipe Orbitas - 8º Ano B',
    detail: 'Missão concluída com todas as evidências'
  }].map(item => \`
            <div class="list-item">
              <div class="list-info">
  ...
  \`)
}`,...(v=(p=i.parameters)==null?void 0:p.docs)==null?void 0:v.source}}};var m,b,u;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => wrapModal(\`
    <div class="modal-header">
      <div class="modal-heading">
        <div class="modal-title">Ranking por turma • Rodada 5</div>
    ...
    class: '8º A',
    xp: '1480 XP',
    badge: '<span class="badge badge-gold"><i class="bi bi-trophy"></i> Lendária</span>'
  }, {
    pos: 2,
    name: 'Bruno Costa',
    class: '8º B',
    xp: '1395 XP',
    badge: '<span class="badge badge-silver"><i class="bi bi-award"></i> Épica</span>'
  }, {
    pos: 3,
    name: 'Diana Santos',
    class: '8º A',
    xp: '1310 XP',
    badge: '<span class="badge badge-bronze"><i class="bi bi-gem"></i> Rara</span>'
  }, {
    pos: 4,
    name: 'Eduardo Lima',
    class: '8º B',
    xp: '1205 XP',
    badge: '<span class="badge badge-info"><i class="bi bi-lightning"></i> Mentor</span>'
  }].map(row => \`
            <tr>
              <td>\${row.pos}</td>
              <td>\${row.name}</td>
  ...
  \`)
}`,...(u=(b=o.parameters)==null?void 0:b.docs)==null?void 0:u.source}}};var g,x,h;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => wrapModal(\`
    <div class="modal-header">
      <div class="modal-heading">
        <div class="modal-title">Planejamento da missão gamificada</div>
    ...
    <div class="modal-body">
      <div class="section">
        ...
        <div class="toggle-list">
          \${[{
    title: 'Introdução ao tabuleiro digital',
    desc: 'Vídeo tutorial com explicação do jogo',
    on: true
  }, {
    title: 'Missão colaborativa',
    desc: 'Equipes com 4 alunos para resolver desafios',
    on: true
  }, {
    title: 'Desafio bônus relâmpago',
    desc: 'Questões extras valendo XP dobrado',
    on: false
  }].map(step => \`
            <div class="toggle-row">
              <div>
      ...
      <div class="section">
        ...
        <div class="list">
          \${[{
    name: '8º Ano A',
    detail: '32 alunos • segunda-feira às 10h'
  }, {
    name: '8º Ano B',
    detail: '29 alunos • terça-feira às 14h'
  }].map(turma => \`
            <div class="list-item">
              <div class="list-info">
  ...
  \`)
}`,...(h=(x=n.parameters)==null?void 0:x.docs)==null?void 0:h.source}}};var f,E,y;e.parameters={...e.parameters,docs:{...(f=e.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => wrapModal(\`
    <div class="modal-header">
      <div class="modal-heading">
        <div class="modal-title">Recompensas e badges</div>
    ...
    <div class="modal-body">
      <div class="section">
        ...
        <div class="stats-grid">
          \${[{
    label: 'Guardião Lendário',
    value: 'Requer 2000 XP',
    color: '#FFD700'
  }, {
    label: 'Mentor da Turma',
    value: 'Apoia 3 colegas',
    color: '#6E63E8'
  }, {
    label: 'Velocista',
    value: 'Conclui em < 5 min',
    color: '#00CFE8'
  }].map(badge => \`
      ...
      <div class="section">
        ...
        <div class="list">
          \${[{
    name: 'Passe VIP Maker',
    detail: 'Acesso extra à sala maker por 1 semana'
  }, {
    name: 'Cartas de poder',
    detail: 'Itens especiais para próxima rodada'
  }].map(reward => \`
            <div class="list-item">
              <div class="list-info">
  ...
  \`)
}`,...(y=(E=e.parameters)==null?void 0:E.docs)==null?void 0:y.source}}};var F,w,$;d.parameters={...d.parameters,docs:{...(F=d.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => wrapModal(\`
    <div class="modal-header">
      <div class="modal-heading">
        <div class="modal-title">Análises avançadas</div>
  ...
  \`)
}`,...($=(w=d.parameters)==null?void 0:w.docs)==null?void 0:$.source}}};var k,A,j;t.parameters={...t.parameters,docs:{...(k=t.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => wrapModal(\`
    <div class="modal-header">
      <div class="modal-heading">
        <div class="modal-title">Configurações avançadas do jogo</div>
    ...
    <div class="modal-body">
      <div class="toggle-list">
        \${[{
    name: 'Ativar modo colaborativo',
    detail: 'Times com até 5 alunos por rodada',
    on: true
  }, {
    name: 'Permitir dicas automáticas',
    detail: 'Libera 1 dica após 2 tentativas sem sucesso',
    on: true
  }, {
    name: 'Bloquear respostas repetidas',
    detail: 'Evita spam de tentativas idênticas',
    on: true
  }, {
    name: 'Ranking público',
    detail: 'Exibe ranking para alunos em tempo real',
    on: false
  }].map(opt => \`
          <div class="toggle-row">
            <div>
  ...
  \`)
}`,...(j=(A=t.parameters)==null?void 0:A.docs)==null?void 0:j.source}}};var B,P,z;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => wrapModal(\`
    <div class="modal-header">
      <div class="modal-heading">
        <div class="modal-title">Resumo rápido do jogo</div>
  ...
  \`, 'compact')
}`,...(z=(P=l.parameters)==null?void 0:P.docs)==null?void 0:z.source}}};var D,C,M;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => wrapModal(\`
    <div class="modal-body" style="padding:48px 32px">
      <div class="empty">
        <svg viewBox="0 0 24 24" fill="currentColor">
  ...
  \`)
}`,...(M=(C=r.parameters)==null?void 0:C.docs)==null?void 0:M.source}}};const S=["Default","RankingTurma","PlanejamentoMissao","Recompensas","Estatisticas","Configuracao","Compacto","Vazio"];export{l as Compacto,t as Configuracao,i as Default,d as Estatisticas,n as PlanejamentoMissao,o as RankingTurma,e as Recompensas,r as Vazio,S as __namedExportsOrder,q as default};
