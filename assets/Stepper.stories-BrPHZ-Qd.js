import{f as L}from"./snippets-m8t1HIl1.js";const R={title:"Molecules/Navigation/Stepper",tags:["autodocs"],parameters:{docs:{description:{component:`
# Stepper
...
- Indicação visual de progresso
        `}}},argTypes:{vertical:{control:"boolean",description:"Orientação vertical",table:{defaultValue:{summary:!1}}},linear:{control:"boolean",description:"Navegação linear (sequencial)",table:{defaultValue:{summary:!0}}}}},N=({vertical:e=!1,linear:n=!0})=>`<div class="bs-stepper ${e?"bs-stepper-vertical":""}" id="stepper1" data-${n?"linear":""}>
...
3. No non-linear, clique direto nas etapas
        `}}},loaders:[async()=>typeof window<"u"?document.querySelector('link[href*="bs-stepper"]')?{bsStepperLoaded:!0}:new Promise((e,n)=>{const s=document.createElement("link");s.rel="stylesheet",s.href="/vuexy/vendors/libs/bs-stepper/bs-stepper.css",s.onload=()=>{if(window.Stepper)e({bsStepperLoaded:!0});else{const t=document.createElement("script");t.src="/vuexy/vendors/libs/bs-stepper/bs-stepper.js",t.onload=()=>{console.log("✅ BS Stepper CSS + JS carregados"),e({bsStepperLoaded:!0})},t.onerror=()=>n(new Error("Failed to load BS Stepper JS")),document.head.appendChild(t)}},s.onerror=()=>n(new Error("Failed to load BS Stepper CSS")),document.head.appendChild(s)}):{}],render:()=>(setTimeout(()=>{if(window.Stepper){const e=new Stepper(document.querySelector("#stepper-linear"),{linear:!0,animation:!0});document.getElementById("btn-next-1").addEventListener("click",function(){const s=document.getElementById("input-name").value,t=document.getElementById("input-email").value;if(!s||!t){alert("Preencha todos os campos obrigatórios!");return}e.next()}),document.getElementById("btn-next-2").addEventListener("click",function(){const s=document.getElementById("input-address").value,t=document.getElementById("input-city").value;if(!s||!t){alert("Preencha todos os campos obrigatórios!");return}e.next()}),document.getElementById("btn-submit").addEventListener("click",function(){const s=document.getElementById("input-name").value,t=document.getElementById("input-email").value,B=document.getElementById("input-address").value,I=document.getElementById("input-city").value;alert(`Cadastro completo!

Nome: `+s+`
Email: `+t+`
Endereço: `+B+`
Cidade: `+I)}),document.getElementById("btn-prev-2").addEventListener("click",()=>e.previous()),document.getElementById("btn-prev-3").addEventListener("click",()=>e.previous());const n=new Stepper(document.querySelector("#stepper-nonlinear"),{linear:!1,animation:!0});document.querySelectorAll(".btn-next-nl").forEach(s=>{s.addEventListener("click",()=>n.next())}),document.querySelectorAll(".btn-prev-nl").forEach(s=>{s.addEventListener("click",()=>n.previous())}),console.log("BS Stepper: 2 instancias inicializadas")}},100),`
      <style>
        .bs-stepper-header {
          padding: 1rem;
