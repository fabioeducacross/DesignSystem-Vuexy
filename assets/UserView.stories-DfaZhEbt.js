import{f as E}from"./snippets-m8t1HIl1.js";const A={title:"Vuexy/Templates/User/UserView",tags:["autodocs"],parameters:{docs:{description:{component:`
# User View Template
...
- View billing
- Change plan
        `}},layout:"fullscreen"},argTypes:{userStatus:{control:"select",options:["active","inactive","suspended"],description:"Status do usuário",table:{defaultValue:{summary:"active"}}}}},C=({userStatus:i="active"})=>{const s={active:'<span class="badge bg-success">Active</span>',inactive:'<span class="badge bg-secondary">Inactive</span>',suspended:'<span class="badge bg-danger">Suspended</span>'};return`<div class="content-wrapper">
...
.timeline-icon {
  ...
  font-size: 1.125rem;
    ...
    <details>
      ...
      <div class="mt-3">
        <h6>HTML</h6>
        <pre><code>${E(s).replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
      </div>
    </details>
  `},l=()=>C({userStatus:"active"}),t=d.bind({});t.args={userStatus:"active"};const e=d.bind({});e.args={userStatus:"inactive"};const a=d.bind({});a.args={userStatus:"suspended"};const n=()=>`
  ...
  `;var c,r,o;l.parameters={...l.parameters,docs:{...(c=l.parameters)==null?void 0:c.docs,source:{originalSource:`() => createUserViewPage({
  userStatus: 'active'
})`,...(o=(r=l.parameters)==null?void 0:r.docs)==null?void 0:o.source}}};var b,v,m;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(m=(v=t.parameters)==null?void 0:v.docs)==null?void 0:m.source}}};var u,p,g;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:`args => {
  const markup = createUserViewPage(args);
  return \`
    \${markup}
  ...
  \`;
}`,...(g=(p=e.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var y,h,f;a.parameters={...a.parameters,docs:{...(y=a.parameters)==null?void 0:y.docs,source:{originalSource:`args => {
  const markup = createUserViewPage(args);
  return \`
    \${markup}
  ...
  \`;
}`,...(f=(h=a.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var x,w,S;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`() => {
  return \`
    <div class="content-wrapper p-4">
      <!-- User Header Card -->
      <div class="card mb-4">
  ...
  \`;
}`,...(S=(w=n.parameters)==null?void 0:w.docs)==null?void 0:S.source}}};const D=["Overview","ActiveUser","InactiveUser","SuspendedUser","Interactive"];export{t as ActiveUser,e as InactiveUser,n as Interactive,l as Overview,a as SuspendedUser,D as __namedExportsOrder,A as default};
