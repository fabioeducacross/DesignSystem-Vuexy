import{f as C}from"./snippets-m8t1HIl1.js";const j={title:"Vuexy/Organisms/Apps/EmailList",tags:["autodocs"],parameters:{docs:{description:{component:`
# Email List
...
- Screen reader support
        `}}},argTypes:{selectedFolder:{control:"select",options:["inbox","sent","draft","spam","trash"],description:"Pasta selecionada",table:{defaultValue:{summary:"inbox"}}}}},E=({selectedFolder:e="inbox"})=>`<div class="email-app">
  <div class="row g-0">
    <!-- Sidebar -->
    <div class="col-lg-3 col-xl-2 email-sidebar border-end">
      <div class="p-3">
        ...
        <ul class="list-unstyled mb-0">
          ${[{id:"inbox",icon:"bx-envelope",label:"Inbox",count:24},{id:"sent",icon:"bx-send",label:"Sent",count:0},{id:"draft",icon:"bx-edit",label:"Draft",count:3},{id:"spam",icon:"bx-error-circle",label:"Spam",count:8},{id:"trash",icon:"bx-trash",label:"Trash",count:0}].map(s=>`
          <li class="mb-1">
            <a href="#" class="d-flex align-items-center text-decoration-none p-2 rounded ${e===s.id?"active":""}">
              <i class="bx ${s.icon} me-2"></i>
              <span class="flex-grow-1">${s.label}</span>
              ${s.count>0?`<span class="badge bg-label-primary rounded-pill">${s.count}</span>`:""}
            </a>
          </li>
          `).join("")}
        </ul>
          ...
          <div class="d-flex align-items-center p-3">
            ...
            <div class="flex-grow-1 overflow-hidden">
              <div class="d-flex align-items-center mb-1">
                ...
                ${e==="inbox"?'<i class="bx bx-paperclip text-muted"></i>':""}
              </div>
...
@media (max-width: 992px) {
  ...
  .email-list-area {
    ...
    <details>
      ...
      <div class="mt-3">
        <h6>HTML</h6>
        <pre><code>${C(r).replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
      </div>
    </details>
  `},l=()=>E({selectedFolder:"inbox"}),t=c.bind({});t.args={selectedFolder:"inbox"};const a=c.bind({});a.args={selectedFolder:"sent"};const i=c.bind({});i.args={selectedFolder:"draft"};const n=()=>`
    <div id="${"email-interactive-"+Math.random().toString(36).substr(2,9)}" style="max-width: 800px;">
  ...
  `;var o,d,m;l.parameters={...l.parameters,docs:{...(o=l.parameters)==null?void 0:o.docs,source:{originalSource:`() => createEmailList({
  selectedFolder: 'inbox'
})`,...(m=(d=l.parameters)==null?void 0:d.docs)==null?void 0:m.source}}};var p,b,g;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(g=(b=t.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};var v,u,h;a.parameters={...a.parameters,docs:{...(v=a.parameters)==null?void 0:v.docs,source:{originalSource:`args => {
  const markup = createEmailList(args);
  return \`
    \${markup}
  ...
  \`;
}`,...(h=(u=a.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};var x,f,y;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`args => {
  const markup = createEmailList(args);
  return \`
    \${markup}
  ...
  \`;
}`,...(y=(f=i.parameters)==null?void 0:f.docs)==null?void 0:y.source}}};var w,k,S;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`() => {
  ...
  \`;
}`,...(S=(k=n.parameters)==null?void 0:k.docs)==null?void 0:S.source}}};const I=["Overview","Inbox","Sent","Draft","Interactive"];export{i as Draft,t as Inbox,n as Interactive,l as Overview,a as Sent,I as __namedExportsOrder,j as default};
