import{f as $,a as H}from"./snippets-m8t1HIl1.js";const S={title:"Molecules/Navigation/Breadcrumb",tags:["autodocs"],parameters:{docs:{description:{component:`
# Breadcrumb
  ...
  <ol class="breadcrumb">
    ...
    <details>
      ...
      <div class="mt-3">
        ...
        <h6>React</h6>
        <pre><code>${H(r,"Breadcrumb").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
      </div>
    </details>
  `},c=()=>`
  <div class="row g-4">
...
`,t=y.bind({});t.args={showIcons:!1,items:[{label:"Home",href:"#"},{label:"Library",href:"#"},{label:"Data",active:!0}]};const n=y.bind({});n.args={showIcons:!0,items:[{label:"Home",href:"#",icon:"bx bx-home"},{label:"Documents",href:"#",icon:"bx bx-folder"},{label:"Reports",href:"#",icon:"bx bx-file"},{label:"Annual Report",active:!0,icon:"bx bx-data"}]};const i={render:()=>`
    ...
    `};var o,m,d;c.parameters={...c.parameters,docs:{...(o=c.parameters)==null?void 0:o.docs,source:{originalSource:`() => \`
  <div class="row g-4">
    <div class="col-12">
      <h5>Básico</h5>
      \${createBreadcrumb({
...
\``,...(d=(m=c.parameters)==null?void 0:m.docs)==null?void 0:d.source}}};var u,b,p;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(p=(b=t.parameters)==null?void 0:b.docs)==null?void 0:p.source}}};var h,v,g;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`args => {
  const markup = createBreadcrumb(args);
  return \`
    <div>
      \${markup}
