const z={title:"Vuexy/Foundations/Icons",parameters:{docs:{description:{component:"Sistema de iconografia do Vuexy com 4 bibliotecas: Bootstrap Icons, Font Awesome 6.7.2, Tabler Icons (5000+), e Flag Icons."}}}},i={render:()=>`
  ...
  `},A=[{name:"plus",category:"Ações",usage:"Adicionar item"},{name:"x",category:"Ações",usage:"Fechar/Remover"},{name:"trash",category:"Ações",usage:"Deletar"},{name:"pencil",category:"Ações",usage:"Editar"},{name:"check",category:"Ações",usage:"Confirmar"},{name:"download",category:"Ações",usage:"Baixar"},{name:"upload",category:"Ações",usage:"Upload"},{name:"search",category:"Ações",usage:"Buscar"},{name:"chevron-left",category:"Navegação",usage:"Voltar"},{name:"chevron-right",category:"Navegação",usage:"Avançar"},{name:"chevron-up",category:"Navegação",usage:"Expandir/Colapsar"},{name:"chevron-down",category:"Navegação",usage:"Expandir/Colapsar"},{name:"arrow-left",category:"Navegação",usage:"Retornar"},{name:"arrow-right",category:"Navegação",usage:"Próximo"},{name:"house",category:"Navegação",usage:"Home"},{name:"list",category:"Navegação",usage:"Menu"},{name:"person",category:"Usuário",usage:"Perfil"},{name:"people",category:"Usuário",usage:"Equipe"},{name:"person-circle",category:"Usuário",usage:"Avatar"},{name:"box-arrow-right",category:"Usuário",usage:"Logout"},{name:"bell",category:"Comunicação",usage:"Notificações"},{name:"envelope",category:"Comunicação",usage:"Email/Mensagens"},{name:"chat",category:"Comunicação",usage:"Chat"},{name:"telephone",category:"Comunicação",usage:"Telefone"},{name:"check-circle",category:"Status",usage:"Sucesso"},{name:"x-circle",category:"Status",usage:"Erro"},{name:"exclamation-triangle",category:"Status",usage:"Aviso"},{name:"info-circle",category:"Status",usage:"Informação"},{name:"gear",category:"Configuração",usage:"Settings"},{name:"sliders",category:"Configuração",usage:"Filtros"},{name:"three-dots-vertical",category:"Configuração",usage:"Menu opções"},{name:"file-earmark",category:"Arquivos",usage:"Documento"},{name:"folder",category:"Arquivos",usage:"Pasta"},{name:"image",category:"Arquivos",usage:"Imagem"},{name:"eye",category:"Interface",usage:"Visualizar"},{name:"eye-slash",category:"Interface",usage:"Ocultar"},{name:"star",category:"Interface",usage:"Favorito"},{name:"heart",category:"Interface",usage:"Curtir"},{name:"share",category:"Interface",usage:"Compartilhar"},{name:"lock",category:"Interface",usage:"Bloqueado"},{name:"unlock",category:"Interface",usage:"Desbloqueado"}],n={render:()=>{const a={};return A.forEach(e=>{a[e.category]||(a[e.category]=[]),a[e.category].push(e)}),`
      <div class="p-4">
              ...
              ${a[e].map(s=>`
                <div class="col-6 col-md-4 col-lg-3">
                  <div class="card h-100 hover-shadow" style="cursor: pointer;" 
                       onclick="navigator.clipboard.writeText('<i class=\\'bi bi-${s.name}\\'></i>'); alert('Copiado: <i class=\\'bi bi-${s.name}\\'></i>')">
                    <div class="card-body text-center">
                      <i class="bi bi-${s.name}" style="font-size: 2rem; color: #696cff;"></i>
                      <p class="mb-1 mt-2 small fw-semibold">${s.name}</p>
                      <p class="mb-0 text-muted" style="font-size: 0.75rem;">${s.usage}</p>
                    </div>
                  </div>
                </div>
              `).join("")}
...
&lt;/button&gt;</code></pre>
  ...
  `,parameters:{docs:{source:{code:`<button class="btn btn-primary">
  <i class="ti tabler-plus me-1"></i>
  Adicionar
</button>
...
&lt;/a&gt;</code></pre>
  ...
  `},l={render:()=>(setTimeout(()=>{document.querySelectorAll(".icon-copy-card").forEach(e=>{e.addEventListener("click",function(){const s=this.dataset.icon;navigator.clipboard.writeText(`<i class="bi bi-${s}"></i>`);const B=this.innerHTML;this.innerHTML='<div class="text-success"><i class="bi bi-check-circle"></i><br>Copiado!</div>',setTimeout(()=>{this.innerHTML=B},1e3)})})},100),`
      <div class="p-4">
        <h5 class="mb-4">
        ...
        <div class="row g-3 mb-4">
          ${["plus","search","bell","heart","star","gear","trash","pencil","eye","download","share","lock"].map(a=>`
            <div class="col-4 col-md-3 col-lg-2">
              <div class="card text-center icon-copy-card" data-icon="${a}" 
                   style="cursor: pointer; transition: all 0.2s;">
                <div class="card-body py-4">
                  <i class="bi bi-${a}" style="font-size: 2.5rem; color: #696cff;"></i>
                  <p class="mb-0 mt-2 small">${a}</p>
                </div>
              </div>
            </div>
          `).join("")}
    ...
    `)};var c,d,b;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="margin-bottom: 1rem;">Bibliotecas de Ícones do Vuexy</h1>
      <p style="color: #6c757d; margin-bottom: 3rem;">
  ...
  \`
}`,...(b=(d=i.parameters)==null?void 0:d.docs)==null?void 0:b.source}}};var m,p,g;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => {
...
}`,...(g=(p=n.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var u,v,f;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
    <div class="p-4">
      <h5 class="mb-4">Ícones em Botões</h5>
...
}`,...(f=(v=t.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};var y,h,x;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => \`
    <div class="p-4">
      <h5 class="mb-4">Ícones em Input Groups</h5>
...
&lt;/div&gt;</code></pre>
  ...
  \`
}`,...(x=(h=r.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};var w,k,I;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => \`
    <div class="p-4">
      <h5 class="mb-4">Ícones em Navegação</h5>
...
&lt;/a&gt;</code></pre>
  ...
  \`
}`,...(I=(k=o.parameters)==null?void 0:k.docs)==null?void 0:I.source}}};var C,D,E;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => {
    setTimeout(() => {
...
}`,...(E=(D=l.parameters)==null?void 0:D.docs)==null?void 0:E.source}}};const F=["AllLibraries","AllIcons","InButtons","InInputGroups","InNavigation","Interactive"];export{n as AllIcons,i as AllLibraries,t as InButtons,r as InInputGroups,o as InNavigation,l as Interactive,F as __namedExportsOrder,z as default};
