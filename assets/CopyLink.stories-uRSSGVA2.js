import{c as N,a as P,d as H}from"./docTemplate-RKjNfURf.js";const j=`
<style>
  .copy-link-modal {
    background: white;
    border-radius: 12px;
...
`,U={title:"Educacross Components V2/Modals/CopyLink",parameters:{layout:"fullscreen",previewTabs:{canvas:{hidden:!0}},viewMode:"docs",docs:{story:{inline:!0,iframeHeight:0},canvas:{sourceState:"none"},description:{component:`CopyLink - Link Copy Component with Clipboard
==============================================

Modal for copying mission/guide links to clipboard.
Shows feedback on successful copy.`}},controls:{disable:!0},actions:{disable:!0},toolbar:{zoom:{hidden:!0},eject:{hidden:!0},copy:{hidden:!0}}}},e=`
<style>
  .copy-link-modal {
    background: white;
    border-radius: 16px;
...
`,n={render:()=>N({title:"CopyLink",subtitle:"Modal para copiar links de missões/guias com feedback visual e integração de clipboard",badge:"Front-office / Modals",badgeIcon:"content_copy",showStats:!0,stats:{Tipo:"Utility",Links:"Multi-format",Feedback:"✓"},colors:{primary:"#6e63e8",secondary:"#FFE082"},content:`
      ${P({title:"Contexto de Uso",icon:"share",steps:["Professor acessa missão ou guia",'Clica em "Compartilhar link"',"Modal exibe URL completa","Clica no botão copiar",'Recebe feedback "Link copiado!" via toast',"Pode colar em WhatsApp, email, LMS, etc."]})}
...
function QRCodeSection({ link }) {
  ...
  />
      ...
      ${H([{prop:"link",type:"String",default:'""',description:"URL completa a ser copiada para o clipboard"},{prop:"visible",type:"Boolean",default:"false",description:"Controla a visibilidade do modal"},{prop:"type",type:"String",default:'"mission"',description:'Tipo do link: "mission", "guide", "activity" para personalizar título'},{prop:"showQRCode",type:"Boolean",default:"false",description:"Exibe QR Code adicional para compartilhamento mobile"}])}
  ...
  `},p={render:()=>(setTimeout(()=>{const t=document.getElementById("interactiveCopy");t&&t.addEventListener("click",()=>{const $=document.getElementById("interactiveInput");navigator.clipboard.writeText($.value),t.classList.add("copied"),t.innerHTML='<i class="bi bi-check-lg"></i> Copiado';const i=document.createElement("div");i.className="success-toast",i.innerHTML='<i class="bi bi-check-circle-fill"></i> Link copiado com sucesso!',document.body.appendChild(i),setTimeout(()=>{i.style.animation="slideIn 0.3s ease reverse",setTimeout(()=>i.remove(),300),t.classList.remove("copied"),t.innerHTML='<i class="bi bi-clipboard"></i>'},2e3)})},100),`
      ${j}
      <div class="copy-link-modal">
        <img src="/educacross-assets/belinha/belinha-school-copy_link.png" class="mascot-image" alt="Belinha" />
  ...
  render: () => createDocPage({
    ...
    content: \`
      ...
      icon: 'share',
      steps: ['Professor acessa missão ou guia', 'Clica em "Compartilhar link"', 'Modal exibe URL completa', 'Clica no botão copiar', 'Recebe feedback "Link copiado!" via toast', 'Pode colar em WhatsApp, email, LMS, etc.']
    })}
...
function QRCodeSection({ link }) {
...
}`,...(b=(u=n.parameters)==null?void 0:u.docs)==null?void 0:b.source}}};var h,y,v;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => \`
  ...
  \`
}`,...(v=(y=o.parameters)==null?void 0:y.docs)==null?void 0:v.source}}};var g,x,f;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => \`
    \${legacyCopyLinkStyles}
    <div class="copy-link-modal">
      <img src="/educacross-assets/belinha/belinha-school-copy_link.png" class="mascot-image" alt="Belinha" />
    ...
    <\/script>
  \`
}`,...(f=(x=a.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};var k,w,C;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => \`
    \${legacyCopyLinkStyles}
    <div class="copy-link-modal">
      <img src="/educacross-assets/belinha/belinha-school-copy_link.png" class="mascot-image" alt="Belinha" />
  ...
  \`
}`,...(C=(w=s.parameters)==null?void 0:w.docs)==null?void 0:C.source}}};var L,T,E;l.parameters={...l.parameters,docs:{...(L=l.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => \`
    \${legacyCopyLinkStyles}
    <div class="copy-link-modal">
      <img src="/educacross-assets/belinha/belinha-school-copy_link.png" class="mascot-image" alt="Belinha" />
  ...
  \`
}`,...(E=(T=l.parameters)==null?void 0:T.docs)==null?void 0:E.source}}};var z,B,S;c.parameters={...c.parameters,docs:{...(z=c.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => \`
    \${legacyCopyLinkStyles}
    <div class="copy-link-modal">
      <h1 class="modal-title" style="margin-bottom: 16px;">Compartilhar missão</h1>
  ...
  \`
}`,...(S=(B=c.parameters)==null?void 0:B.docs)==null?void 0:S.source}}};var M,F,R;r.parameters={...r.parameters,docs:{...(M=r.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => \`
    \${legacyCopyLinkStyles}
    <div style="max-width: 375px; margin: 0 auto;">
      <div class="copy-link-modal" style="padding: 24px;">
  ...
  \`
}`,...(R=(F=r.parameters)==null?void 0:F.docs)==null?void 0:R.source}}};var q,_,D;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => \`
    \${legacyCopyLinkStyles}
    <div class="copy-link-modal" style="max-width: 600px;">
      <h1 class="modal-title">Compartilhar recursos</h1>
  ...
  \`
}`,...(D=(_=d.parameters)==null?void 0:_.docs)==null?void 0:D.source}}};var I,A,Q;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: () => {
    setTimeout(() => {
...
}`,...(Q=(A=p.parameters)==null?void 0:A.docs)==null?void 0:Q.source}}};const W=["Documentation","Default","WithToast","GuideLink","ShortLink","WithQRCode","MobileView","MultipleLinks","Interactive"];export{o as Default,n as Documentation,s as GuideLink,p as Interactive,r as MobileView,d as MultipleLinks,l as ShortLink,c as WithQRCode,a as WithToast,W as __namedExportsOrder,U as default};
