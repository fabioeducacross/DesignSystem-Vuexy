import{f as y}from"./snippets-m8t1HIl1.js";const C={title:"Vuexy/Organisms/Apps/ChatInterface",tags:["autodocs"],parameters:{docs:{description:{component:`
# Chat Interface
...
- Screen reader support
        `}}},argTypes:{showSidebar:{control:"boolean",description:"Mostrar sidebar de conversas",table:{defaultValue:{summary:!0}}}}},f=({showSidebar:e=!0})=>`<div class="app-chat">
  <div class="row g-0">
    ...
    <!-- Chat Area -->
    <div class="${e?"col-lg-8 col-xl-9":"col-12"} app-chat-area">
      <div class="d-flex flex-column h-100">
        <!-- Chat Header -->
        <div class="p-3 border-bottom">
...
.chat-history {
  min-height: 100%;
    ...
    <details>
      ...
      <div class="mt-3">
        <h6>HTML</h6>
        <pre><code>${y(l).replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
  ...
  `},a=()=>f({showSidebar:!0}),t=b.bind({});t.args={showSidebar:!0};const s=b.bind({});s.args={showSidebar:!1};const i=()=>{const e="chat-interactive-"+Math.random().toString(36).substr(2,9);return`
    <div id="${e}" style="max-width: 600px;">
      ...
      <div class="card">
        ...
        <div class="card-body" id="chatMessages-${e}" style="height: 300px; overflow-y: auto;">
          <div class="mb-3">
            <div class="d-flex">
        ...
        <div class="card-footer">
          <div class="input-group">
            <input type="text" id="messageInput-${e}" class="form-control" placeholder="Type a message..." onkeypress="if(event.key === 'Enter') document.getElementById('sendBtn-${e}').click();">
            <button class="btn btn-primary" id="sendBtn-${e}" onclick="
              const input = document.getElementById('messageInput-${e}');
              const msg = input.value.trim();
              if (msg) {
                const chat = document.getElementById('chatMessages-${e}');
  ...
  `};var n,c,d;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:`() => createChatInterface({
  showSidebar: true
})`,...(d=(c=a.parameters)==null?void 0:c.docs)==null?void 0:d.source}}};var r,o,m;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(m=(o=t.parameters)==null?void 0:o.docs)==null?void 0:m.source}}};var v,g,h;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`args => {
  const markup = createChatInterface(args);
  return \`
    \${markup}
  ...
  \`;
}`,...(h=(g=s.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};var p,x,u;i.parameters={...i.parameters,docs:{...(p=i.parameters)==null?void 0:p.docs,source:{originalSource:`() => {
  ...
  \`;
}`,...(u=(x=i.parameters)==null?void 0:x.docs)==null?void 0:u.source}}};const E=["Overview","WithSidebar","ChatOnly","Interactive"];export{s as ChatOnly,i as Interactive,a as Overview,t as WithSidebar,E as __namedExportsOrder,C as default};
