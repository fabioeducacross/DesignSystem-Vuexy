...
`,s={render:()=>`
    ...
    `;return setTimeout(()=>{const p=document.getElementById("interactive-question");if(!p)return;const n=p.querySelectorAll(".card-alternative"),u=document.getElementById("submit-btn"),X=document.getElementById("reset-btn");let m=null;n.forEach((e,i)=>{e.addEventListener("click",()=>{e.classList.contains("correct")||e.classList.contains("incorrect")||(n.forEach(t=>t.classList.remove("selected")),e.classList.add("selected"),m=i,u.disabled=!1)})}),u.addEventListener("click",()=>{if(m===null)return;const e=n[m],i=e.dataset.correct==="true";n.forEach(t=>{t.classList.remove("selected"),t.dataset.correct==="true"?(t.classList.add("correct"),t.innerHTML+='<div class="feedback-icon correct">✓</div>'):t===e&&!i&&(t.classList.add("incorrect"),t.innerHTML+='<div class="feedback-icon incorrect">✗</div>')}),u.disabled=!0}),X.addEventListener("click",()=>{n.forEach(e=>{e.classList.remove("selected","correct","incorrect");const i=e.querySelector(".feedback-icon");i&&i.remove()}),m=null,u.disabled=!0})},100),K}},v={render:()=>`
      ${a}
      <div class="question-container">
    ...
    `};var g,b,f,x,h;s.parameters={...s.parameters,docs:{...(g=s.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => {
    return \`
...
}`,...(f=(b=s.parameters)==null?void 0:b.docs)==null?void 0:f.source},description:{story:"Default - 4 alternativas de texto (questão de Geografia)",...(h=(x=s.parameters)==null?void 0:x.docs)==null?void 0:h.description}}};var q,E,A,y,B;r.parameters={...r.parameters,docs:{...(q=r.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => {
    return \`
      \${questionAlternativeStyles}
      <div class="question-container">
...
}`,...(A=(E=r.parameters)==null?void 0:E.docs)==null?void 0:A.source},description:{story:"AllStates - Estados: Default, Selected, Correct, Incorrect",...(B=(y=r.parameters)==null?void 0:y.docs)==null?void 0:B.description}}};var k,C,S,L,Q;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => {
    return \`
      \${questionAlternativeStyles}
      <div class="question-container">
...
}`,...(S=(C=c.parameters)==null?void 0:C.docs)==null?void 0:S.source},description:{story:"MathQuestion - Questão de Matemática",...(Q=(L=c.parameters)==null?void 0:L.docs)==null?void 0:Q.description}}};var I,D,z,w,R;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: () => {
    return \`
      \${questionAlternativeStyles}
      <div class="question-container">
...
}`,...(z=(D=d.parameters)==null?void 0:D.docs)==null?void 0:z.source},description:{story:"ImageAlternatives - Questão com figuras geométricas",...(R=(w=d.parameters)==null?void 0:w.docs)==null?void 0:R.description}}};var T,M,H,P,F;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => {
    return \`
      \${questionAlternativeStyles}
      <div class="question-container">
...
}`,...(H=(M=o.parameters)==null?void 0:M.docs)==null?void 0:H.source},description:{story:"ScienceQuestion - Questão de Ciências com texto longo",...(F=(P=o.parameters)==null?void 0:P.docs)==null?void 0:F.description}}};var $,V,U,j,O;l.parameters={...l.parameters,docs:{...($=l.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => {
    const html = \`
      \${questionAlternativeStyles}
      <div class="question-container" id="interactive-question">
