const C={title:"Vuexy/Foundations/Colors",parameters:{previewTabs:{canvas:{hidden:!1}}}},k={primary:{name:"Primary",hex:"#5f61e6",usage:"Ações principais, links, botões CTA"},secondary:{name:"Secondary",hex:"#8592a3",usage:"Ações secundárias, elementos auxiliares"},success:{name:"Success",hex:"#56ca00",usage:"Mensagens de sucesso, status positivo"},danger:{name:"Danger",hex:"#ff4c51",usage:"Erros, alertas críticos, ações destrutivas"},warning:{name:"Warning",hex:"#ffb400",usage:"Avisos, atenção necessária"},info:{name:"Info",hex:"#16b1ff",usage:"Informações, dicas, ajuda"},dark:{name:"Dark",hex:"#4b4b4b",usage:"Texto principal, elementos escuros"},light:{name:"Light",hex:"#f8f8f8",usage:"Backgrounds claros, separadores"}},$=(a,e)=>`
  <div style="
...
`,n={render:()=>`
    <div style="padding: 2rem;">
      ...
      <div style="
        ...
        gap: 1.5rem;
      ">
        ${Object.entries(k).map(([a,e])=>$(a,e)).join("")}
      </div>
    </div>
  `},r={render:()=>`
      <div style="padding: 2rem;">
        ...
        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
          ${[{name:"Gray 100",hex:"#f8f9fa",class:"bg-gray-100"},{name:"Gray 200",hex:"#e9ecef",class:"bg-gray-200"},{name:"Gray 300",hex:"#dee2e6",class:"bg-gray-300"},{name:"Gray 400",hex:"#ced4da",class:"bg-gray-400"},{name:"Gray 500",hex:"#adb5bd",class:"bg-gray-500"},{name:"Gray 600",hex:"#6c757d",class:"bg-gray-600"},{name:"Gray 700",hex:"#495057",class:"bg-gray-700"},{name:"Gray 800",hex:"#343a40",class:"bg-gray-800"},{name:"Gray 900",hex:"#212529",class:"bg-gray-900"}].map(e=>`
            <div style="
              display: flex;
              align-items: center;
              background: white;
    ...
    `},s={render:()=>`
      <div style="padding: 2rem;">
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
          ${["primary","secondary","success","danger","warning","info","dark"].map(e=>`
            <div style="text-align: center;">
              <span class="badge bg-label-${e}" style="font-size: 0.875rem; padding: 0.5rem 1rem;">
  ...
  `},i={render:()=>`
    <div style="padding: 2rem; max-width: 900px;">
      ...
      <div id="color-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem;">
        ${Object.entries({primary:"#5f61e6",secondary:"#8592a3",success:"#56ca00",danger:"#ff4c51",warning:"#ffb400",info:"#16b1ff",dark:"#4b4b4b",light:"#f8f8f8"}).map(([a,e])=>`
          <div style="border: 1px solid #dee2e6; border-radius: 8px; overflow: hidden; cursor: pointer; transition: transform 0.2s;"
               ...
               onclick="
                 ...
                 toastText.textContent = '✅ Copied ${e}';
                 toast.style.display = 'block';
                 setTimeout(() => toast.style.display = 'none', 2000);
               ">
            <div style="background: ${e}; height: 120px; position: relative;">
            ...
            <div style="padding: 1rem; background: white;">
              <h5 style="margin: 0 0 0.5rem 0; font-size: 1rem; text-transform: capitalize;">${a}</h5>
              <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                <code style="font-size: 0.75rem; padding: 0.25rem 0.5rem; background: #f8f8f8; border-radius: 4px;">.text-${a}</code>
                <code style="font-size: 0.75rem; padding: 0.25rem 0.5rem; background: #f8f8f8; border-radius: 4px;">.bg-${a}</code>
              </div>
            </div>
          </div>
        `).join("")}
  ...
  `};var d,o,l;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="margin-bottom: 0.5rem;">Theme Colors</h1>
      <p style="color: #6c757d; margin-bottom: 2rem;">
      ...
      <div style="
        ...
        gap: 1.5rem;
      ">
        \${Object.entries(colors).map(([key, details]) => createColorSwatch(key, details)).join('')}
      </div>
    </div>
  \`
}`,...(l=(o=n.parameters)==null?void 0:o.docs)==null?void 0:l.source}}};var c,m,g;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => {
    const grays = [{
      name: 'Gray 100',
      hex: '#f8f9fa',
...
}`,...(g=(m=r.parameters)==null?void 0:m.docs)==null?void 0:g.source}}};var p,b,y;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => {
...
}`,...(y=(b=s.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};var v,x,u;t.parameters={...t.parameters,docs:{...(v=t.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; max-width: 900px;">
      <h2 style="margin-bottom: 2rem;">Usage Examples</h2>
  ...
  \`
}`,...(u=(x=t.parameters)==null?void 0:x.docs)==null?void 0:u.source}}};var f,h,w;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; max-width: 900px;">
      <h2 style="margin-bottom: 2rem;">🎨 Interactive Color Palette</h2>
  ...
  \`
}`,...(w=(h=i.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};const z=["ThemeColors","GrayScale","LabelColors","UsageExamples","Interactive"];export{r as GrayScale,i as Interactive,s as LabelColors,n as ThemeColors,t as UsageExamples,z as __namedExportsOrder,C as default};
