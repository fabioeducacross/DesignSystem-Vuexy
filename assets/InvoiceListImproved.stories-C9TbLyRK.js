const y={title:"Vuexy/Organisms/Apps/Invoice List Improved",tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:`
<style>
...
Lazy load de 10 items por vez. Virtual scrolling para listas maiores que 100 items. Debounce em search input (300ms). Memoização de filtros computados.
        `}}}},w=[{id:5036,client:"Jordan Stevenson",email:"jordan.steve@example.com",date:"Apr 18, 2021",total:3428,balance:0,status:"paid"},{id:5035,client:"Stephanie Burns",email:"s.burns@techcorp.io",date:"Apr 17, 2021",total:5219,balance:0,status:"paid"},{id:5034,client:"Tony Herrera",email:"tony.h@innovate.com",date:"Apr 15, 2021",total:3719,balance:0,status:"paid"},{id:5033,client:"Kevin Patton",email:"kpatton@solutions.net",date:"Apr 14, 2021",total:4749,balance:0,status:"paid"},{id:5032,client:"Mrs. Julie Donovan MD",email:"julie.donovan@health.org",date:"Apr 12, 2021",total:4056,balance:1200,status:"pending"},{id:5031,client:"Amanda Phillips",email:"a.phillips@design.studio",date:"Apr 10, 2021",total:2771,balance:0,status:"paid"},{id:5030,client:"Scott Davidson",email:"scott.d@enterprise.com",date:"Apr 08, 2021",total:5200,balance:2800,status:"overdue"},{id:5029,client:"Christina Collier",email:"chris.collier@marketing.io",date:"Apr 05, 2021",total:3202,balance:0,status:"paid"}],s={render:()=>`
          ...
          <tr>
            ...
            <td>
              <div class="d-flex flex-column">
                <span class="fw-semibold text-body">${a.client}</span>
            ...
            <td>
              ${a.balance>0?`<span class="text-danger fw-medium">$${a.balance.toLocaleString()}</span>`:'<span class="badge bg-label-success">Paid in full</span>'}
            </td>
            
            <!-- Status (SÓ BADGE, sem ícone redundante) -->
            <td>
              <span class="badge bg-label-${a.status==="paid"?"success":a.status==="pending"?"warning":"danger"}" 
                    role="status"
                    aria-label="Payment status: ${a.status}">
            ...
            <td style="text-align: center;">
              <div class="dropdown">
                <button 
                  ...
                  aria-label="Actions menu for invoice ${a.id}"
                  aria-expanded="false">
                  <i class="bx bx-dots-vertical-rounded" aria-hidden="true"></i>
                </button>
...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row g-4">
    ...
    `,loaders:[async()=>typeof window<"u"&&!window.bootstrap?new Promise(a=>{const i=document.createElement("script");i.src="/vuexy/js/bootstrap.js",i.onload=()=>a({bootstrapLoaded:!0}),document.head.appendChild(i)}):{}]},n={render:()=>`
<link rel="stylesheet" href="/vuexy/css/core.css">
...
.cursor-pointer:hover {
  ...
  box-shadow: 0 4px 20px rgba(0,0,0,0.1);
    ...
    `};var t,l,o,d,r;s.parameters={...s.parameters,docs:{...(t=s.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render: () => {
    return \`
<link rel="stylesheet" href="/vuexy/css/core.css">
<link rel="stylesheet" href="/vuexy/vendors/libs/datatables-bs5/datatables.bootstrap5.css">
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <!-- Balance (só aparece se > 0) -->
            <td>
              \${inv.balance > 0 ? \`<span class="text-danger fw-medium">$\${inv.balance.toLocaleString()}</span>\` : \`<span class="badge bg-label-success">Paid in full</span>\`}
            </td>
...
}`,...(o=(l=s.parameters)==null?void 0:l.docs)==null?void 0:o.source},description:{story:"Story: Lista Melhorada Completa",...(r=(d=s.parameters)==null?void 0:d.docs)==null?void 0:r.description}}};var c,m,b,p,v;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => {
    return \`
<link rel="stylesheet" href="/vuexy/css/core.css">
...
}`,...(b=(m=e.parameters)==null?void 0:m.docs)==null?void 0:b.source},description:{story:"Story: Comparação Before/After",...(v=(p=e.parameters)==null?void 0:p.docs)==null?void 0:v.description}}};var u,x,g,h,f;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => {
    return \`
<link rel="stylesheet" href="/vuexy/css/core.css">
...
}`,...(g=(x=n.parameters)==null?void 0:x.docs)==null?void 0:g.source},description:{story:"Story: Métricas Acionáveis",...(f=(h=n.parameters)==null?void 0:h.docs)==null?void 0:f.description}}};const C=["ImprovedList","BeforeAfterComparison","ActionableMetrics"];export{n as ActionableMetrics,e as BeforeAfterComparison,s as ImprovedList,C as __namedExportsOrder,y as default};
