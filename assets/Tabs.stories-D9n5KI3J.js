import{f as V,a as q}from"./snippets-m8t1HIl1.js";const K={title:"Organisms/Navigation/Tabs",tags:["autodocs"],parameters:{docs:{description:{component:`
# Tabs
...
- \`aria-selected\` na tab ativa
  ...
  <div class="tab-content mt-3">
    ...
    <details>
      ...
      <div class="mt-3">
        <h6>HTML</h6>
        <pre><code>${V(c).replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
        <h6>React</h6>
...
\``,...(w=(k=h.parameters)==null?void 0:k.docs)==null?void 0:w.source}}};var S,T,x;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(H=(D=m.parameters)==null?void 0:D.docs)==null?void 0:H.source}}};var j,M,N;p.parameters={...p.parameters,docs:{...(j=p.parameters)==null?void 0:j.docs,source:{originalSource:`() => {
  ...
  \`;
}`,...(N=(M=p.parameters)==null?void 0:M.docs)==null?void 0:N.source}}};const O=["Overview","Default","ProfileActive","PillsStyle","VerticalLeft","Interactive"];export{r as Default,p as Interactive,h as Overview,d as PillsStyle,l as ProfileActive,m as VerticalLeft,O as __namedExportsOrder,K as default};
