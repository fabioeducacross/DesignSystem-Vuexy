const D={title:"Educacross Components V2/Data Display/ExerciseType",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
`,s={render:()=>`
  ...
  `},t={render:()=>`
    ...
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 900px;">
      ...
      <div style="display: flex; flex-direction: column; gap: 16px;">
        ${[{titulo:"Frações Básicas",descricao:"Introdução ao conceito de frações",questoes:12,tipo:"multiple-choice",icone:"bi-list-check"},{titulo:"Operações com Frações",descricao:"Adição e subtração de frações",questoes:8,tipo:"essay",icone:"bi-file-text"},{titulo:"Quiz Rápido: Frações",descricao:"Avaliação rápida de conhecimento",questoes:10,tipo:"true-false",icone:"bi-toggle-on"},{titulo:"Conectando Frações e Decimais",descricao:"Relação entre representações numéricas",questoes:6,tipo:"matching",icone:"bi-link-45deg"}].map(e=>`
          <div style="background: #F8F8F8; border-radius: 8px; padding: 16px; display: flex; justify-content: space-between; align-items: center; gap: 16px;">
            <div style="flex: 1;">
              <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 6px;">
                <h4 style="margin: 0; font-size: 16px; font-weight: 600; color: #5E5873;">${e.titulo}</h4>
                <span class="exercise-type type-${e.tipo}">
                  <i class="bi ${e.icone}"></i>
                  ${e.tipo==="multiple-choice"?"Múltipla Escolha":e.tipo==="essay"?"Dissertativa":e.tipo==="true-false"?"V ou F":"Associação"}
                </span>
              </div>
              <p style="margin: 0; font-size: 13px; color: #6E6B7B;">${e.descricao}</p>
            </div>
            <div style="text-align: right;">
              <div style="font-size: 24px; font-weight: 700; color: #6E63E8;">${e.questoes}</div>
  ...
  `},a={render:()=>`
    ...
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 24px; max-width: 700px;">
      ...
      <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px;">
        ${[{tipo:"multiple-choice",nome:"Múltipla Escolha",desc:"Selecionar 1 alternativa",icone:"bi-list-check"},{tipo:"essay",nome:"Dissertativa",desc:"Resposta em texto livre",icone:"bi-file-text"},{tipo:"true-false",nome:"Verdadeiro/Falso",desc:"Afirmações V ou F",icone:"bi-toggle-on"},{tipo:"matching",nome:"Associação",desc:"Conectar itens",icone:"bi-link-45deg"},{tipo:"ordering",nome:"Ordenação",desc:"Sequenciar itens",icone:"bi-sort-down"},{tipo:"fill-blanks",nome:"Preencher Lacunas",desc:"Completar texto",icone:"bi-dash-square"}].map(e=>`
          <div style="padding: 16px; border: 2px solid #E5E3F3; border-radius: 10px; cursor: pointer; transition: all 0.2s; background: #fff;" onmouseover="this.style.borderColor='#6E63E8'; this.style.background='#F8F7FD'" onmouseout="this.style.borderColor='#E5E3F3'; this.style.background='#fff'">
            ...
            <p style="margin: 0; font-size: 12px; color: #6E6B7B;">${e.desc}</p>
          </div>
        `).join("")}
      </div>
    </div>
  ...
  `},r={render:()=>`
    ...
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 600px;">
      ...
      <div style="display: flex; flex-direction: column; gap: 14px;">
        ${[{tipo:"multiple-choice",nome:"Múltipla Escolha",count:45,percent:35,icone:"bi-list-check"},{tipo:"essay",nome:"Dissertativa",count:28,percent:22,icone:"bi-file-text"},{tipo:"true-false",nome:"Verdadeiro/Falso",count:32,percent:25,icone:"bi-toggle-on"},{tipo:"matching",nome:"Associação",count:15,percent:12,icone:"bi-link-45deg"},{tipo:"ordering",nome:"Ordenação",count:8,percent:6,icone:"bi-sort-down"}].map(e=>`
          <div style="display: flex; align-items: center; gap: 12px;">
            <span class="exercise-type type-${e.tipo}" style="min-width: 180px;">
              <i class="bi ${e.icone}"></i>
              ${e.nome}
            </span>
            <div style="flex: 1; background: #E8E8E8; height: 8px; border-radius: 4px; overflow: hidden;">
              <div style="width: ${e.percent}%; height: 100%; background: linear-gradient(90deg, #6E63E8, #28C76F); transition: width 0.5s;"></div>
            </div>
            <div style="display: flex; align-items: center; gap: 8px; min-width: 100px; justify-content: flex-end;">
              <span style="font-size: 18px; font-weight: 700; color: #5E5873;">${e.count}</span>
              <span style="font-size: 12px; color: #6E6B7B;">(${e.percent}%)</span>
            </div>
          </div>
        `).join("")}
      </div>
  ...
  \`
}`,...(c=(l=s.parameters)==null?void 0:l.docs)==null?void 0:c.source}}};var d,x,y;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="display: flex; flex-wrap: wrap; gap: 12px;">
      <span class="exercise-type type-multiple-choice type-outline">
  ...
  \`
}`,...(y=(x=n.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};var u,g,m;o.parameters={...o.parameters,docs:{...(u=o.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="display: flex; flex-wrap: wrap; gap: 8px;">
      <span class="exercise-type exercise-type-small type-multiple-choice">
  ...
  \`
}`,...(m=(g=o.parameters)==null?void 0:g.docs)==null?void 0:m.source}}};var b,f,E;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 900px;">
      <h3 style="margin: 0 0 16px; font-size: 18px; font-weight: 600; color: #5E5873;">Biblioteca de Missões - Matemática 5º Ano</h3>
    ...
    descricao: 'Adição e subtração de frações',
    questoes: 8,
    tipo: 'essay',
    icone: 'bi-file-text'
  }, {
    titulo: 'Quiz Rápido: Frações',
    descricao: 'Avaliação rápida de conhecimento',
    questoes: 10,
    tipo: 'true-false',
    icone: 'bi-toggle-on'
  }, {
    titulo: 'Conectando Frações e Decimais',
    descricao: 'Relação entre representações numéricas',
    questoes: 6,
    tipo: 'matching',
    icone: 'bi-link-45deg'
  }].map(missao => \`
            ...
            <div style="flex: 1;">
              <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 6px;">
                ...
                <span class="exercise-type type-\${missao.tipo}">
                  ...
                  \${missao.tipo === 'multiple-choice' ? 'Múltipla Escolha' : missao.tipo === 'essay' ? 'Dissertativa' : missao.tipo === 'true-false' ? 'V ou F' : 'Associação'}
                </span>
              </div>
  ...
  \`
}`,...(E=(f=t.parameters)==null?void 0:f.docs)==null?void 0:E.source}}};var h,v,F;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 24px; max-width: 700px;">
      <h3 style="margin: 0 0 8px; font-size: 20px; font-weight: 600; color: #5E5873;">Criar Nova Questão</h3>
    ...
    desc: 'Selecionar 1 alternativa',
    icone: 'bi-list-check'
  }, {
    tipo: 'essay',
    nome: 'Dissertativa',
    desc: 'Resposta em texto livre',
    icone: 'bi-file-text'
  }, {
    tipo: 'true-false',
    nome: 'Verdadeiro/Falso',
    desc: 'Afirmações V ou F',
    icone: 'bi-toggle-on'
  }, {
    tipo: 'matching',
    nome: 'Associação',
    ...
    tipo: 'ordering',
    nome: 'Ordenação',
    desc: 'Sequenciar itens',
    icone: 'bi-sort-down'
  }, {
    tipo: 'fill-blanks',
    nome: 'Preencher Lacunas',
    desc: 'Completar texto',
    icone: 'bi-dash-square'
  }].map(opcao => \`
          <div style="padding: 16px; border: 2px solid #E5E3F3; border-radius: 10px; cursor: pointer; transition: all 0.2s; background: #fff;" onmouseover="this.style.borderColor='#6E63E8'; this.style.background='#F8F7FD'" onmouseout="this.style.borderColor='#E5E3F3'; this.style.background='#fff'">
            <div style="margin-bottom: 10px;">
  ...
  \`
}`,...(F=(v=a.parameters)==null?void 0:v.docs)==null?void 0:F.source}}};var w,k,B;r.parameters={...r.parameters,docs:{...(w=r.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => \`
    \${css}
    <div style="background: #fff; border: 1px solid #D8D6DE; border-radius: 8px; padding: 20px; max-width: 600px;">
      <h3 style="margin: 0 0 16px; font-size: 18px; font-weight: 600; color: #5E5873;">Distribuição por Tipo - Turma 5º A</h3>
  ...
  \`
}`,...(B=(k=r.parameters)==null?void 0:k.docs)==null?void 0:B.source}}};const $=["Default","OutlineVariant","SmallSize","BibliotecaDeMissoes","CriacaoDeMissao","RelatorioPorTipo"];export{t as BibliotecaDeMissoes,a as CriacaoDeMissao,s as Default,n as OutlineVariant,r as RelatorioPorTipo,o as SmallSize,$ as __namedExportsOrder,D as default};
