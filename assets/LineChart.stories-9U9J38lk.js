import{f as P}from"./snippets-m8t1HIl1.js";const q={title:"Vuexy/Organisms/Charts/LineChart",tags:["autodocs"],parameters:{docs:{description:{component:`
# Line Chart
...
- ARIA labels
        `}}},argTypes:{variant:{control:"select",options:["simple","multiple","area"],description:"Variante do gráfico",table:{defaultValue:{summary:"simple"}}}}},T=({variant:t="simple"})=>{const e=`lineChart${t}`,n=`
  ...
  <div class="card-header d-flex justify-content-between align-items-center">
    <h5 class="mb-0">
      ${t==="simple"?"Monthly Revenue":t==="multiple"?"Financial Overview":"User Growth"}
    </h5>
    <div class="text-muted small">2024</div>
  </div>
  <div class="card-body">
    ${{simple:n,multiple:c,area:m}[t]}
  </div>
</div>
...
<div class="alert alert-info mt-4">
  ...
  <pre class="mb-0 mt-2"><code>&lt;script src="vendors/libs/apex-charts/apexcharts.js"&gt;&lt;/script&gt;</code></pre>
    ...
    <details>
      ...
      <div class="mt-3">
        <h6>HTML</h6>
        <pre><code>${P(e).replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
      </div>
    </details>
  `},l=()=>T({variant:"simple"}),s=d.bind({});s.args={variant:"simple"};const i=d.bind({});i.args={variant:"multiple"};const o=d.bind({});o.args={variant:"area"};const r={parameters:{docs:{description:{story:`
...
3. Clique nas legendas para ocultar séries
        `}}},loaders:[async()=>typeof window<"u"?window.ApexCharts?{apexChartsLoaded:!0}:new Promise((t,e)=>{const n=document.createElement("script");n.src="/vuexy/vendors/libs/apex-charts/apexcharts.js",n.onload=()=>{console.log("✅ ApexCharts JS carregado"),t({apexChartsLoaded:!0})},n.onerror=()=>e(new Error("Failed to load ApexCharts")),document.head.appendChild(n)}):{}],render:()=>(setTimeout(()=>{window.ApexCharts&&(new ApexCharts(document.querySelector("#chart-line"),{series:[{name:"Vendas 2025",data:[28e3,32e3,29e3,42e3,38e3,5e4,48e3,61e3,59e3,67e3,73e3,78e3]},{name:"Vendas 2024",data:[24e3,28e3,26e3,35e3,33e3,42e3,4e4,51e3,48e3,55e3,6e4,65e3]}],chart:{height:300,type:"line",toolbar:{show:!0},zoom:{enabled:!0}},colors:["#696cff","#8592a3"],dataLabels:{enabled:!1},stroke:{curve:"smooth",width:3},xaxis:{categories:["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"]},yaxis:{labels:{formatter:function(a){return"R$ "+a/1e3+"k"}}},tooltip:{y:{formatter:function(a){return"R$ "+a.toLocaleString("pt-BR")}}}}).render(),new ApexCharts(document.querySelector("#chart-bar"),{series:[{name:"Receita",data:[44,55,41,67,22,43,21,49,65,72,68,84]}],chart:{height:300,type:"bar",toolbar:{show:!1}},colors:["#71dd37"],plotOptions:{bar:{borderRadius:8,dataLabels:{position:"top"}}},dataLabels:{enabled:!0,formatter:function(a){return a+"k"},offsetY:-20,style:{fontSize:"12px",colors:["#304758"]}},xaxis:{categories:["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"]},yaxis:{labels:{formatter:function(a){return a+"k"}}}}).render(),new ApexCharts(document.querySelector("#chart-pie"),{series:[44,55,41,17,15],chart:{height:300,type:"pie"},labels:["Eletrônicos","Roupas","Alimentos","Livros","Outros"],colors:["#696cff","#71dd37","#ffab00","#ff3e1d","#8592a3"],legend:{position:"bottom"},responsive:[{breakpoint:480,options:{chart:{width:200},legend:{position:"bottom"}}}]}).render(),new ApexCharts(document.querySelector("#chart-donut"),{series:[1234,567,89],chart:{height:300,type:"donut"},labels:["Ativos","Inativos","Bloqueados"],colors:["#71dd37","#ffab00","#ff3e1d"],plotOptions:{pie:{donut:{size:"65%",labels:{show:!0,name:{show:!0,fontSize:"22px"},value:{show:!0,fontSize:"16px",formatter:function(a){return parseInt(a).toLocaleString("pt-BR")}},total:{show:!0,label:"Total",formatter:function(a){return a.globals.seriesTotals.reduce((D,k)=>D+k,0).toLocaleString("pt-BR")}}}}}},legend:{position:"bottom"}}).render(),new ApexCharts(document.querySelector("#chart-area"),{series:[{name:"Visitantes",data:[31,40,28,51,42,109,100]},{name:"Pageviews",data:[11,32,45,32,34,52,41]}],chart:{height:300,type:"area",toolbar:{show:!1}},colors:["#696cff","#71dd37"],dataLabels:{enabled:!1},stroke:{curve:"smooth"},xaxis:{categories:["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"]},tooltip:{x:{format:"dd/MM/yy"}},fill:{type:"gradient",gradient:{opacityFrom:.6,opacityTo:.1}}}).render(),new ApexCharts(document.querySelector("#chart-mixed"),{series:[{name:"Vendas",type:"column",data:[23,11,22,27,13,22,37,21,44,22,30,35]},{name:"Receita",type:"line",data:[30,25,36,30,45,35,64,52,59,36,39,51]}],chart:{height:300,type:"line",toolbar:{show:!1}},colors:["#71dd37","#696cff"],stroke:{width:[0,3]},dataLabels:{enabled:!0,enabledOnSeries:[1]},xaxis:{categories:["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"]},yaxis:[{title:{text:"Vendas (unidades)"}},{opposite:!0,title:{text:"Receita (R$ mil)"}}]}).render(),console.log("✅ ApexCharts: 6 gráficos renderizados"))},100),`
    ...
    `)};var u,p,h;l.parameters={...l.parameters,docs:{...(u=l.parameters)==null?void 0:u.docs,source:{originalSource:`() => createLineChart({
  variant: 'simple'
})`,...(h=(p=l.parameters)==null?void 0:p.docs)==null?void 0:h.source}}};var v,b,g;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(g=(b=s.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};var x,f,C;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`args => {
  const markup = createLineChart(args);
  return \`
    \${markup}
  ...
  \`;
}`,...(C=(f=i.parameters)==null?void 0:f.docs)==null?void 0:C.source}}};var y,A,w;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`args => {
  const markup = createLineChart(args);
  return \`
    \${markup}
  ...
  \`;
}`,...(w=(A=o.parameters)==null?void 0:A.docs)==null?void 0:w.source}}};var S,L,E,R,M;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
}`,...(E=(L=r.parameters)==null?void 0:L.docs)==null?void 0:E.source},description:{story:`====================================
INTERACTIVE STORY - ApexCharts Real
====================================`,...(M=(R=r.parameters)==null?void 0:R.docs)==null?void 0:M.description}}};const J=["Overview","Simple","Multiple","Area","Interactive"];export{o as Area,r as Interactive,i as Multiple,l as Overview,s as Simple,J as __namedExportsOrder,q as default};
