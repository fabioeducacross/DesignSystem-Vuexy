import{f as S}from"./snippets-m8t1HIl1.js";const B={title:"Vuexy/Organisms/Apps/Invoice",tags:["autodocs"],parameters:{docs:{description:{component:`
# Invoice
...
- Readable fonts
- Logical structure
        `}},layout:"fullscreen"},argTypes:{status:{control:"select",options:["paid","pending","overdue"],description:"Status do pagamento",table:{defaultValue:{summary:"paid"}}}}},$=({status:t="paid"})=>`<div class="invoice-wrapper">
      ...
      <div class="card-body">
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-6 text-md-end">
            ...
            <div>
              <strong>Status:</strong> ${{paid:'<span class="badge bg-success">Paid</span>',pending:'<span class="badge bg-warning">Pending</span>',overdue:'<span class="badge bg-danger">Overdue</span>'}[t]}
            </div>
          </div>
        </div>
...
@media (max-width: 768px) {
  ...
  .invoice-card .card-body {
    ...
    <details>
      ...
      <div class="mt-3">
        <h6>HTML</h6>
        <pre><code>${S(o).replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
  ...
  `},a=()=>$({status:"paid"}),e=i.bind({});e.args={status:"paid"};const s=i.bind({});s.args={status:"pending"};const n=i.bind({});n.args={status:"overdue"};const d=()=>{const t="invoice-interactive-"+Math.random().toString(36).substr(2,9);return`
    <div id="${t}" style="max-width: 800px;">
      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <span id="statusBadge-${t}" class="badge bg-success">Paid</span>
        </div>
        <div class="card-body">
          <div class="row mb-4">
            <div class="col-md-6">
          ...
          <div class="mt-4 pt-3 border-top">
            ...
            <div class="btn-group" role="group">
              <button class="btn btn-outline-success" onclick="
                document.getElementById('statusBadge-${t}').className = 'badge bg-success';
                document.getElementById('statusBadge-${t}').textContent = 'Paid';
              ">Paid</button>
              <button class="btn btn-outline-warning" onclick="
                document.getElementById('statusBadge-${t}').className = 'badge bg-warning';
                document.getElementById('statusBadge-${t}').textContent = 'Pending';
              ">Pending</button>
              <button class="btn btn-outline-danger" onclick="
                document.getElementById('statusBadge-${t}').className = 'badge bg-danger';
                document.getElementById('statusBadge-${t}').textContent = 'Overdue';
              ">Overdue</button>
            </div>
          </div>
        </div>
  ...
  `};var r,c,l;a.parameters={...a.parameters,docs:{...(r=a.parameters)==null?void 0:r.docs,source:{originalSource:`() => createInvoice({
  status: 'paid'
})`,...(l=(c=a.parameters)==null?void 0:c.docs)==null?void 0:l.source}}};var m,p,u;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(u=(p=e.parameters)==null?void 0:p.docs)==null?void 0:u.source}}};var b,g,v;s.parameters={...s.parameters,docs:{...(b=s.parameters)==null?void 0:b.docs,source:{originalSource:`args => {
  const markup = createInvoice(args);
  return \`
    \${markup}
  ...
  \`;
}`,...(v=(g=s.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};var h,y,x;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`args => {
  const markup = createInvoice(args);
  return \`
    \${markup}
  ...
  \`;
}`,...(x=(y=n.parameters)==null?void 0:y.docs)==null?void 0:x.source}}};var f,w,I;d.parameters={...d.parameters,docs:{...(f=d.parameters)==null?void 0:f.docs,source:{originalSource:`() => {
  ...
  \`;
}`,...(I=(w=d.parameters)==null?void 0:w.docs)==null?void 0:I.source}}};const P=["Overview","Paid","Pending","Overdue","Interactive"];export{d as Interactive,n as Overdue,a as Overview,e as Paid,s as Pending,P as __namedExportsOrder,B as default};
