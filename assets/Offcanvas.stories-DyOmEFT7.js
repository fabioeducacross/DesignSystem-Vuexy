import{f as q,a as J}from"./snippets-m8t1HIl1.js";const D={title:"Vuexy/Organisms/Navigation/Offcanvas",tags:["autodocs"],parameters:{docs:{description:{component:`
# Offcanvas
...
- ESC fecha o painel
        `}}},argTypes:{placement:{control:{type:"select"},options:["start","end","top","bottom"],description:"Posição do offcanvas",table:{defaultValue:{summary:"start"}}},backdrop:{control:"boolean",description:"Mostra backdrop escuro",table:{defaultValue:{summary:!0}}},scroll:{control:"boolean",description:"Permite scroll do body",table:{defaultValue:{summary:!1}}}}},H=({placement:n="start",backdrop:a=!0,scroll:s=!1})=>`<!-- Button trigger -->
<button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
  Open Offcanvas
</button>

<!-- Offcanvas -->
<div class="offcanvas offcanvas-${n}" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" ${s?'data-bs-scroll="true"':""} ${a?"":'data-bs-backdrop="false"'}>
  ...
  <div class="offcanvas-body">
    ...
    <details>
      ...
      <div class="mt-3">
        <h6>HTML</h6>
        <pre><code>${q(a).replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
        <h6>React</h6>
        <pre><code>${J(a,"Offcanvas").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre>
      </div>
    </details>
  `},f=()=>`
  <div class="row g-4">
...
`,o=t.bind({});o.args={placement:"start",backdrop:!0,scroll:!1};const i=t.bind({});i.args={placement:"end",backdrop:!0,scroll:!1};const l=t.bind({});l.args={placement:"top",backdrop:!0,scroll:!1};const c=t.bind({});c.args={placement:"bottom",backdrop:!0,scroll:!1};const r=t.bind({});r.args={placement:"start",backdrop:!1,scroll:!1};const d=t.bind({});d.args={placement:"start",backdrop:!0,scroll:!0};const e={parameters:{docs:{description:{story:`
...
4. Teste os 4 posicionamentos diferentes
        `}}},loaders:[async()=>typeof window<"u"&&!window.bootstrap?new Promise((n,a)=>{const s=document.createElement("script");s.src="/vuexy/js/bootstrap.js",s.onload=()=>{console.log("✅ Bootstrap JS carregado para Offcanvas"),n({bootstrapLoaded:!0})},s.onerror=()=>a(new Error("Failed to load Bootstrap JS")),document.head.appendChild(s)}):{bootstrapLoaded:!0}],render:()=>`
    ...
    `};var b,v,m;f.parameters={...f.parameters,docs:{...(b=f.parameters)==null?void 0:b.docs,source:{originalSource:`() => \`
  <div class="row g-4">
    <div class="col-12">
      <h5>Posicionamento</h5>
      <div class="d-flex flex-wrap gap-3">
...
\``,...(m=(v=f.parameters)==null?void 0:v.docs)==null?void 0:m.source}}};var p,u,h;o.parameters={...o.parameters,docs:{...(p=o.parameters)==null?void 0:p.docs,source:{originalSource:`args => {
  ...
  \`;
}`,...(h=(u=o.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};var g,x,y;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`args => {
  const markup = createOffcanvas(args);
  return \`
    <div style="padding: 20px;">
      \${markup}
  ...
  \`;
}`,...(y=(x=i.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};var w,k,C;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`args => {
  const markup = createOffcanvas(args);
  return \`
    <div style="padding: 20px;">
      \${markup}
  ...
  \`;
}`,...(C=(k=l.parameters)==null?void 0:k.docs)==null?void 0:C.source}}};var E,S,L;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`args => {
  const markup = createOffcanvas(args);
  return \`
    <div style="padding: 20px;">
      \${markup}
  ...
  \`;
}`,...(L=(S=c.parameters)==null?void 0:S.docs)==null?void 0:L.source}}};var B,O,F;r.parameters={...r.parameters,docs:{...(B=r.parameters)==null?void 0:B.docs,source:{originalSource:`args => {
  const markup = createOffcanvas(args);
  return \`
    <div style="padding: 20px;">
      \${markup}
  ...
  \`;
}`,...(F=(O=r.parameters)==null?void 0:O.docs)==null?void 0:F.source}}};var T,j,R;d.parameters={...d.parameters,docs:{...(T=d.parameters)==null?void 0:T.docs,source:{originalSource:`args => {
  const markup = createOffcanvas(args);
  return \`
    <div style="padding: 20px;">
      \${markup}
  ...
  \`;
}`,...(R=(j=d.parameters)==null?void 0:j.docs)==null?void 0:R.source}}};var $,A,M,P,z;e.parameters={...e.parameters,docs:{...($=e.parameters)==null?void 0:$.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
}`,...(M=(A=e.parameters)==null?void 0:A.docs)==null?void 0:M.source},description:{story:`====================================
INTERACTIVE STORY - Bootstrap JS Real
====================================`,...(z=(P=e.parameters)==null?void 0:P.docs)==null?void 0:z.description}}};const I=["Overview","Start","End","Top","Bottom","NoBackdrop","WithScroll","Interactive"];export{c as Bottom,i as End,e as Interactive,r as NoBackdrop,f as Overview,o as Start,l as Top,d as WithScroll,I as __namedExportsOrder,D as default};
