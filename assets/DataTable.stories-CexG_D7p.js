const X={title:"Organisms/Data Display/DataTable",tags:["autodocs"],argTypes:{rowsCount:{control:{type:"range",min:0,max:20,step:1},description:"Number of rows to display",table:{defaultValue:{summary:5}}},showPagination:{control:"boolean",description:"Show pagination controls",table:{defaultValue:{summary:!0}}},state:{control:{type:"select"},options:["default","empty","loading"],description:"Table state",table:{defaultValue:{summary:"default"}}},striped:{control:"boolean",description:"Striped rows",table:{defaultValue:{summary:!0}}},hover:{control:"boolean",description:"Hover effect on rows",table:{defaultValue:{summary:!0}}},bordered:{control:"boolean",description:"Bordered table",table:{defaultValue:{summary:!1}}}},parameters:{docs:{description:{component:`
# DataTable
...
}`,...(F=(Q=v.parameters)==null?void 0:Q.docs)==null?void 0:F.source}}};var q,V,J;y.parameters={...y.parameters,docs:{...(q=y.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => {
...
}`,...(J=(V=y.parameters)==null?void 0:V.docs)==null?void 0:J.source}}};var O,U,z,W,G;c.parameters={...c.parameters,docs:{...(O=c.parameters)==null?void 0:O.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
