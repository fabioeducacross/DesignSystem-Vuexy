const I={title:"Educacross Components V2/Cards/UserCard",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`
...
.class-more:hover {
  ...
  `};var d,c,p,g,v;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="user-card" onclick="this.style.transform='translateY(-2px)'; setTimeout(() => this.style.transform='', 200)">
      <div class="user-card-header" style="background: url('/profile-corujinhas/7.png') center center / 80px no-repeat, url('/educacross-assets/bg-bolinhas.svg') center center / cover no-repeat, #5F4B8B linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.2) 100%);">
  ...
  \`
}`,...(p=(c=a.parameters)==null?void 0:c.docs)==null?void 0:p.source},description:{story:`Story: Default (Aluno)
...
Educational context: Página de boas-vindas. Responsável escolhendo qual filho logar.`,...(v=(g=a.parameters)==null?void 0:g.docs)==null?void 0:v.description}}};var u,b,m,x,h;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="user-card">
      <div class="user-card-header" style="background: url('/assets/profiles/teacher.svg') center center / 80px no-repeat, url('/assets/bg-bolinhas.svg') center center / cover no-repeat, #7F6CC3 linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.2) 100%);">
  ...
  \`
}`,...(m=(b=e.parameters)==null?void 0:b.docs)==null?void 0:m.source},description:{story:`Story: Professor

Card de professora "Colégio Nova Jornada" (institucional) com 4 turmas + contador "+78".
Background roxo com ícone de professor.
Contador: 190 alunos.

Educational context: Professor com múltiplas turmas acessando plataforma.`,...(h=(x=e.parameters)==null?void 0:x.docs)==null?void 0:h.description}}};var f,y,E,A,C;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="user-card">
      <div class="user-card-header" style="background: url('/assets/profiles/coordinator.svg') center center / 80px no-repeat, url('/assets/bg-bolinhas.svg') center center / cover no-repeat, #F05FF3 linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.2) 100%);">
  ...
  \`
}`,...(E=(y=n.parameters)==null?void 0:y.docs)==null?void 0:E.source},description:{story:`Story: Coordenador

Card de coordenador "Colégio Nova Jornada" com background rosa/magenta.
4 turmas visíveis + contador "+78".
Contador: 190 alunos.

Educational context: Coordenador acessando perfil para gestão pedagógica.`,...(C=(A=n.parameters)==null?void 0:A.docs)==null?void 0:C.description}}};var B,w,F,k,D;r.parameters={...r.parameters,docs:{...(B=r.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="user-card">
      <div class="user-card-header" style="background: url('/assets/profiles/principal.svg') center center / 80px no-repeat, url('/assets/bg-bolinhas.svg') center center / cover no-repeat, #FE6E6E linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.2) 100%);">
  ...
  \`
}`,...(F=(w=r.parameters)==null?void 0:w.docs)==null?void 0:F.source},description:{story:`Story: Diretor

Card de diretor "Colégio Nova Jornada" com background vermelho/coral.
Sem turmas específicas (gestão geral).
Contador: 190 alunos.

Educational context: Diretor acessando perfil para visão estratégica da escola.`,...(D=(k=r.parameters)==null?void 0:k.docs)==null?void 0:D.description}}};var N,G,M,z,P;o.parameters={...o.parameters,docs:{...(N=o.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="user-card">
      <div class="user-card-header" style="background: url('/assets/profiles/network-manager.svg') center center / 80px no-repeat, url('/assets/bg-bolinhas.svg') center center / cover no-repeat, #00BDB8 linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.2) 100%);">
  ...
  \`
}`,...(M=(G=o.parameters)==null?void 0:G.docs)==null?void 0:M.source},description:{story:`Story: GestorDeRedes

Card de gestor de redes "Rede Produt o" com background turquesa/teal.
Sem turmas (gestão de rede).
Contador: 2 escolas.

Educational context: Gestor de rede acessando visão consolidada de múltiplas instituições.`,...(P=(z=o.parameters)==null?void 0:z.docs)==null?void 0:P.description}}};var J,S,R,j,$;i.parameters={...i.parameters,docs:{...(J=i.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div class="user-card">
      <div class="user-card-header" style="background: url('/assets/profiles/admin.svg') center center / 80px no-repeat, url('/assets/bg-bolinhas.svg') center center / cover no-repeat, #FFB443 linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.2) 100%);">
  ...
  \`
}`,...(R=(S=i.parameters)==null?void 0:S.docs)==null?void 0:R.source},description:{story:`Story: Administrador

Card de administrador "Colégio Nova Jornada" com background laranja/amarelo.
4 turmas visíveis + contador "+78".
Contador: 190 alunos.

Educational context: Admin escolar acessando perfil para gestão administrativa.`,...($=(j=i.parameters)==null?void 0:j.docs)==null?void 0:$.description}}};var T,q,L,U,O;t.parameters={...t.parameters,docs:{...(T=t.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <div style="display: grid; grid-template-columns: repeat(3, 280px); gap: 20px; max-width: 900px;">
      <!-- Aluno 1 -->
  ...
  \`
}`,...(L=(q=t.parameters)==null?void 0:q.docs)==null?void 0:L.source},description:{story:`Story: MultiPerfil
...
Educational context: Responsável/profissional com múltiplos perfis vinculados.`,...(O=(U=t.parameters)==null?void 0:U.docs)==null?void 0:O.description}}};var X,V,Y,_,H;l.parameters={...l.parameters,docs:{...(X=l.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => \`
    \${styles}
    <style>
    .loading-overlay {
  ...
  \`
}`,...(Y=(V=l.parameters)==null?void 0:V.docs)==null?void 0:Y.source},description:{story:`Story: Loading

Card de aluno com overlay de loading (spinner).
Estado durante autenticação/login.

Educational context: Usuário clicou no card, aguardando autenticação.`,...(H=(_=l.parameters)==null?void 0:_.docs)==null?void 0:H.description}}};const K=["Default","Professor","Coordenador","Diretor","GestorDeRedes","Administrador","MultiPerfil","Loading"];export{i as Administrador,n as Coordenador,a as Default,r as Diretor,o as GestorDeRedes,l as Loading,t as MultiPerfil,e as Professor,K as __namedExportsOrder,I as default};
