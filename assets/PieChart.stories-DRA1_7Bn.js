const G={title:"Educacross Components V2/Charts/PieChart",tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`PieChart - Gráfico de Pizza
=============================
...
setTimeout(() => {
  ...
  new Chart(canvas, {
    type: 'pie',
    data: {
      labels: ${JSON.stringify(v)},
      datasets: [{
        data: ${JSON.stringify(s)},
        backgroundColor: ${JSON.stringify(m)},
        borderWidth: 2,
        borderColor: '#fff'
      }]
    },
...
<\/script>
`,t={render:()=>p("Distribuição por Matéria","Tempo de estudo semanal - 8º Ano A",[35,25,20,12,8],["Matemática","Português","Ciências","História","Geografia"],["#6E63E8","#00CFE8","#28C76F","#FF9F43","#EA5455"])},n={render:()=>p("Distribuição de Notas","Turma 8º Ano A - Matemática - Janeiro 2026",[15,45,30,10],["Excelente (9-10)","Bom (7-8.9)","Regular (5-6.9)","Insuficiente (<5)"],["#28C76F","#00CFE8","#FF9F43","#EA5455"])},i={render:()=>p("Tipos de Missões","Distribuição por categoria - Janeiro 2026",[42,35,28,18,12],["Exercícios","Leitura","Vídeo-aula","Pesquisa","Projeto"],["#6E63E8","#00CFE8","#28C76F","#FF9F43","#EA5455"],!0,"Missões")},r={render:()=>p("Status de Frequência","Classificação dos alunos - Janeiro 2026",[78,15,7],["Frequente (≥90%)","Moderado (75-89%)","Baixa (<75%)"],["#28C76F","#FF9F43","#EA5455"])},d={render:()=>`
<div class="chart-container">
  <div class="chart-header">
...
`};var x,h,b;t.parameters={...t.parameters,docs:{...(x=t.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => base('Distribuição por Matéria', 'Tempo de estudo semanal - 8º Ano A', [35, 25, 20, 12, 8], ['Matemática', 'Português', 'Ciências', 'História', 'Geografia'], ['#6E63E8', '#00CFE8', '#28C76F', '#FF9F43', '#EA5455'])
}`,...(b=(h=t.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};var F,E,y;n.parameters={...n.parameters,docs:{...(F=n.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => base('Distribuição de Notas', 'Turma 8º Ano A - Matemática - Janeiro 2026', [15, 45, 30, 10], ['Excelente (9-10)', 'Bom (7-8.9)', 'Regular (5-6.9)', 'Insuficiente (<5)'], ['#28C76F', '#00CFE8', '#FF9F43', '#EA5455'])
}`,...(y=(E=n.parameters)==null?void 0:E.docs)==null?void 0:y.source}}};var C,f,A;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => base('Tipos de Missões', 'Distribuição por categoria - Janeiro 2026', [42, 35, 28, 18, 12], ['Exercícios', 'Leitura', 'Vídeo-aula', 'Pesquisa', 'Projeto'], ['#6E63E8', '#00CFE8', '#28C76F', '#FF9F43', '#EA5455'], true, 'Missões')
}`,...(A=(f=i.parameters)==null?void 0:f.docs)==null?void 0:A.source}}};var B,k,D;r.parameters={...r.parameters,docs:{...(B=r.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => base('Status de Frequência', 'Classificação dos alunos - Janeiro 2026', [78, 15, 7], ['Frequente (≥90%)', 'Moderado (75-89%)', 'Baixa (<75%)'], ['#28C76F', '#FF9F43', '#EA5455'])
}`,...(D=(k=r.parameters)==null?void 0:k.docs)==null?void 0:D.source}}};var z,T,$;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => \`
<div class="chart-container">
  <div class="chart-header">
    <div class="chart-title">Conquistas por Raridade</div>
...
<\/script>
\`
}`,...($=(T=d.parameters)==null?void 0:T.docs)==null?void 0:$.source}}};var S,w,P;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => \`
<div class="chart-container">
  <div class="chart-header">
    <div class="chart-title">Progresso Geral</div>
...
<\/script>
\`
}`,...(P=(w=l.parameters)==null?void 0:w.docs)==null?void 0:P.source}}};var M,q,R;c.parameters={...c.parameters,docs:{...(M=c.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => \`
<div class="chart-container" style="max-width:350px;padding:16px">
  <div class="chart-title" style="font-size:14px;text-align:center;margin-bottom:12px">Notas por Faixa</div>
  <canvas class="chart-canvas" id="pie-compact" style="height:200px"></canvas>
...
<\/script>
\`
}`,...(R=(q=c.parameters)==null?void 0:q.docs)==null?void 0:R.source}}};var j,J,I;o.parameters={...o.parameters,docs:{...(j=o.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => \`
<div class="chart-container">
  <div class="chart-header">
    <div class="chart-title">Distribuição por Matéria</div>
...
<style>\${css}</style>
\`
}`,...(I=(J=o.parameters)==null?void 0:J.docs)==null?void 0:I.source}}};const V=["Default","DistribuicaoNotas","TiposDeMissoes","FrequenciaPorStatus","ConquistasPorTipo","Donut","Compacto","Vazio"];export{c as Compacto,d as ConquistasPorTipo,t as Default,n as DistribuicaoNotas,l as Donut,r as FrequenciaPorStatus,i as TiposDeMissoes,o as Vazio,V as __namedExportsOrder,G as default};
