        ...
        <div class="modal-content-infos gap-5 flex-column flex-lg-row">
          <div class="modal-content-infos-container">
            ...
            <p class="modal-content-infos-text-content" style="padding: 16px">
              ...
              perguntas e respostas com tutoriais de navegação da {{ FAQModalSchoolName }}.
            </p>
            <b-button variant="primary" class="button-faq-content" @click="redirectToFAQ">
          ...
          <div class="modal-content-infos-container">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2">
              ...
              <b-button v-if="showEmail" variant="outline-primary" @click="redirectToEmail">
                <div class="d-flex align-items-center justify-content-between gap-2">
...
const emit = defineEmits(['open-faq', 'open-whatsapp-support', 'open-email'])

const FAQModalSchoolName = computed(() => {
  return getWhitelabelConfig('name')
})

const showEmail = computed(() => {
  return getWhitelabelConfig('email')
})
