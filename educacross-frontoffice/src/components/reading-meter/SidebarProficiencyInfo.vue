              ...
              <tbody>
                <tr class="nivel-abaixo-basico">
                  <td class="text-center align-middle">
                    ...
                    >
                      {{ getVariantByRuleV2(1, 'proficiency').label.toUpperCase() }}
                    </b-badge>
                  </td>
                ...
                <tr class="nivel-basico">
                  <td class="text-center align-middle">
                    <b-badge
                      ...
                      class="font-weight-bold"
                    >
                      {{ getVariantByRuleV2(2, 'proficiency').label.toUpperCase() }}
                    </b-badge>
                  </td>
                  <td class="text-center">
                ...
                <tr class="nivel-proficiente">
                  <td class="text-center align-middle">
                    <b-badge
                      ...
                      class="font-weight-bold"
                    >
                      {{ getVariantByRuleV2(3, 'proficiency').label.toUpperCase() }}
                    </b-badge>
                  </td>
                  <td class="text-center">
                ...
                <tr class="nivel-avancado">
                  <td class="text-center align-middle">
                    <b-badge
                      ...
                      class="font-weight-bold"
                    >
                      {{ getVariantByRuleV2(4, 'proficiency').label.toUpperCase() }}
                    </b-badge>
                  </td>
                  <td class="text-center">
...
const props = defineProps({
  ...
  sidebarId: {
    type: String,
    default: 'sidebar-proficiency-info',
  },
})
...
// State
const sidebarOpen = ref(props.visible)

// Watch visible prop to update sidebarOpen
watch(
  () => props.visible,
  newVal => {
...
// Watch sidebarOpen to propagate change to parent
