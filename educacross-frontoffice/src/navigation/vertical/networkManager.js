...
export default [
  ...
  },
  {
    ...
    children: [
      {
        title: 'Missões',
        route: 'listMissionsSchoolNM',
        resource: PERMISSION.MODULE.SCHOOL_MISSIONS,
        action: ACTION.READ,
      },
      {
        title: 'Missões Plus',
        route: 'missionsPlusInstitutionsOverview',
  ...
  },
  {
    ...
    route: 'educationSystemNetworkList',
    icon: 'auto_stories',
    order: 26,
  ...
  },
  {
    ...
    children: [
      ...
      {
        title: 'Migrar Alunos',
        route: 'changeStudentFromClassAdmin',
