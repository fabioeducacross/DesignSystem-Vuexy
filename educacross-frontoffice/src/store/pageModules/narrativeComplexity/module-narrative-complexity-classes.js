import {
  getNarrativeComplexityClasses,
  getNarrativeComplexityClassesCards,
...
const { institution, serie } = useFilters()
...
export default {
  ...
  getters: {
    ...
    institutionName(state) {
      return state.cards[0] ? state.cards[0].institutionName : null
    },
  },
  actions: {
    fetch({ commit, state }) {
