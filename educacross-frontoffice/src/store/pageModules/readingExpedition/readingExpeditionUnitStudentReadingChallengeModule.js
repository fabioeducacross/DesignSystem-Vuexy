import { getReadingChallenge } from '@/services/shared/reading-expedition/reading-expedition.service.js'
...
export default {
  ...
  actions: {
    async fetchReadingDetails({ commit, rootGetters }) {
      commit('loading', true)
      ...
      const res = await getReadingChallenge(studentId, { Stage: stage })
