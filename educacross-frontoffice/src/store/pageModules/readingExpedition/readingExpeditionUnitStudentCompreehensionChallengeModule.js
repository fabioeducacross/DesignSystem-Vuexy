import { getCompreehensionChallenge } from '@/services/shared/reading-expedition/reading-expedition.service.js'
...
export default {
  ...
  actions: {
    async fetch({ commit, rootGetters }) {
      ...
      const { data } = await getCompreehensionChallenge(studentId, { Stage: stage })
