...
import { getEducationSystemReporBooksContentNetwork } from '@/services/shared/educationSystem/EducationSystem.Service.js'
import { getEducationSystemBookDetails } from '@/services/teacher-context/educationSystem/EducationSystem.Service'
import useFilters from '@/store/filters/useFilters'

const { book, serie, period, educationSystemId, subject, subjects } = useFilters()
...
export default {
  ...
  actions: {
    ...
    fetch({ commit, state }) {
      ...
      getEducationSystemReporBooksContentNetwork(educationSystemId.value, {
        ...
        InstitutionId: state.school.id,
        NetworkGroupId: state.group.id,
        ...state.params,
      })
        .then(({ data }) => {
