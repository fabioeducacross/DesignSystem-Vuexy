import { getEducationSystemReportInstitutionGuide } from '@/services/shared/educationSystem/EducationSystem.Service.js'
...
export default {
  ...
  actions: {
    ...
    fetch({ commit }) {
      ...
      getEducationSystemReportInstitutionGuide(educationSystemId.value, {
