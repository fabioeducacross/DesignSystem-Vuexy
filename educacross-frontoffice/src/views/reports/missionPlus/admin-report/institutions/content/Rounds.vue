              ...
              >
                ...
                >
                  <ProgressBarHorizontalV2
                    v-if="institution && institution.id"
                    :value="round.institutionPerformance"
                  ...
                  <ProgressBarHorizontalV2
                    v-if="networkGroup && networkGroup.id"
                    :value="round.networkGroupPerformance"
                    enum="accuracyPerformance"
                    reverse
                  >
                    <template v-slot="{ item }">
...
import MissionAndQuestionItemByAbility from '@/views/reports/missionPlus/admin-report/institutions/content/components/MissionAndQuestionItemByAbility.vue'
import MissionAndQuestionItemByTopic from '@/views/reports/missionPlus/admin-report/institutions/content/components/MissionAndQuestionItemByTopic.vue'
...
const { rounds, loading, total, currentPage, perPage, exhibition, fetch } =
  useReportMissionPlusContent()
const { subject, institution, networkGroup } = useFilters()
