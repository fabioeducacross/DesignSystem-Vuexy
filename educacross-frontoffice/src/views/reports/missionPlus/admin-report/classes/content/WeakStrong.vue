...
const { loading, tableStrongWeak, exhibition } = useReportMissionPlusContent()
          ...
          >
            <template v-slot:empty>
              <div class="d-flex flex-column align-items-center">
                ...
                <span
                  v-if="!tableStrongWeak.descriptorsStrong.length && !tableStrongWeak.descriptorsToImprove.length"
                  class="text-center"
                >
                  Parece que
              ...
              <div class="d-flex flex-column align-items-center">
                ...
                <span v-else class="text-center">
                  ...
                  <span class="font-bold text-success">
                    Todos os desempenhos estão acima de 50%.
                  </span>
                </span>
              </div>
            </template>
