          ...
          <template v-slot:description>
            <p class="text-body">
              <span class="text-body font-extrabold">
                {{ dataTeacherAccess.teachers | formatNumber }}
              </span>
      ...
      <b-col cols="12" lg="4" sm="12">
        ...
        >
          <template v-slot:description>
            <p class="text-body">
              <span class="text-body font-extrabold">
                {{ dataTeacherAccess.teacherAccessPercentage | formatNumber }}%
              </span>
            </p>
          </template>
        </MediaCard>
      ...
      <b-col cols="12" lg="4" sm="12">
        ...
        >
          <template v-slot:description>
            <p class="text-body">
              <span class="text-body font-extrabold">
                {{ dataTeacherAccess.guidesEnabled | formatNumber }}
              </span>
            </p>
          </template>
        </MediaCard>
...
const dataTeacherAccess = computed(
  () => store.getters['moduleTeacherAccessTabSchool/dataTeacherAccess'],
)

const cardLoading = computed(() => store.getters['moduleTeacherAccessTabSchool/cardLoading'])
</script>