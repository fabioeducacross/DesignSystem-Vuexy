<template>
  <section>
    <b-card no-body>
      ...
      <b-table
        id="list-table-teachers-access-network"
        ...
        no-local-sorting
      >
        <template #head(teachersAccessesPercentage)="item">
...
import { getTeachersAccessByInstitutionMonthExcel } from '@/services/shared/teachers/Teachers.Service.js'
...
const dataTable = computed(() => store.getters['moduleTeacherAccessTabNetwork/data'])

const year = new Date().getFullYear()

const tableColumns = [
  { key: 'institutionName', label: 'Escola' },
  {
    key: 'amountTeachers',
  ...
  {
    key: 'teachersAccessesPercentage',
...
const exportToExcel = () => {
  ...
  getTeachersAccessByInstitutionMonthExcel({
...
<style lang="scss">
  #list-table-teachers-access-network {
    .thead-row {
      th {
