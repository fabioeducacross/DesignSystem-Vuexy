<template>
  <div>
    ...
    <EducationSystemAdminDashboard 
      :only-in-progress="params.OnlyInProgress"
...
<script setup>
import GeralBooksFilters from './GeralBooksFilters.vue'
import GeralBooksList from './GeralBooksList.vue'
...
const { fetchDashboardData, dashboardData, loadingDashboard } = useEducationSystemAdminDashboard()
