...
const { loading, cards } = useEducationSystemMissionPlus()
    ...
    <b-col cols="12" md="6" lg="3">
      ...
      >
        <template v-slot:description>
          <ProgressBarHorizontalV2 :value="cards.progress.institution" height="6px" enum="progress">
            <template v-slot="{ item }">
              <div class="d-flex justify-content-between gap-1">
                <span :class="item.variant.textClass" class="font-14 font-bold mr-1"
