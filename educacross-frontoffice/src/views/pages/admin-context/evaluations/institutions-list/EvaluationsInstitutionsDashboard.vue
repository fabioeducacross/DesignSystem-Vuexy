              ...
              <b-row class="match-height h-full">
                <b-col cols="12">
                  <MediaCard
                    ...
                    right-align
                    tooltip-text="Iniciaram pelos menos uma prova"
                  >
                    <template v-slot:description>
                      <p>
                        ...
                        de
                        {{ data.totalInstitutions | formatNumber }}
                        iniciaram
                      </p>
...
const setStudentsChartSeries = (studentsStarted, studentsFinished, totalStudents) => {
  let notStarted = totalStudents - studentsStarted
  ...
  chartSeries.value = [
    calcPercent(studentsStarted, totalStudents),
    calcPercent(studentsFinished, totalStudents),
  ]
}

watch([data], () => {
  setStudentsChartSeries(
