...
import {
  getEvaluationQuestionsClasses,
  getEvaluationQuestionsClassesExcel,
...
const fetchData = () => {
  ...
  getEvaluationQuestionsClasses(evaluationId, cleanParams)
    .then(({ data }) => {
...
const getQuestionsIds = () => {
  ...
  getEvaluationQuestionsClasses(evaluationId, cleanBody).then(({ data }) => {
...
const exportToExcel = () => {
  ...
  getEvaluationQuestionsClassesExcel(evaluationId, {
    ...
    .then(response => {
      const fileName = 'Avaliação Digital - Questões - Escolas.xlsx'
