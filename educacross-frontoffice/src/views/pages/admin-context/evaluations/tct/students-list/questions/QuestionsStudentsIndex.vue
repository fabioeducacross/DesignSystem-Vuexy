<template>
  <section>
    ...
    <QuestionsStudentsListQuestion
      v-if="filtersParams.exhibition === 1"
      :filters-params="filtersParams"
    />

    <QuestionsStudentsListStudent
      v-if="filtersParams.exhibition === 2"
      :filters-params="filtersParams"
    />
  </section>
</template>
...
import QuestionsStudentsListStudent from './QuestionsStudentsListStudent.vue'
