<template>
  <section>
    ...
    <SidebarInfo :show-text-more="false" :show-percentile-performance="showPercentilePerformance" />
  </section>
</template>

<script setup>
import SidebarInfo from '@/views/pages/test-fluency/narrative-complexity/components/SidebarInfo.vue'
import { getCurrentInstance, ref, onMounted, onUnmounted, computed } from 'vue'

const props = defineProps({
  showPercentilePerformance: {
    type: Boolean,
    default: false,
  },
})
