<template>
  <section>
    <h2 class="text-primary my-1">Desempenho por turno</h2>
...
import ModalStudentRoundDetails from '@/components/mission-plus/ModalStudentRoundDetails.vue'
...
const { rounds, loading, student } = useEducationSystemMissionPlus()
