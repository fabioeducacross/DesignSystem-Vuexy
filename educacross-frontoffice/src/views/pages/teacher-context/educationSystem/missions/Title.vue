...
const { bookName, subjectId } = useEducationSystemMissions()
const { bookId } = router.currentRoute.params

const redirectBack = () => {
  router.push({
    name: `EducationSystemModules${educationSystemId.value}`,
    params: {
...
const goEducationSystemMissionsBookReport = () => {
  router.push({
    name: `EducationSystemMissionsBookReport${educationSystemId.value}`,
    params: {
      educationSystemId: educationSystemId.value,
      bookId,
    },
