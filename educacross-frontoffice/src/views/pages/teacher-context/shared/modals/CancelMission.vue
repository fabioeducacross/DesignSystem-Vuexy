  ...
  <div class="cancel-mission">
    <div v-if="!cancelled" class="confirm-cancel">
      <img
        ...
        alt="belinha"
      />
      <h1 class="title-cancel-mission mt-1">Cancelar envio de missão?</h1>
...
<script setup>
  ...
  const confirmCancelMission = () => {
    ...
    cancellationGuide(props.cancelMission.guideId, {
      id: props.cancelMission.guideId,
