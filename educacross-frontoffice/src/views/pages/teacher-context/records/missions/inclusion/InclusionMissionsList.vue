...
const guides = computed(() => store.getters['inclusionMissionsModule/missions'])
const loading = computed(() => store.getters['inclusionMissionsModule/loading'])
const currentPage = computed(() => store.getters['inclusionMissionsModule/currentPage'])
const perPage = computed(() => store.getters['inclusionMissionsModule/perPage'])
const totalData = computed(() => store.getters['inclusionMissionsModule/totalData'])
