      ...
      <div class="d-none d-lg-flex" style="padding: 1rem 2.8rem 1rem 1rem">
        <b-row class="full-width flex-grow-1 mr-2">
          <b-col cols="6" lg="4" class="flex align-items-center">
            <h5 class="subtitle-educacrossMission color-patternTwo">Nome da missão</h5>
          </b-col>

          <b-col cols="6" lg="4" class="align-items-center d-none d-lg-flex">
            <h5 class="subtitle-educacrossMission color-patternTwo">Anotações internas</h5>
          </b-col>
        </b-row>
      </div>
          ...
          >
            <template v-slot:header>
              <b-row class="full-width flex-grow-1 mr-2">
                ...
                <b-col cols="12" lg="4" class="align-items-center flex">
                  <span class="subtitle-books color-patternTwo">
                    <span class="font-semibold">Situação:</span>
                    <span class="text-books">
                      {{ guideStatus[guide.status].label }}
                    </span>
                  </span>
                  <div @click.stop>
                    <span
                      v-b-tooltip="guideStatus[guide.status].tooltip"
                      class="material-symbols-outlined ml-50 color-patternSeven"
...
const guides = computed(() => store.getters['booksMissionsModule/missions'])
const loading = computed(() => store.getters['booksMissionsModule/loading'])
