...
<script>
  ...
  export default {
    ...
    setup() {
      const avatar6 = new URL('@/assets/images/avatars/6-small.png', import.meta.url).href
      const avatar9 = new URL('@/assets/images/avatars/9-small.png', import.meta.url).href
