    ...
    >
      ...
      <div class="customizer-section">
        ...
        <b-form-group label="Router Transition" label-cols="6">
          <ESelect
            v-model="routerTransitionOption"
...
<script>
  ...
  export default {
    ...
    setup() {
      ...
      // computed mapping between primitive routerTransition (string) and ESelect option (object)
      const routerTransitionOption = computed({
        get: () => {
          return (
            (routerTransitionOptions &&
              routerTransitionOptions.find(o => o.value === routerTransition.value)) ||
            null
          )
        },
        set: val => {
          routerTransition.value = val ? val.value : null
        },
      })
