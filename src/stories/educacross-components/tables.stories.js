/**
 * @file Tables - Educacross Design System
...
export default {
  title: 'Educacross/Components/Tables',
  parameters: {
    layout: 'padded',
    docs: {
      description: {
...
// Story: Tabela responsiva pequena
