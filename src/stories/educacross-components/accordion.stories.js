/**
 * @file Accordion - Educacross Design System
 * @description Painéis colapsáveis para organização de conteúdo
 * 
 * Status: DONE
...
export default {
  title: 'Educacross/Components/Accordion',
  parameters: {
    layout: 'padded',
    docs: {
      description: {
...
// Story: Accordion Flush (sem bordas)
export const Flush = {
