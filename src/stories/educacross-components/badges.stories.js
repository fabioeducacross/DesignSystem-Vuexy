/**
 * Educacross Components - Badges
 * 
 * Componentes de badge extraídos do educacross-frontoffice
 * Contém: BadgeStatus, CellStatus, ConditionalValueDisplay
 */

export default {
  title: 'Educacross/Badges',
  parameters: {
    layout: 'padded',
  },
};
...
/**
 * BadgeStatus - Badge com variantes de status
 * Original: educacross-frontoffice/src/components/badge/BadgeStatus.vue
 */
...
/**
 * CellStatus - Badge para células de tabela
 * Original: educacross-frontoffice/src/components/badge/CellStatus.vue
 */
...
/**
 * ConditionalValueDisplay - Badge condicional baseado em valor
 * Original: educacross-frontoffice/src/components/badge/ConditionalValueDisplay.vue
 */
export const ConditionalValueDisplay = {
  render: () => `
    <style>
      .stat-card {
        background: #fff;
