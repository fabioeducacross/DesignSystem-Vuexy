/**
 * @file Notifications - Educacross Design System
 * @description Sistema de notificações e feedback do usuário
 * 
 * Status: DONE
...
export default {
  title: 'Educacross/Components/Notifications',
  parameters: {
    layout: 'padded',
    docs: {
      description: {
