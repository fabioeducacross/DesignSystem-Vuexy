/**
 * @file Tabs - Educacross Design System
 * @description Navegação por abas para organização de conteúdo
 * 
 * Status: DONE
...
export default {
  title: 'Educacross/Components/Tabs',
  parameters: {
    layout: 'padded',
    docs: {
      description: {
...
// Story: Tabs de Filtro por Período
