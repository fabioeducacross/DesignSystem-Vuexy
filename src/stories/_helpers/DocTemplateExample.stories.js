...
// Exemplo completo do template de documentação
    ...
    content: `
      ${createUsageSection({
        ...
        steps: [
          ...
          'Adicione o texto e ícones se necessário',
...
// Apenas título, subtítulo e conteúdo básico
...
// Mostra como usar cores diferentes do padrão
