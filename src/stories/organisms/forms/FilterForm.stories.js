/**
 * FilterForm - Formulário de Filtros Cascateados Educacross
 *
 ...
 * Card Body
 * ├── Row Principal
 * │   ├── Área de conhecimento (ESelect com ícones SVG)
 * │   └── Campo de Busca (AutoSuggest)
 * │
 * └── Filtros Avançados (Expansível)
 *     ├── Matriz/Currículo (ESelect)
 *     ├── Temática (ESelect - depende de Matriz)
 *     ├── Habilidades (ESelect múltiplo - depende de Temática)
 *     ├── Link "Limpar busca"
 *     └── Toggle "Mais/Menos filtros"
 * ```
 *
 * ### Dependências Cascateadas:
 * 1. Área de conhecimento → independente
 * 2. Matriz/Currículo → depende de Área
 * 3. Temática → depende de Matriz/Currículo
 * 4. Habilidades → depende de Temática
 */
...
/**
 * Ícones SVG das áreas de conhecimento
 * Arquivos originais: Assets/Áreas de conhecimento/
 */
const icons = {
  /**
   * Matemática - Cor #00BDB8 (Cyan/Turquesa)
   */
  math: `<svg width="32" height="32" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M16.9278 29.7H18.4556V27.0111H21.1444V25.4833H18.4556V22.7944H16.9278V25.4833H14.2389V27.0111H16.9278V29.7ZM23.4972 28.6306H29.6389V27.1333H23.4972V28.6306ZM23.4972 25.3611H29.6389V23.8333H23.4972V25.3611ZM24.6278 20.3806L26.4917 18.5167L28.3556 20.3806L29.4556 19.2806L27.5917 17.4167L29.4556 15.5528L28.3556 14.4528L26.4917 16.3167L24.6278 14.4528L23.5278 15.5528L25.3917 17.4167L23.5278 19.2806L24.6278 20.3806ZM14.6972 18.1806H20.6861V16.6528H14.6972V18.1806ZM12.8333 33C12.3444 33 11.9167 32.8167 11.55 32.45C11.1833 32.0833 11 31.6556 11 31.1667V12.8333C11 12.3444 11.1833 11.9167 11.55 11.55C11.9167 11.1833 12.3444 11 12.8333 11H31.1667C31.6556 11 32.0833 11.1833 32.45 11.55C32.8167 11.9167 33 12.3444 33 12.8333V31.1667C33 31.6556 32.8167 32.0833 32.45 32.45C32.0833 32.8167 31.6556 33 31.1667 33H12.8333ZM12.8333 31.1667H31.1667V12.8333H12.8333V31.1667Z" fill="white"/>
  ...
  /**
   * Língua Portuguesa - Cor #EC6300 (Laranja)
   */
  portuguese: `<svg width="32" height="32" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="22" height="22" fill="white" transform="translate(11 11)"/>
  ...
  /**
   * Liga das Corujinhas - Cor #56124F (Roxo/Púrpura)
   */
  owls: `<svg width="32" height="32" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M27.5607 22.7057C27.9913 22.7057 28.3404 22.3535 28.3404 21.9191C28.3404 21.4846 27.9913 21.1324 27.5607 21.1324C27.1301 21.1324 26.781 21.4846 26.781 21.9191C26.781 22.3535 27.1301 22.7057 27.5607 22.7057Z" fill="#FEFEFE"/>
  ...
  /**
   * Matemática Inglês - Matemática com overlay de bandeira UK/US
   */
  mathEnglish: `<svg width="32" height="32" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="44" height="44" rx="5" fill="#00BDB8"/>
<path d="M16.9278 29.7H18.4556V27.0111H21.1444V25.4833H18.4556V22.7944H16.9278V25.4833H14.2389V27.0111H16.9278V29.7ZM23.4972 28.6306H29.6389V27.1333H23.4972V28.6306ZM23.4972 25.3611H29.6389V23.8333H23.4972V25.3611ZM24.6278 20.3806L26.4917 18.5167L28.3556 20.3806L29.4556 19.2806L27.5917 17.4167L29.4556 15.5528L28.3556 14.4528L26.4917 16.3167L24.6278 14.4528L23.5278 15.5528L25.3917 17.4167L23.5278 19.2806L24.6278 20.3806ZM14.6972 18.1806H20.6861V16.6528H14.6972V18.1806ZM12.8333 33C12.3444 33 11.9167 32.8167 11.55 32.45C11.1833 32.0833 11 31.6556 11 31.1667V12.8333C11 12.3444 11.1833 11.9167 11.55 11.55C11.9167 11.1833 12.3444 11 12.8333 11H31.1667C31.6556 11 32.0833 11.1833 32.45 11.55C32.8167 11.9167 33 12.3444 33 12.8333V31.1667C33 31.6556 32.8167 32.0833 32.45 32.45C32.0833 32.8167 31.6556 33 31.1667 33H12.8333ZM12.8333 31.1667H31.1667V12.8333H12.8333V31.1667Z" fill="white"/>
<!-- Flag overlay -->
...
<path d="M35 2V16M28 9H42" stroke="#C8102E" stroke-width="1.5"/>
  ...
  /**
   * Todas as Áreas - Cor #0C5257 (Verde escuro) - Corujinha completa
   */
  all: `<svg width="32" height="32" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
...
// Story: Dropdown Aberto
export const DropdownOpened = {
...
/**
 * Story Interativa - FilterForm com JavaScript
 * Demonstra dependências cascateadas e comportamento real
 */
    ...
    function createSelectHandler(id, stateKey, nextSelectId, nextPlaceholder) {
      ...
      options.querySelectorAll('.option').forEach(opt => {
        opt.addEventListener('click', (e) => {
          ...
          // Atualizar estado
          state[stateKey] = { value: opt.dataset.value, label: opt.dataset.label };
          updateStateDisplay();
